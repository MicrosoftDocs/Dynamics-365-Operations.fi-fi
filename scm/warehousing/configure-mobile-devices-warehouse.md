...
[Määritä mobiililaitteen valikkovaihtoehto työn valmistumista varten Ostotilaus-tyypissä (tehtäväopas)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu)

[Määritä mobiililaitteen valikkovaihtoehto vastaanotettujen nimikkeiden rekisteröinnille (tehtäväopas)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu-item-register-received-items)
