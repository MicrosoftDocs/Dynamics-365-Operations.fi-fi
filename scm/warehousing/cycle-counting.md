...
2.  **Inventoinnin käsittely** – kun inventointityö on luotu, voit suorittaa sen laskemalla varastosijainnin nimikkeet ja kirjaamalla tuloksen Microsoft Dynamics 365 for Operations -järjestelmään mobiililaitteella. Vaihtoehtoisesti voit laskea varastosijainnin nimikkeet inventointityötä luomatta. Tätä prosessia kutsutaan nimellä *spot-inventointi*.
...
Inventointityöt voidaan käsitellä useilla menetelmillä käyttämällä Dynamics 365 for Operations -järjestelmää mobiililaitteessa:

-   **Käyttäjän ohjaama** – Työntekijä voi määrittää inventointityön tunnuksen, joka on **Avoin**-tilassa.
-   **Järjestelmän ohjaama** – Dynamics 365 for Operations määrittää työntekijälle inventointityön tunnuksen.
