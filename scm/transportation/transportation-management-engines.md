...
Seuraavassa taulukossa on kuvattu Microsoft Dynamics 365 for Operations -järjestelmässä käytettävissä olevat kuljetuksenhallintamoduulit.

| Kuljetuksenhallinnan moduuli | kuvaus                                                                                                                                                                                                                                                                                                                 |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Hinnan laskenta**                  | Laskee hinnat.                                                                                                                                                                                                                                                                                                           |
| **Yleinen laskenta**               | Yksinkertaiset muiden moduulien käyttämät apumoduulit, jotka eivät edellytä tietoja Microsoft Dynamics 365 for Operations -järjestelmässä, esimerkiksi jako-osuuden laskenta. Jako-osuuden laskentojen avulla vähennetään tiettyjen tilausten ja rivien lopullisia kuljetuskustannuksia dimensioiden, kuten volyymin ja painon, perusteella. |
