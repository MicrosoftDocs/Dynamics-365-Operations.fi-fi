...
description: "Tässä aiheessa kuvataan, miten voit käyttää ostotilauksia toimittajayhteistyön avulla Microsoft Microsoft Dynamics 365 for Operations -ympäristössä ja valvoa tavaralähetysvarastoa."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
