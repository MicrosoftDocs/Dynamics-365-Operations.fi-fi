...
- **CustomerGroupId** on päivitettävä Finance and Operationsin kelvolliseksi arvoksi. Voit määrittää oletusarvon. Vaihtoehtoisesti voit määrittää arvon arvomäärityksellä. Oletusmallin arvo on **10**.
- **Osoitteen maa- tai aluekoodi** on pakollinen Finance and Operationsissa. Voit estää synkronointivirheet määrittämällä oletusarvon. Oletusarvo käytetään, jos kenttä on tyhjä Salesissa.
