...
14. Valitse Myyjä.
    * Myyntiedustaja- sivulla on luettelo yrityksen tiettyyn provisioryhmään liitetyistä myyjistä. Voit määrittää samaan ryhmään useita myyntiedustajia ja määrittää prosentteina kunkin osuuden kokonaisprovisiosta. Kaikkien työntekijöiden osuus kokonaisprovisiosta ei voi olla yli 100.  
