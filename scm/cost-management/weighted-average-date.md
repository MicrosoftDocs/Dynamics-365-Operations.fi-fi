...
Seuraavassa esimerkkitilanteessa on kirjattu vastaanotto ja varastostaotto, jotka on päivitetty kirjanpitoon. Varaston sulkemisen aikana järjestelmä selvittää vastaanoton suoraan varastostaottoa vasten, eikä varastostaottoa varten tarvita kustannushinnan muutosta. Seuraavassa on kuvattu näitä tapahtumia:
...
Järjestelmä käyttää suoran selvityksen menetelmää päivälle 1. **2. päivä:**
...
Järjestelmä käyttää suoran selvityksen menetelmää päivälle 2. **3. päivä:**
