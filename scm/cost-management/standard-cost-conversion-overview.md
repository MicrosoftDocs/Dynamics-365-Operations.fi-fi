...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Tarkista ja muuta muuntotietueen uutta kustannuslaskelmaversiota
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Määritä nimikkeiden muuntamiseen käyttämään vakiokustannusta
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Syötä tai Laske käytetään kullekin nimikkeelle odottavan standardikustannuksen
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Tarkista ja ratkaise mahdolliset ongelmat nimikkeille, joita ollaan
...
## <a name="7-back-up-the-database-before-conversion"></a>7. Varmuuskopioi tietokanta ennen muuntamista
Varmuuskopioinnin avulla voit palauttaa tietokannan, jos muuntoprosessissa tapahtuu virheitä.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. Suorita muunto kun muuntotietueen tilaksi Valmis
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. Tarkista ja Täsmäytä muunnettujen nimikkeiden varastoarvot
