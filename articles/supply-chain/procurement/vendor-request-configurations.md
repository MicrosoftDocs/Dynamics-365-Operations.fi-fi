...
3. <span data-ttu-id="f1ebc-114">Piilotettu (ei näy)</span><span class="sxs-lookup"><span data-stu-id="f1ebc-114">Hidden (Not visible)</span></span>
4. <span data-ttu-id="f1ebc-115">Näytetty (näkyvissä mutta ei pakollinen)</span><span class="sxs-lookup"><span data-stu-id="f1ebc-115">Displayed (Visible but not mandatory)</span></span>
5. <span data-ttu-id="f1ebc-116">Pakollinen (näkyvissä ja pakollinen)</span><span class="sxs-lookup"><span data-stu-id="f1ebc-116">Required (Visible and mandatory)</span></span>
6. <span data-ttu-id="f1ebc-117">Määritä **Sisältö**-välilehdessä, näytetäänkö teksti ohjatussa toiminnossa ja onko ilmoitettava, että mahdollisen toimittajan käyttäjän on hyväksyttävä se ennen siirtymistä ohjatun toiminnon seuraavaan vaiheeseen.</span><span class="sxs-lookup"><span data-stu-id="f1ebc-117">Click the **Content** tab to specify if text is going to be shown on the wizard and if there should be an acknowledgement that the prospective vendor user must accept this before moving to the next step in the wizard.</span></span> <span data-ttu-id="f1ebc-118">Hyväksyntä pyydetään kaikille ehdoille, jotka käyttäjän on hyväksyttävä ennen jatkamista.</span><span class="sxs-lookup"><span data-stu-id="f1ebc-118">The acknowledgement will be requested for any terms and conditions that the user must accept to continue.</span></span>
