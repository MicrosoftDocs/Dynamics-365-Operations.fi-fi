---
title: Sijaintidirektiivin määrittäminen ostotilauksen hyllytykselle
description: Tässä artikkelissa käsitellään, kuinka määritetään yksinkertainen sijaintidirektiivi.
author: Weijiesa
ms.date: 08/08/2019
