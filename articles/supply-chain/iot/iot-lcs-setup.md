...
Tässä ohjeaiheessa käsitellään IoT-analytiikkalisäosan asentamista Microsoft Dynamics Lifecycle Servicesiin (LCS). Ennen lisäosan asentamista on [luotava Azure-resurssit](iot-azure-setup.md).
