...
Jos haluat määrittää minimitunnuksen, joka selittää lisääntyneen kausittaisen vaihtelun kevät- ja kesäkuukausina, valitse **Pääsuunnittelu** > **Asetukset** > **Kattavuus** > **Minimi- ja maksimitunnukset** ja noudata seuraavia ohjeita.

1. Luo 12 riviä ja määritä riveille **Muutos**-kentässä luku 1–12.
2. Valitse **Yksikkö**-kentässä **Kuukaudet**.
3. Anna **Kerroin**-kentässä arvot, joita käsitellään seuraavassa taulukossa.

|Viivakaavio|Anna tämä arvo|Tulos|
|---|---|---|
