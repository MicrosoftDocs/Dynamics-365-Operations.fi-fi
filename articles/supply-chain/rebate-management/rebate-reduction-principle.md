...
description: Tässä artikkelissa käsitellään ostohyvityksen vähentämisperiaatteiden määrittämistä. Vähennysperiaatteet ohjaavat toimintaa, kun samaan nimikkeeseen tai tapahtumaan sovelletaan useita ostohyvityksiä.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
