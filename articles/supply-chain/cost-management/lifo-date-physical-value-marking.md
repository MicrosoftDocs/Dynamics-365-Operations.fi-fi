...
Seuraavassa on kuvattu LIFO-päivämäärään perustuvan varastomallin vaikutusta, kun **Sisällytä fyysinen arvo** -asetusta ei käytetä. ![LIFO-päivämäärä ja Sisällytä fyysinen arvo.](./media/lifodatewithoutincludephysicalvalue.gif) 
...
Seuraavassa on kuvattu LIFO-päivämäärään perustuvan varastomallin vaikutusta, kun **Sisällytä fyysinen arvo** -asetus on käytössä. ![LIFO-päivämäärä ja Sisällytä fyysinen arvo.](./media/lifodatewithincludephysicalvalue.gif) 
