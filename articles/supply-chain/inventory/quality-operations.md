...
description: Tässä artikkelissa kuvataan, kuinka voit luoda ja käyttää toimintoja määrityksistä poikkeamisille.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8847988"
---
# <a name="operations-for-nonconformances"></a>Toiminnot määrityksistä poikkeamisille

[!include [banner](../includes/banner.md)]

Tässä artikkelissa kuvataan, kuinka voit luoda ja käyttää toimintoja määrityksistä poikkeamisille.
