...
Lisätietoja toimittajien määrittämisestä käyttämään toimittajayhteistyötä on kohdassa [Toimittajayhteistyön käyttäjien hallinta](../procurement/manage-vendor-collaboration-users.md).
