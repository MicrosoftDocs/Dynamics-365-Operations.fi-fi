...
ms.locfileid: "7567412"
---
# <a name="enable-quality-and-nonconformance-management"></a>Laadun ja määrityksistä poikkeamisen hallinnan ottaminen käyttöön

[!include [banner](../includes/banner.md)]

Tässä aiheessa on yhteenveto laadun ja määrityksistä poikkeamisen hallinnan ominaisuuksien määritys- ja konfigurointiprosessista Microsoft Dynamics 365 Supply Chain Managementissa.
