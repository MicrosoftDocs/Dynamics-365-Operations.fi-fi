...
description: Tässä artikkelissa kuvataan varastomäärien varaamisen eri vaihtoehtoja.
author: yufeihuang
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa kuvataan varastomäärien varaamisen eri vaihtoehtoja.
