...
description: Tässä artikkelissa kuvataan, kuinka käytetään ja luodaan määrityksistä poikkeamisten kanssa käytettäviä diagnostiikkatyyppejä.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8852444"
---
# <a name="diagnostic-types-for-nonconformances"></a>Määrityksistä poikkeamisten diagnostiikkatyypit

[!include [banner](../includes/banner.md)]

Tässä artikkelissa kuvataan, kuinka käytetään ja luodaan määrityksistä poikkeamisten kanssa käytettäviä diagnostiikkatyyppejä.
