...
description: Tässä artikkelissa kerrotaan ylläpitosuunnitelmista resurssien hallinnassa.
...
- Uuden ylläpitosuunnitelman esiintymisvälin tyyppi on *Toistetaan koostetun arvon mukaan (vain laskuri)*. Tämä tyyppi käynnistää ylläpidon aina, kun koostettu laskuri saavuttaa määritetyn arvon kerrannaisen. Huolto voidaan esimerkiksi käynnistää 10 000 tunnin välein. Lisätietoja on tämän artikkelin edellä olevassa kohdassa [Välityyppien yleiskuvaus](#interval-types).
