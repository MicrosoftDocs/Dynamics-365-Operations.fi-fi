...
description: Tässä artikkelissa on tietoja ylläpidon käyttökatkon käyttämisestä kapasiteetin yleiskuvan saamiseksi. Se tarvitaan tiettyjen käyttöomaisuuksien kunnossapitotöiden suorittamiseen tiettynä ajanjaksona.
...
1. Valitse **Resurssien hallinta** > **Ylläpidon käyttökatkojen toiminnot** > **Kaikki ylläpidon käyttökatkojen toiminnot** tai **Aktiiviset ylläpidon käyttökatkojen toiminnot**.
