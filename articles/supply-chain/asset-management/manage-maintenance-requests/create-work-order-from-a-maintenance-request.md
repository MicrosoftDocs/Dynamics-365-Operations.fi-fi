...
description: Tässä artikkelissa kerrotaan, kuinka työtilauksia luodaan ylläpitopyynnöistä resurssien hallinnassa.
...
1. Valitse **Resurssien hallinta** \> **Ylläpitopyynnöt** \> **Kaikki ylläpitopyynnöt**.
...
6. Valitse **Resurssien hallinta** \> **Työtilaukset** \> **Kaikki työtilaukset** ja avaa uusi työtilaus.
