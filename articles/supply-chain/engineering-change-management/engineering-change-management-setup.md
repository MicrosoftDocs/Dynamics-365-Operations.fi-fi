...
description: Tässä artikkelissa käsitellään suunnittelun muutostenhallinnan eri osissa parametreina käytettävien yhteisten arvojen luontia.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
