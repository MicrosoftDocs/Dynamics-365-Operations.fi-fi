...
description: Tässä artikkelissa on tietoja toimittajan laskun yksiköistä, joiden avulla kustannustyyppikoodit voidaan konfiguroida sisäisille kustannuksille tai ulkoisille kustannuksille.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
