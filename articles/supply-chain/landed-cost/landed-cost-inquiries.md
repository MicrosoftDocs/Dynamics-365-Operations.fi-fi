...
description: Tässä artikkelissa kuvataan, miten Aiheutunut kustannus -moduulissa käytettävissä olevia erilaisia kyselyitä löytyy ja käytetään.
author: Weijiesa
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
