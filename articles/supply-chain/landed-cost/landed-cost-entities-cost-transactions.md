...
description: Tässä aiheessa on tietoja kustannustapahtuman yksiköistä, joiden avulla kustannuksen arvo voidaan jakaa kustannusalueen sisältöön käyttämällä jako-osuuden menetelmän valintaa.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
