...
description: Tässä artikkelissa kuvataan, miten toimitustiedot määritetään Aiheutunut kustannus -moduulia varten.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa kuvataan, miten toimitustiedot määritetään **Aiheutunut kustannus** -moduulia varten.
