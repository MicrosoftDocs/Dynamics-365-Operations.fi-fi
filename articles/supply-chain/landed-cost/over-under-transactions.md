...
description: Tässä artikkelissa on tietoja, jotka auttavat ylitys-/alitustapahtumien käytäntöjen tietojen määrittämisessä, jotta järjestelmä voi määrittää, miten tuotteiden yli- ja alikäsittelyä hallitaan vastaanoton hetkellä.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
