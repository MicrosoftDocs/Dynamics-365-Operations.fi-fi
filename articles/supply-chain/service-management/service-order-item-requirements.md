...
2.  Valitse **Lähetys**, ja valitse sitten **Nimiketarve** avataksesi **Nimiketarpeet**-lomakkeen.

3.  Valitse **Projekti** -välilehti ja tarkasta **Huoltotilaus**-kentästä nimiketarpeen palvelutilaukset.
...
2.  Valitse **Lähetys**, ja valitse sitten **Nimiketarve** avataksesi **Nimiketarpeet**-lomakkeen. Tässä lomakkeessa näkyvät kaikki huoltotilaukseen luodut nimiketarpeet.

3.  Valitse poistettava nimiketarve ja valitse sitten **Poista**.

–TAI–

1.  Valitse **Projektinhallinta ja kirjanpito** \> **Yleinen** \> **Projektit** \> **Kaikki projektit**.

2.  Avaa projekti, joka sisältää palvelutilauksen, jossa nimiketarve on luotu.

3.  Valitse **Projektit**-lomakkeen oikeassa ruudussa **Nimiketarpeet**. **Nimiketarpeet**-lomake avautuu, ja siinä näkyvät valittuun projektiin liittyvät nimiketarpeet.

4.  Valitse poistettava nimiketarve ja valitse sitten **Poista**.

## <a name="see-also"></a>Lisätietoja

[Nimiketarpeet (lomake)](https://technet.microsoft.com/en-us/library/aa552021\(v=ax.60\))
