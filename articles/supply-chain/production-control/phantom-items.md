...
Seuraavassa kuvassa (a) on tuotteen H sekä osien F ja G tuoterakenne ja (b) on tuotteen H ja osan F reititystaulukko.

![Esimerkki kaksitasoisesta tuoterakenteesta.](media/product-H-part-F.png)
...
![Tuotteen H tekninen tuotannon tuoterakenne.](media/product-H-part-B.png)
...
![Monitasoisissa tuoterakenteissa käytettävä haamurivin tyyppi.](media/product-G-route-sheet-G.png)
...
![Esimerkki monitasoisessa tuoterakenteessa käytettävästä reititysverkosta.](media/product-G-part-F.png)

Seuraavassa kuvassa (a) on tuotteen G ja osan F tuoterakenne ja (b) on tuotteen G ja osan F reititystaulukko.

![Tuotteen G ja osan F tuoterakenne sekä tuotteen G ja osan F reititystaulukko.](media/product-G-part-F-with-route-sheet.png)
