...
description: Tässä artikkelissa käsitellään palkan laskemista työntekijän rekisteröintien perusteella.
...
ms.locfileid: "8844377"
---
# <a name="pay-based-on-registrations"></a>Rekisteröinteihin perustuva palkka

[!include [banner](../includes/banner.md)]

Tässä artikkelissa käsitellään yksityiskohtaisesti palkan laskemista työntekijän rekisteröintien perusteella. Se sisältää esimerkkejä siitä, miten laskennan käytettävissä olevien asetusvalintojen eri yhdistelmät vaikuttavat tulokseen. Tässä on joitakin alueita, jotka katetaan:
