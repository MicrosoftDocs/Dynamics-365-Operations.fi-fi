...
|---------------------|-----------------|---------------------------|----------|
| None                | A               | 20                        | litra    |
| Aktiivinen              | D               | 30                        | litra    |
| Kompensoidaan        | Y               | 10                        | litra    |
| Täyttäjä              | T               | 40                        | litra    |

### <a name="active"></a>Aktiivinen
...
| Y               | Kompensoidaan        | 10                     | 14,72                 |                     | litra    |                |
| T               | Täyttäjä              | 40                     | 39,57                 |                     | litra    |                |
...
### <a name="compensating"></a>Kompensoidaan
...
2.  Tulos kerrotaan kompensointikertoimella:

>   4.29×1,10 =–4,72

3.  Arvioidusta kompensointimäärästä vähennetään –4,72 ja sen mukaan lasketaan täsmäytetty kompensointimäärä:
...
On olemassa yksi poikkeus sääntöön, jonka mukaan erätilauksissa voi käyttää erän tasausta, jos reseptissä on ainakin yksi reseptirivi, jonka ainesosatyyppi on **Aktiivinen**.
