...
description: Tässä artikkelissa kuvataan työvaiheiden ajoittamisen asetuksia. Työvaiheiden ajoitusta voidaan käyttää, kun tuotantoprosessin kestosta halutaan yleisarvio.
...
ms.locfileid: "8907258"
---
# <a name="operations-scheduling-options"></a>Työvaiheen ajoitusvaihtoehdot

[!include [banner](../includes/banner.md)]

Tässä artikkelissa kuvataan työvaiheiden ajoittamisen asetuksia. Työvaiheiden ajoitusta voidaan käyttää, kun tuotantoprosessin kestosta halutaan yleisarvio.
