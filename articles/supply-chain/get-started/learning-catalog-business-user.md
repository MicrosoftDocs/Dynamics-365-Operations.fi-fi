...
| [Varastonhallinnan konfiguroiminen ja käsitteleminen Dynamics 365 for Finance and Operationsissa](/learn/paths/configure-work-warehouse-management-d365-finance-ops/) | Varastonhallinta Dynamics 365 Supply Chain Managementissa auttaa optimoimaan ja virtaviivaistamaan varastoprosessit yksilöllisten tarpeiden mukaan ja antaa käsityksen varastostasi ja työkaluista, jotka auttavat lisäämään asiakastyytyväisyyttä ja vähentämään kustannuksia. | Maksuton, omaan tahtiin etenevä verkko-oppimispolku | 8.5 tuntia |
