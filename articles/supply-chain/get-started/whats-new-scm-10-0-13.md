...
Tässä ohjeaiheessa kerrotaan Microsoft Dynamics 365 Supply Chain Managementin version 10.0.13 uudet tai muuttuneet ominaisuudet. Tämän version koontinumero on 10.0.569. Se on käytettävissä seuraavasti:
...
Microsoft Dynamics 365 Supply Chain Management 10.0.13 sisältää Platform updateja. Lisätietoja on kohdassa [Finance and Operations -sovellusten (lokakuu 2020) käyttöympäristön päivitysversio 10.0.13](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-13.md).
