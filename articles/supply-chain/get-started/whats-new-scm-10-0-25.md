...
Tässä aiheessa käsitellään Microsoft Dynamics 365 Supply Chain Managementin version 10.0.25 uusia tai muuttuneita ominaisuuksia. Tämän version koontinumero on 10.0.1149. Se on käytettävissä seuraavasti:
