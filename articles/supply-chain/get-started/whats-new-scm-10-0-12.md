...
Microsoft Dynamics 365 Supply Chain Management 10.0.12 sisältää Platform updateja. Lisätietoja on kohdassa [Talous- ja toimintosovellusten (elokuu 2020) käyttöympäristön päivitysversio 10.0.12](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-10-0-12.md).
