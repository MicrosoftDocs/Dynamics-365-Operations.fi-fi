...
Microsoft Dynamics 365 Supply Chain Management 10.0.27 sisältää Platform updateja. Lisätietoja on kohdassa [Talous- ja toimintosovellusten (heinäkuu 2022) käyttöympäristön päivitysversio 10.0.27](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-27.md).
