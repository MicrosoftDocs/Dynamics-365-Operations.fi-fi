...
| [Analysoinnin ja raportoinnin käyttäminen Finance and Operationsissa](/learn/modules/work-with-analytics-reporting-in-dynamics-365-finance-ops/) | Liiketoiminnan johtajat voivat tehdä tärkeitä päätöksiä yrityksessä, jos heillä on tarkat tiedot taustalla olevasta taloudellisesta ja operatiivisesta datasta. Ilman tietojen näkyvyyttä yritysjohtajat haastetaan lähes mahdottomaan tehtävään. Käyttämällä analyyseja ja raportointia talous- ja toimintosovelluksissa voit valtuuttaa jokaisen yrityskäyttäjän saamaan käyttöoikeuksien mukaan tarvitsemansa tiedot näiden tärkeiden valintojen tekemistä varten. | Maksuton, omaan tahtiin etenevä verkko-oppimispolku | 1.5 tuntia |
| [Talous- ja toimintosovellusten toteutusprojektin hallinta](/learn/paths/implement-finance-operations/) | Tietoja tärkeimmistä elementeistä ja parhaista käytännöistä onnistuneen talous- ja toimintosovellusten toteuttamisprojektin hallintaa varten. Tiedot kattavat ensimmäisen vaiheen, jossa pohditaan ja suunnitellaan projektin metodologiaa, FastTrack-palveluiden käyttöä, kehitysstrategiaa, tiedonhallintaa ja muita toimintoja. Lisäksi perehdytään parhaisiin tapoihin ylläpitää ja seurata toimintoja julkaisun jälkeen. | Maksuton, omaan tahtiin etenevä verkko-oppimispolku | 11.5 tuntia |
| [Järjestelmän hallinnan aloitussivu](/dynamics365/unified-operations/dev-itpro/sysadmin/system-administration-home-page) | Tämä artikkeli viittaa Microsoft Dynamics 365 Financen järjestelmänvalvojien sisältöön. Sisältö avustaa järjestelmän määrittämisessä niin, että se auttaa sujuvasti ja tehokkaasti organisaatiotasi. | Dokumentaatio | |
...
| [AX2009 - siirtotyökalu](https://community.dynamics.com/365/b/techtalks/posts/ax2009-migration-tool-may-11-2017) | Tämä istunto kattaa työkalut, jotka auttavat siirtymään AX2009-versiosta Dynamics 365 Supply Chain Managementiin. | Verkkokokouksen maksuton tallenne | 55 minuuttia |
