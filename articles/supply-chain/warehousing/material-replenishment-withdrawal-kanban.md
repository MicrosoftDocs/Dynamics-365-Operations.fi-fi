...
description: Tässä artikkelissa käsitellään, miten otto-kanbaneja käytetään valmistustehtävien materiaalitäydennykseen.
author: perlynne
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863705"
---
# <a name="replenishment-with-withdrawal-kanbans"></a>Täydennys ja otto-kanbanit

[!include [banner](../includes/banner.md)]

Tässä artikkelissa käsitellään, miten otto-kanbaneja käytetään valmistustehtävien materiaalitäydennykseen.
