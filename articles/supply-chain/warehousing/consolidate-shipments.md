...
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Lähetysten konsolidointi lähetyksen konsolidointikäytäntöjen avulla

[!include [banner](../includes/banner.md)]

Seuraavissa skenaarioissa käydään läpi lähetyksen konsolidointiprosessi, joka käyttää lähetyksen konsolidointikäytäntöjä automaattisen ja manuaaliseen varastoon vapautuksen aikana:
