...
description: Tämä artikkeli sisältää järjestelmän ohjaaman klusterin keräilyn yleiskatsauksen Microsoft Dynamics 365 Supply Chain Managementissa.
author: Mirzaab
ms.date: 05/26/2020
ms.topic: article
ms.prod: ''
