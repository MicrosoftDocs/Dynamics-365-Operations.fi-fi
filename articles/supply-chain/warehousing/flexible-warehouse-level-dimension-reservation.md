...
<span data-ttu-id="bf1e0-106">Tässä ohjeaiheessa kuvataan varastonvarauskäytäntö, jonka avulla nämä yritykset varaavat tiettyjä eriä tai rekisterikilpiä, vaikka tuotteet on yhdistetty Erä alla\[sijainti\]-varaushierarkiaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-106">This topic describes the inventory reservation policy that lets these businesses reserve specific batches or license plates, even when the products are associated with a "Batch-below\[location\]" reservation hierarchy.</span></span>
...
## <a name="example-scenario-batch-number-allocation"></a><span data-ttu-id="bf1e0-164">Esimerkkiskenaario: Eränumeron kohdistus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-164">Example scenario: Batch number allocation</span></span>
...
1. <span data-ttu-id="bf1e0-177">Määritä tuotteen kolme päätietoparametria käyttämällä seuraavia arvoja:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-177">Set the product's three master data parameters by using these values:</span></span>
...
9. <span data-ttu-id="bf1e0-250">Valitse myyntitilauksen otsikossa **Varasto** \> **Toiminnot** \> **Vapauta varastoon**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-250">On the sales order header, select **Warehouse** \> **Actions** \> **Release to warehouse**.</span></span> <span data-ttu-id="bf1e0-251">Tilausrivi on nyt aallotettu, ja kuormitus ja työ luodaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-251">The order line is now waved, and a load and work are created.</span></span>
...
### <a name="business-scenario"></a><span data-ttu-id="bf1e0-274">Liiketoimintaskenaario</span><span class="sxs-lookup"><span data-stu-id="bf1e0-274">Business scenario</span></span>
...
1. <span data-ttu-id="bf1e0-286">**Ominaisuuden nimi:** *Joustava varastotason dimensioiden varauskäytäntö*</span><span class="sxs-lookup"><span data-stu-id="bf1e0-286">**Feature name:** *Flexible warehouse-level dimension reservation*</span></span>
...
- <span data-ttu-id="bf1e0-298">Viite (vain *Myyntitilaus* -arvoa tuetaan).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-298">Reference (Only the *Sales order* value is supported.)</span></span>
...
## <a name="example-scenario-set-up-and-process-an-order-committed-license-plate-reservation"></a><span data-ttu-id="bf1e0-312">Esimerkkiskenaario: Tilaussidonnaisen rekisterikilven varauksen määrittäminen ja käsitteleminen</span><span class="sxs-lookup"><span data-stu-id="bf1e0-312">Example scenario: Set up and process an order-committed license plate reservation</span></span>
...
1. <span data-ttu-id="bf1e0-346">Oikaise uusien nimikkeiden käytettävissä olevaa varastoa seuravan taulukon mukaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-346">Adjust the on-hand inventory of the new items as specified in the following table.</span></span>
    ...
    | <span data-ttu-id="bf1e0-347">Kohde</span><span class="sxs-lookup"><span data-stu-id="bf1e0-347">Item</span></span>  | <span data-ttu-id="bf1e0-348">Varasto</span><span class="sxs-lookup"><span data-stu-id="bf1e0-348">Warehouse</span></span> | <span data-ttu-id="bf1e0-349">Toimipaikka</span><span class="sxs-lookup"><span data-stu-id="bf1e0-349">Location</span></span> | <span data-ttu-id="bf1e0-350">Rekisterikilpi</span><span class="sxs-lookup"><span data-stu-id="bf1e0-350">License plate</span></span> | <span data-ttu-id="bf1e0-351">Määrä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-351">Quantity</span></span> |
    |-------|-----------|----------|---------------|----------|
...
1. <span data-ttu-id="bf1e0-383">Lisää toinen myyntitilausrivi, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-383">Add a second sales order line that has the following settings:</span></span>
    ...
    - <span data-ttu-id="bf1e0-384">**Nimiketunnus:** *Nimike2*</span><span class="sxs-lookup"><span data-stu-id="bf1e0-384">**Item number:** *Item2*</span></span>
...
1. <span data-ttu-id="bf1e0-396">Jos haluat varata nimikkeen tietystä rekisterikilvestä, valitse Excelin lisäosassa **Uusi** ja lisää varausrivi. Määritä sitten seuraavat arvot:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-396">To reserve an item on a specific license plate, in the Excel add-in, select **New** to add a reservation line, and then set the following values:</span></span>
    ...
    - <span data-ttu-id="bf1e0-398">**Rekisterikilpi:** *RK02*</span><span class="sxs-lookup"><span data-stu-id="bf1e0-398">**License plate:** *LP02*</span></span>
    - <span data-ttu-id="bf1e0-399">**ReservedInventoryQuantity:** *10*</span><span class="sxs-lookup"><span data-stu-id="bf1e0-399">**ReservedInventoryQuantity:** *10*</span></span>

1. <span data-ttu-id="bf1e0-400">Lisää toinen varausrivi valitsemalla **Uusi** ja määritä sille seuraavat arvot:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-400">Select **New** to add another reservation line, and set the following values:</span></span>

    - <span data-ttu-id="bf1e0-401">**Erätunnus:** Anna **Erätunnus** -arvo, joka on myyntitilausrivillä *Nimike2* -kohdassa.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-401">**Lot ID:** Enter the **Lot ID** value you found for the sales order line for *Item2*.</span></span>
    - <span data-ttu-id="bf1e0-402">**Rekisterikilpi:** *RK02*</span><span class="sxs-lookup"><span data-stu-id="bf1e0-402">**License plate:** *LP02*</span></span>
    - <span data-ttu-id="bf1e0-403">**ReservedInventoryQuantity:** *5*</span><span class="sxs-lookup"><span data-stu-id="bf1e0-403">**ReservedInventoryQuantity:** *5*</span></span>

1. <span data-ttu-id="bf1e0-404">Valitse Excelin lisäosassa **Julkaise** ja lähetä tiedot takaisin Supply Chain Management -sovellukseen.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-404">In the Excel add-in, select **Publish** to send the data back to Supply Chain Management.</span></span>

    > [!NOTE]
    > <span data-ttu-id="bf1e0-405">Varausrivi tulee näkyviin järjestelmään vain, jos julkaisemisessa ei ole tehty virheitä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-405">The reservation line will appear in the system only if publishing is completed without errors.</span></span>

1. <span data-ttu-id="bf1e0-406">Siirry takaisin Supply Chain Management -sovellukseen.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-406">Go back to Supply Chain Management.</span></span> 
1. <span data-ttu-id="bf1e0-407">Voit tarkistaa nimikkeen varauksen **Myyntitilausrivit** -pikavälilehden **Varasto** -valikossa valitsemalla **Ylläpidä \> Varaus**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-407">To review the item's reservation, on the **Sales order lines** FastTab, on the **Inventory** menu, select **Maintain \> Reservation**.</span></span> <span data-ttu-id="bf1e0-408">Ota huomioon, että *Nimike1* -kohdan myyntitilausrivillä varataan varastoa *10* ja *Nimike2* -kohdan myyntitilausrivillä varataan varastoa *5*.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-408">Notice that, for the sales order line for *Item1* , inventory of *10* is reserved, and for the sales order line for *Item2* , inventory of *5* is reserved.</span></span>
1. <span data-ttu-id="bf1e0-409">Voit tarkastella varastotapahtumia, jotka liittyvät myyntitilausrivin varaukseen, **Myyntitilausrivit** -pikavälilehden **Varasto** -valikossa valitsemalla **Näytä \> Tapahtumat**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-409">To review inventory transactions that are related to the sales order line reservation, on the **Sales order lines** FastTab, on the **Inventory** menu, select **View \> Transactions**.</span></span> <span data-ttu-id="bf1e0-410">Huomaa, että varaukseen liittyy kaksi tapahtumaa. Toisen **Viite** -kentän arvoksi on määritetty *Myyntitilaus* ja toisen **Viite** -kentän arvoksi on määritetty *Tilaussidonnainen varaus*.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-410">Notice that there are two transactions that are related to the reservation: one where the **Reference** field is set to *Sales order* and one where the **Reference** field is set to *Order-committed reservation*.</span></span>

    > [!NOTE]
    > <span data-ttu-id="bf1e0-411">Tapahtuma, jossa **Viite** -kentän arvoksi on määritetty *Myyntitilaus* , edustaa tilausrivin varausta varastodimensioissa, jotka ovat yli **Sijainti** -tason (toimipaikka, varasto ja varaston tila).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-411">A transaction where the **Reference** field is set to *Sales order* represents the order line reservation for inventory dimensions that are above the **Location** level (site, warehouse, and inventory status).</span></span> <span data-ttu-id="bf1e0-412">Tapahtuma, jonka **Viite** -kentän arvoksi on määritetty *Tilaussidonnainen varaus* , vastaa tietyn rekisterikilven ja sijainnin tilausrivin varausta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-412">A transaction where the **Reference** field is set to *Order-committed reservation* represents the order line reservation for the specific license plate and location.</span></span>

1. <span data-ttu-id="bf1e0-413">Jos haluat vapauttaa myyntitilauksen, valitse toimintoruudun **Varasto** -välilehden **Toiminnot** -ryhmässä **Vapauta varastoon**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-413">To release the sales order, on the Action Pane, on the **Warehouse** tab, in the **Actions** group, select **Release to warehouse**.</span></span>

### <a name="review-and-process-warehouse-work-with-order-committed-license-plates-assigned"></a><span data-ttu-id="bf1e0-414">Varaston työn tarkistaminen ja käsitteleminen määritettyjen tilaussidonnaisten rekisterikilpien avulla</span><span class="sxs-lookup"><span data-stu-id="bf1e0-414">Review and process warehouse work with order-committed license plates assigned</span></span>

1. <span data-ttu-id="bf1e0-415">Valitse **Myyntitilausrivit** -pikavälilehdellä **Varasto** -valikosta **Työn tiedot**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-415">On the **Sales order lines** FastTab, on the **Warehouse** menu, select **Work details**.</span></span>

    <span data-ttu-id="bf1e0-416">Kun varaus on tehty tietylle erälle, järjestelmä ei käytä sijaintidirektiivejä, kun rekisterikilven varausta käyttävälle myyntitilaukselle luodaan työ.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-416">As when reservation is done for a specific batch, the system doesn't use location directives when it creates the work for the sales order that uses license plate reservation.</span></span> <span data-ttu-id="bf1e0-417">Koska tilaussidonnainen varaus määrittää kaikki varastodimensiot, mukaan lukien sijainnin, sijaintidirektiivejä ei tarvitse käyttää, koska nämä varastodimensiot on juuri syötetty työhön.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-417">Because the order-committed reservation specifies all the inventory dimensions, including the location, location directives don't have to be used, because those inventory dimensions are just entered in the work.</span></span> <span data-ttu-id="bf1e0-418">Ne näkyvät **Varastodimensioista** -osassa **Työn varastotapahtumat** -sivulla.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-418">They are shown in the **From inventory dimensions** section on the **Work inventory transactions** page.</span></span>

    > [!NOTE]
    > <span data-ttu-id="bf1e0-419">Kun työ on luotu, nimikkeen varastotapahtuma, jossa **Viite** -kentän arvona on *Tilaussidonnainen varaus* , poistetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-419">After the work is created, the item's inventory transaction where the **Reference** field is set to *Order-committed reservation* is removed.</span></span> <span data-ttu-id="bf1e0-420">Varastotapahtuma, jossa **Viite** -kentän arvona on *Työ* , sisältää nyt kaikkien määrän varastodimensioiden fyysisen varauksen.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-420">The inventory transaction where the **Reference** field is set to *Work* now holds the physical reservation for all the quantity's inventory dimensions.</span></span>

1. <span data-ttu-id="bf1e0-421">Tee työn keräily ja hyllytys valmiiksi mobiililaitteessa käyttämällä valikon vaihtoehtoa, jossa **Käsittele rekisterikilven mukaan** -valintaruutu on valittuna.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-421">On the mobile device, finish picking and putting the work by using a menu item where the **Handle by license plate** check box is selected.</span></span>

    > [!NOTE]
    > <span data-ttu-id="bf1e0-422">**Käsittele rekisterikilven mukaan** -toiminto auttaa koko rekisterikilven käsittelemisessä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-422">The **Handle by license plate** functionality helps you process the whole license plate.</span></span> <span data-ttu-id="bf1e0-423">Jos sinun on käsiteltävä rekisterikilven osa, et voi käyttää tätä toimintoa.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-423">If you must process part of the license plate, you can't use this functionality.</span></span>
    >
    > <span data-ttu-id="bf1e0-424">On suositeltavaa, että kustakin rekisterikilvestä luodaan erilliset työt.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-424">We recommend that you have separate work generated for each license plate.</span></span> <span data-ttu-id="bf1e0-425">Voit saavuttaa tämän tuloksen käyttämällä **Työn otsikoiden katkaisut** -ominaisuutta **Työmalli** -sivulla.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-425">To achieve this result, use the **Work header breaks** feature on the **Work template** page.</span></span>

    <span data-ttu-id="bf1e0-426">Rekisterikilpi *RK02* on nyt kerätty myyntitilausriveille ja hyllytetty *Lastausovi* -sijaintiin.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-426">License plate *LP02* is now picked for sales order lines and put to the *Baydoor* location.</span></span> <span data-ttu-id="bf1e0-427">Tässä vaiheessa se on valmis lastattavaksi ja lähetettäväksi asiakkaalle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-427">At this point, it's ready to be loaded and dispatched to the customer.</span></span>

## <a name="exception-handling-of-warehouse-work-that-has-order-committed-batch-numbers"></a><span data-ttu-id="bf1e0-428">Niiden varastotöiden poikkeustenkäsittely, joilla on tilaussidonnaiset eränumerot</span><span class="sxs-lookup"><span data-stu-id="bf1e0-428">Exception handling of warehouse work that has order-committed batch numbers</span></span>

<span data-ttu-id="bf1e0-429">Tilaussidonnaisten eränumeroiden keräilyn varastotyöhön sovelletaan samoja varaston poikkeustenkäsittelyä ja -toimintoja kuin tavanomaiseen työhön.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-429">Warehouse work for picking order-committed batch numbers is subject to the same standard warehouse exception handling and actions as regular work.</span></span> <span data-ttu-id="bf1e0-430">Yleisesi ottaen avoin työ tai työrivi voidaan peruuttaa, se voidaan keskeyttää, koska käyttäjän sijainti on täynnä, siihen voidaan soveltaa lyhyttä keräilyä ja sitä voidaan päivittää siirron vuoksi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-430">In general, the open work or work line can be canceled, it can be interrupted because a user location is full, it can be short-picked, and it can be updated because of a movement.</span></span> <span data-ttu-id="bf1e0-431">Samoin jo valmiiksi saatua keräiltyä työmäärää voidaan vähentää tai työ voidaan palauttaa.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-431">Likewise, the picked quantity of work that has already been completed can be reduced, or the work can be reversed.</span></span>

<span data-ttu-id="bf1e0-432">Kaikkiin näihin poikkeusten käsittelyn toimintoihin sovelletaan seuraavaa keskeistä sääntöä: asiakkaalle varattua eränumeroa ei voi koskaan korvata toisella eränumerolla, mutta sen varastodimensioita (sijainti ja rekisterikilpi) voi muuttaa joko käyttäjän manuaalisella päivityksellä tai järjestelmän automaattisella päivityksellä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-432">The following key rule is applied to all these exception handling actions: the batch number that was reserved for the customer can never be replaced with a different batch number, but its storage dimensions (location and license plate) can be changed through either a manual update by the user or an automatic update by the system.</span></span> <span data-ttu-id="bf1e0-433">Automaattinen päivitys perustuu samaan varastodimensioiden satunnaiseen määrittämiseen, jota käytetään, kun tietty erä varataan automaattisesti mutta varastodimensioita ei määritetä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-433">The automatic update is based on the same random assignment of storage dimensions that applied when a specific batch was automatically reserved but no storage dimensions were specified.</span></span>

### <a name="example-scenario"></a><span data-ttu-id="bf1e0-434">Esimerkkiskenaario</span><span class="sxs-lookup"><span data-stu-id="bf1e0-434">Example scenario</span></span>

<span data-ttu-id="bf1e0-435">Esimerkki tästä skenaariosta on tilanne, jossa aiemmin valmistuneiden töiden keräily perutaan **Vähennä keräiltyä määrää** -toimintoa.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-435">An example of this scenario is a situation where previously completed work is being unpicked by using the **Reduce picked quantity** function.</span></span> <span data-ttu-id="bf1e0-436">Tässä esimerkissä oletetaan, että olet jo tehnyt [Esimerkkiskenaario: Eränumeron kohdistus](#Example-batch-allocation) -kohdassa kerrotut vaiheet.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-436">This example assumes that you've already completed the steps that are described in [Example scenario: Batch number allocation](#Example-batch-allocation).</span></span> <span data-ttu-id="bf1e0-437">Se jatkuu kyseisestä esimerkistä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-437">It continues from that example.</span></span>

1. <span data-ttu-id="bf1e0-438">Siirry kohtaan **Varastonhallinta** \> **Kuormat** \> **Aktiiviset kuormat**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-438">Go to **Warehouse management** \> **Loads** \> **Active loads**.</span></span>
2. <span data-ttu-id="bf1e0-439">Valitse kuorma, joka on luotu myyntitilauksen lähetyksen yhteydessä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-439">Select the load that was created in connection with the shipment of your sales order.</span></span>
3. <span data-ttu-id="bf1e0-440">Valitse **Kuormatilauksen rivit** -pikavälilehdestä **Vähennä keräiltyä määrää**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-440">From the **Load order lines** FastTab, select **Reduce picked quantity**.</span></span>
4. <span data-ttu-id="bf1e0-441">Valitse **Vähennä keräiltyä määrää** -sivun **Siirrä sijaintiin** -kentässä **FL-001**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-441">On the **Reduce picked quantity** page, in the **Move to location** field, select **FL-001**.</span></span>
5. <span data-ttu-id="bf1e0-442">Valitse **Siirrä rekisterikilvelle** -kentässä **LP33**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-442">In the **Move to license plate** field, select **LP33**.</span></span>
6. <span data-ttu-id="bf1e0-443">Syötä **Peruttava keräilty varastomäärä** -kenttään arvo **10**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-443">In the grid, in the **Inventory quantity to unpick** field, enter **10**.</span></span>
7. <span data-ttu-id="bf1e0-444">Valitse **OK**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-444">Select **OK**.</span></span>

<span data-ttu-id="bf1e0-445">Tässä ovat keräilyn perumisen tulokset:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-445">Here are the results of the unpicking action:</span></span>

- <span data-ttu-id="bf1e0-446">Aiemmin suljetun työn tilaksi määritetään **Peruttu**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-446">The status of the previously closed work is set to **Canceled**.</span></span>
- <span data-ttu-id="bf1e0-447">Uusi **Varastonsiirto** -tyypin työ luodaan varastomäärälle **10** eränumerossa **B11**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-447">New work of the **Inventory movement** type is created for the unpicked quantity of **10** for batch number **B11**.</span></span> <span data-ttu-id="bf1e0-448">Tämä työ edustaa siirtoa sijainnista **Lastauspaikan ovi** rekisterikilvelle **LP33** sijainnissa **FL-001**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-448">This work represents the movement from the **Baydoor** location to license plate **LP33** in location **FL-001**.</span></span> <span data-ttu-id="bf1e0-449">Tilaksi määritetään **Suljettu**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-449">The status is set to **Closed**.</span></span>
- <span data-ttu-id="bf1e0-450">Järjestelmä varaa uudelleen alun perin tilatun eränumeron ja määrittää sijainnin ja rekisterikilpitunnukset.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-450">The system re-reserves the batch number that was originally ordered, and assigns the location and license plate IDs.</span></span> <span data-ttu-id="bf1e0-451">(Tämä prosessi vastaa **Vara rivi** -toiminnon suorittamista tietyn eränumeron tilausriville).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-451">(This process is equivalent to running the **Reserve line** function for the order line for a given batch number).</span></span> <span data-ttu-id="bf1e0-452">Tämän tuloksena erä **B11** näkyy sidottuna **Lähderiville sidotut eränumerot** -pikavälilehdessä sivulla **Erävaraus** ja **Varaus** -kentässä on määrä **10** eränumeron **B11** osalta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-452">As a result, batch **B11** is shown as committed on the **Batch numbers committed to source line** FastTab of the **Batch reservation** page, and the **Reservation** field contains a quantity of **10** for batch number **B11**.</span></span> <span data-ttu-id="bf1e0-453">Lisäksi **Sijainti** -kentän arvona on **FL-001** ja **Rekisterikilpi** -kentän arvona on **LP11**.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-453">Additionally, the **Location** field is set to **FL-001** , and the **License plate** field is set to **LP11**.</span></span> <span data-ttu-id="bf1e0-454">(Voit lisätä nämä kentät ruudukkoon, jos ne eivät ole näkyvissä.)</span><span class="sxs-lookup"><span data-stu-id="bf1e0-454">(You can add these fields to the grid if they aren't visible.)</span></span>

<span data-ttu-id="bf1e0-455">Seuraavissa taulukoissa on yhteenveto siitä, miten järjestelmä käsittelee tiettyjen varastotoimintojen tilaussidonnaisen erävarauksen.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-455">The following tables provide an overview that shows how the system handles order-committed batch reservation for specific warehouse actions.</span></span> <span data-ttu-id="bf1e0-456">Taulukkojen sisältöä tulkitaan olettamalla, että kukin varastotoiminnon suorittamiseen liittyy olemassa oleva tilaussidonnaiseen erävaraukseen perustuvaa työ tai että kunkin varastotoiminnon suorittaminen vaikuttaa kyseisentyyppiseen työhön.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-456">To interpret the content in the tables, assume that each warehouse action is run in the context of existing warehouse work that originates from an order-committed batch reservation, or that execution of each warehouse action affects work of that type.</span></span>

> [!NOTE]
> <span data-ttu-id="bf1e0-457">Näissä taulukoissa Erämäärä on käytettävissä -sarake ilmaisee, onko varastomäärää käytettävissä sen määrän lisäksi, joka on jo varattu kulloisillekin tilaussidonnaisille varauksille tai joka on varattu kyseisentyyppisiin varauksiin perustuvassa varastotyössä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-457">In these tables, the "Batch quantity is available" column indicates whether a batch quantity is available in addition to the quantity that is either already reserved for the current order-committed reservations or already reserved by the warehouse work that originates from reservations of that type.</span></span>

#### <a name="override-the-pick-location-on-the-open-work"></a><span data-ttu-id="bf1e0-458">Avoimen työn keräilysijainnin ohitus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-458">Override the pick location on the open work</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="bf1e0-459">Keskeiset määritysparametrit</span><span class="sxs-lookup"><span data-stu-id="bf1e0-459">Key setup parameter</span></span></th>
<th><span data-ttu-id="bf1e0-460">Erämäärä on käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-460">Batch quantity is available</span></span></th>
<th><span data-ttu-id="bf1e0-461">Keskeiset käyttäjän vaiheet</span><span class="sxs-lookup"><span data-stu-id="bf1e0-461">Key user steps</span></span></th>
<th><span data-ttu-id="bf1e0-462">Varastotyö</span><span class="sxs-lookup"><span data-stu-id="bf1e0-462">Warehouse work</span></span></th>
<th><span data-ttu-id="bf1e0-463">Tilaussidonnainen erävaraus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-463">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="bf1e0-464"><strong>Salli keräilysijainnin ohitus</strong> -asetus on käytössä työntekijällä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-464">The <strong>Allow pick location override</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="bf1e0-465">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-465">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-466">Valitse valikkovaihtoehto <strong>Ohita sijainti</strong> varastointisovelluksessa, kun aloitat keräilytyön.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-466">Select the <strong>Override location</strong> menu item on the warehouse app when you start picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-467">Valitse <strong>Ehdota</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-467">Select <strong>Suggest</strong>.</span></span></li>
<li><span data-ttu-id="bf1e0-468">Vahvista uusi sijainti, jota ehdotetaan erämäärän käytettävyyden perusteella.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-468">Confirm the new location that is suggested based on batch quantity availability.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-469">Seuraavat toiminnot tapahtuvat kulloisessakin työssä:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-469">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="bf1e0-470">Keräilyrivin sijainniksi päivittyy uusi sijainti.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-470">The location on the pick line is updated to the new location.</span></span> <span data-ttu-id="bf1e0-471">(Jos sijainti on rekisterikilpihallittu, työvarastotapahtumalle määritetään satunnainen rekisterikilpi ja työntekijä voi keräillä mistä tahansa rekisterikilvestä, jossa määrää on käytettävissä.)</span><span class="sxs-lookup"><span data-stu-id="bf1e0-471">(If the location is license plate–controlled, a random license plate is assigned to the work inventory transaction, and the worker can pick from any license plate that has available quantity.)</span></span></li>
<li><span data-ttu-id="bf1e0-472">Jos määrää on uuden sijainnin useassa rekisterikilvessä, alkuperäinen keräilyrivi jaetaan useaan riviin, jotka vastaavat kutakin rekisterikilpeä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-472">If the quantity is found on more than one license plate in the new location, the original pick line is split into multiple lines to match each license plate.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-473">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-473">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-474">Nro</span><span class="sxs-lookup"><span data-stu-id="bf1e0-474">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-475">Valitse valikkovaihtoehto <strong>Ohita sijainti</strong> varastointisovelluksessa, kun aloitat keräilytyön.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-475">Select the <strong>Override location</strong> menu item on the warehouse app when you start picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-476">Määritä sijainti manuaalisesti.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-476">Manually enter a location.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-477"><strong>Ohita sijainti</strong> -toiminto ei ole mahdollinen.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-477">The <strong>Override location</strong> action isn't possible.</span></span> <span data-ttu-id="bf1e0-478">Se epäonnistuu, ja ilmenee virhe.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-478">It fails, and an error is thrown.</span></span></td>
<td><span data-ttu-id="bf1e0-479">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-479">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="full-button--split-a-work-line-because-of-overflow-on-the-user-location"></a><span data-ttu-id="bf1e0-480">Täysi-painike – Työrivin jakaminen käyttäjän sijainnin ylivuodon vuoksi</span><span class="sxs-lookup"><span data-stu-id="bf1e0-480">Full button – Split a work line because of overflow on the user location</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="bf1e0-481">Keskeiset määritysparametrit</span><span class="sxs-lookup"><span data-stu-id="bf1e0-481">Key setup parameter</span></span></th>
<th><span data-ttu-id="bf1e0-482">Erämäärä on käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-482">Batch quantity is available</span></span></th>
<th><span data-ttu-id="bf1e0-483">Keskeiset käyttäjän vaiheet</span><span class="sxs-lookup"><span data-stu-id="bf1e0-483">Key user steps</span></span></th>
<th><span data-ttu-id="bf1e0-484">Varastotyö</span><span class="sxs-lookup"><span data-stu-id="bf1e0-484">Warehouse work</span></span></th>
<th><span data-ttu-id="bf1e0-485">Tilaussidonnainen erävaraus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-485">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="bf1e0-486"><strong>Salli työn jakaminen</strong> -asetus on käytössä mobiililaitteen valikkovaihtoehdossa.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-486">The <strong>Allow splitting of work</strong> option is enabled on the mobile device menu item.</span></span></td>
<td><span data-ttu-id="bf1e0-487">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-487">Not applicable</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-488">Valitse valikkovaihtoehto <strong>Täysi</strong> varastointisovelluksessa, kun käsittelet keräilytyötä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-488">Select the <strong>Full</strong> menu item on the warehouse app when you process picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-489">Syötä <strong>Keräilymäärä</strong>-kenttään tarvittavan keräilyn osamäärä ilmaisemaan täyttä kapasiteettia.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-489">In the <strong>Pick Qty</strong> field, enter a partial quantity of the required pick to indicate the full capacity.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-490">Kulloisessakin työssä määrä päivitetään vastaamaan jäljellä olevaa keräiltävää määrää.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-490">On the current work, the quantity is updated to the remaining quantity that must be picked.</span></span></li>
<li><span data-ttu-id="bf1e0-491">Keräillylle määrälle luodaan uusi työ ja se suljetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-491">New work for the picked quantity is created and closed.</span></span></li>
</ul></td>
<td><span data-ttu-id="bf1e0-492">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-492">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="reduce-the-picked-quantity-of-completed-work-from-a-load"></a><span data-ttu-id="bf1e0-493">Valmiin työn keräillyn määrän vähentäminen (kuormasta)</span><span class="sxs-lookup"><span data-stu-id="bf1e0-493">Reduce the picked quantity of completed work (from a load)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="bf1e0-494">Keskeiset määritysparametrit</span><span class="sxs-lookup"><span data-stu-id="bf1e0-494">Key setup parameter</span></span></th>
<th><span data-ttu-id="bf1e0-495">Erämäärä on käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-495">Batch quantity is available</span></span></th>
<th><span data-ttu-id="bf1e0-496">Keskeiset käyttäjän vaiheet</span><span class="sxs-lookup"><span data-stu-id="bf1e0-496">Key user steps</span></span></th>
<th><span data-ttu-id="bf1e0-497">Varastotyö</span><span class="sxs-lookup"><span data-stu-id="bf1e0-497">Warehouse work</span></span></th>
<th><span data-ttu-id="bf1e0-498">Tilaussidonnainen erävaraus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-498">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="bf1e0-499">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-499">Not applicable</span></span></td>
<td><span data-ttu-id="bf1e0-500">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-500">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-501">Avaa <strong>Vähennä keräiltyä määrää</strong> -sivu kuormariviltä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-501">Open the <strong>Reduce picked quantity</strong> page from the load line.</span></span></li>
<li><span data-ttu-id="bf1e0-502">Syötä sen määrän kokonaisarvo, jonka keräily perutaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-502">Enter the full quantity to unpick.</span></span></li>
<li><span data-ttu-id="bf1e0-503">Valitse "siirto kohteeseen" sijainti/rekisterikilpi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-503">Select a "move to" location/license plate.</span></span></li>
</ol>
</td>
<td>
<ul> 
<li><span data-ttu-id="bf1e0-504">Kuormariviin liittyvä työ perutaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-504">Work that is associated with the load line is canceled.</span></span></li>
<li><span data-ttu-id="bf1e0-505">Varastosiirrolle luodaan uusi työ ja se suljetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-505">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-506">Määrä varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-506">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-507">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-507">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-508">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-508">No</span></span></td>
<td><span data-ttu-id="bf1e0-509">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-509">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-510">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-510">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-511">Määrä varataan uudelleen samalle erälle ja samalle sijainnille ja rekisterikilvelle (jos sijainti on rekisterikilpihallittu), jotka on syötetty keräilyn perumisen yhteydessä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-511">The quantity is re-reserved for the same batch, and for the same location and license plate (if the location is license plate–controlled) that were entered during unpicking.</span></span></td>
</tr>
</tbody>
</table>

#### <a name="move-an-item-within-a-warehouse"></a><span data-ttu-id="bf1e0-512">Nimikkeen siirtäminen varastossa</span><span class="sxs-lookup"><span data-stu-id="bf1e0-512">Move an item within a warehouse</span></span>

> [!NOTE]
> <span data-ttu-id="bf1e0-513">Tätä varastotoimintoa voidaan soveltaa vain **Työnluontiprosessi** -tyypin siirtoihin, ei mallin mukaiseen siirtoon.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-513">This warehouse action is applicable only to movement of the **Work creation process** type, not to movement by template.</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="bf1e0-514">Keskeiset määritysparametrit</span><span class="sxs-lookup"><span data-stu-id="bf1e0-514">Key setup parameter</span></span></th>
<th><span data-ttu-id="bf1e0-515">Erämäärä on käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-515">Batch quantity is available</span></span></th>
<th><span data-ttu-id="bf1e0-516">Keskeiset käyttäjän vaiheet</span><span class="sxs-lookup"><span data-stu-id="bf1e0-516">Key user steps</span></span></th>
<th><span data-ttu-id="bf1e0-517">Varastotyö</span><span class="sxs-lookup"><span data-stu-id="bf1e0-517">Warehouse work</span></span></th>
<th><span data-ttu-id="bf1e0-518">Tilaussidonnainen erävaraus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-518">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="bf1e0-519"><strong>Salli työhön liitetyn varaston siirto</strong> -asetus on käytössä työntekijällä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-519">The <strong>Allow movement of inventory with associated work</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="bf1e0-520">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-520">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-521">Aloita siirto varastointisovelluksella.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-521">Start a movement on the warehouse app.</span></span></li>
<li><span data-ttu-id="bf1e0-522">Anna kohteesta- ja kohteeseen-sijainnit.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-522">Enter "from" and "to" locations.</span></span></li>
</ol></td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-523">Kaikissa olemassa olevissa töissä, joihin siirto vaikuttaa, keräilysijainniksi päivitetään uusi kohteeseen-sijainti.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-523">On all existing work that is affected by the move, the pick location is updated to the new "to" location.</span></span></li>
<li><span data-ttu-id="bf1e0-524">Varastosiirrolle luodaan uusi työ ja se suljetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-524">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-525">Kaikki aiemmin luodut varaukset, joihin kyseisestä sijainnista suoritettava määränsiirto vaikuttaa, varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-525">All existing reservations that are affected by the quantity movement from the given location are re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-526">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-526">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-527">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-527">No</span></span></td>
<td><span data-ttu-id="bf1e0-528">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-528">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-529">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-529">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-530">Kaikki aiemmin luodut varaukset, joihin kyseisestä sijainnista suoritettava määränsiirto vaikuttaa, varataan uudelleen samalle erälle ja uudelle kohteeseen-sijainnille ja rekisterikilvelle (jos sijainti on rekisterikilpihallittu).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-530">All existing reservations that are affected by the quantity movement from the given location are re-reserved for the same batch, and for the new "to" location and license plate (if the location is license plate–controlled).</span></span></td>
</tr>
</tbody>
</table>

#### <a name="reverse-the-picked-quantity-of-completed-work-from-a-load-or-a-wave"></a><span data-ttu-id="bf1e0-531">Valmiin työn keräillyn määrän palauttaminen (kuormasta tai aallosta)</span><span class="sxs-lookup"><span data-stu-id="bf1e0-531">Reverse the picked quantity of completed work (from a load or a wave)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="bf1e0-532">Keskeiset määritysparametrit</span><span class="sxs-lookup"><span data-stu-id="bf1e0-532">Key setup parameter</span></span></th>
<th><span data-ttu-id="bf1e0-533">Erämäärä on käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-533">Batch quantity is available</span></span></th>
<th><span data-ttu-id="bf1e0-534">Keskeiset käyttäjän vaiheet</span><span class="sxs-lookup"><span data-stu-id="bf1e0-534">Key user steps</span></span></th>
<th><span data-ttu-id="bf1e0-535">Varastotyö</span><span class="sxs-lookup"><span data-stu-id="bf1e0-535">Warehouse work</span></span></th>
<th><span data-ttu-id="bf1e0-536">Tilaussidonnainen erävaraus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-536">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='6'><span data-ttu-id="bf1e0-537">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-537">Not applicable</span></span></td>
<td><span data-ttu-id="bf1e0-538">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-538">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-539">Avaa <strong>Työn palautus</strong> -sivu.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-539">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="bf1e0-540">Valitse pyyntösivulla vaihtoehto <strong>Jätä nimikkeet nykyiseen sijaintiin</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-540">On the request page, select the <strong>Leave items at current location</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-541">Kaikki tähän Kuormariviin liittyvät työt perutaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-541">All work that is associated with the load is canceled.</span></span></td>
<td><span data-ttu-id="bf1e0-542">Määrä varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-542">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-543">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-543">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-544">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-544">No</span></span></td>
<td><span data-ttu-id="bf1e0-545">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-545">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-546">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-546">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-547">Määrä varataan uudelleen samalle erälle sekä sijainnille ja rekisterikilvelle, joihin määrä jätettiin palautuksen yhteydessä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-547">The quantity is re-reserved for the same batch, and for the location and license plate where the quantity was left upon reversal.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-548">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-548">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-549">Avaa <strong>Työn palautus</strong> -sivu.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-549">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="bf1e0-550">Valitse pyyntösivulla vaihtoehto <strong>Osoita nimikkeet tähän sijaintiin</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-550">On the request page, select the <strong>Assign items to this location</strong> option.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-551">Nykyinen työ perutaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-551">The current work is canceled.</span></span></li>
<li><span data-ttu-id="bf1e0-552">Varastosiirrolle luodaan uusi työ ja se suljetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-552">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-553">Määrä varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-553">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-554">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-554">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-555">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-555">No</span></span></td>
<td><span data-ttu-id="bf1e0-556">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-556">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-557">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-557">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-558">Määrä varataan uudelleen samalle erälle sekä sijainnille ja rekisterikilvelle, joihin määrä osoitettiin palautuksen yhteydessä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-558">The quantity is re-reserved for the same batch, and for the location and license plate that the quantity was assigned to upon reversal.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-559">Kyllä/ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-559">Yes/No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-560">Avaa <strong>Työn palautus</strong> -sivu.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-560">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="bf1e0-561">Valitse pyyntösivulla vaihtoehto <strong>Siirrä nimikkeet tähän sijaintiin</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-561">On the request page, select the <strong>Move items to this location</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-562">Palautusta ei tueta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-562">Reversal isn't supported.</span></span></td>
<td><span data-ttu-id="bf1e0-563">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-563">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-564">Kyllä/ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-564">Yes/No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-565">Avaa <strong>Työn palautus</strong> -sivu.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-565">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="bf1e0-566">Valitse pyyntösivulla vaihtoehto <strong>Siirrä nimikkeet sijaintidirektiivien perusteella</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-566">On the request page, select the <strong>Move items based on location directives</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-567">Palautusta ei tueta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-567">Reversal isn't supported.</span></span> </td>
<td><span data-ttu-id="bf1e0-568">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-568">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="short-pick-a-quantity--register-the-quantity-as-physically-not-found-at-the-locationlicense-plate-while-you-perform-picking-work"></a><span data-ttu-id="bf1e0-569">Määrän lyhytkeräily – Rekisteröi määrä fyysisesti löytymättömäksi sijainnista/rekisterikilvestä, kun keräilytyötä suoritetaan</span><span class="sxs-lookup"><span data-stu-id="bf1e0-569">Short-pick a quantity – Register the quantity as physically not found at the location/license plate while you perform picking work</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="bf1e0-570">Keskeiset määritysparametrit</span><span class="sxs-lookup"><span data-stu-id="bf1e0-570">Key setup parameter</span></span></th>
<th><span data-ttu-id="bf1e0-571">Erämäärä on käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-571">Batch quantity is available</span></span></th>
<th><span data-ttu-id="bf1e0-572">Keskeiset käyttäjän vaiheet</span><span class="sxs-lookup"><span data-stu-id="bf1e0-572">Key user steps</span></span></th>
<th><span data-ttu-id="bf1e0-573">Varastotyö</span><span class="sxs-lookup"><span data-stu-id="bf1e0-573">Warehouse work</span></span></th>
<th><span data-ttu-id="bf1e0-574">Tilaussidonnainen erävaraus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-574">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="bf1e0-575">Määritetään <strong>Lyhyt keräily</strong> -tyypin poikkeus, jossa <strong>Nimikkeen uudelleenosoitus</strong> = <strong>Ei mitään</strong>, <strong>Varaston oikaisu</strong> = <strong>Kyllä</strong> ja <strong>Poista varaukset</strong> = <strong>Ei</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-575">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>None</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No</strong>.</span></span></td>
<td><span data-ttu-id="bf1e0-576">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-576">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-577">Valitse valikkovaihtoehto <strong>Lyhyt keräily</strong> varastointisovelluksessa, kun käsittelet keräilytyötä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-577">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-578">Kirjoita <strong>Keräilymäärä</strong>-kenttään <strong>0</strong> (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-578">In the <strong>Pick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-579">Kirjoita <strong>Syy</strong>-kenttään <strong>Ei uudelleenosoitusta</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-579">In the <strong>Reason</strong> field, enter <strong>No reallocation</strong>.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-580">Olemassa oleva työ suljetaan ja keräiltävä määrä on 0 (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-580">The current work is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-581"><strong>Inventointi</strong>-tyypin ja <strong>Myyty</strong>-tyypin varasto-ottotyyppi luodaan edustamaan oikaisua.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-581">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-582">Määrä varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-582">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-583">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-583">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-584">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-584">No</span></span></td>
<td><span data-ttu-id="bf1e0-585">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-585">See the previous row.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-586">Lyhyt keräilytoiminto epäonnistuu ja ilmenee virhe.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-586">The short-picking action fails, and an error is thrown.</span></span></li>
<li><span data-ttu-id="bf1e0-587">Olemassa oleva työ pysyy avoimena.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-587">The current work remains open.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-588">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-588">Not applicable</span></span></td>
</tr>
<tr>
<td rowspan='2'><span data-ttu-id="bf1e0-589">Määritetään <strong>Lyhyt keräily</strong> -tyypin poikkeus, jossa <strong>Nimikkeen uudelleenosoitus</strong> = <strong>Ei mitään</strong>, <strong>Varaston oikaisu</strong> = <strong>Kyllä</strong> ja <strong>Poista varaukset</strong> = <strong>Kyllä</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-589">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>None</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>Yes</strong>.</span></span></td>
<td><span data-ttu-id="bf1e0-590">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-590">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-591">Valitse valikkovaihtoehto <strong>Lyhyt keräily</strong> varastointisovelluksessa, kun käsittelet keräilytyötä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-591">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-592">Kirjoita <strong>Keräilymäärä</strong>-kenttään <strong>0</strong> (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-592">In the <strong>Pick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-593">Kirjoita <strong>Syy</strong>-kenttään <strong>Ei uudelleenosoitusta</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-593">In the <strong>Reason</strong> field, enter <strong>No reallocation</strong>.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-594">Olemassa oleva työ suljetaan ja keräiltävä määrä on 0 (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-594">The current work is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-595"><strong>Inventointi</strong>-tyypin ja <strong>Myyty</strong>-tyypin varasto-ottotyyppi luodaan edustamaan oikaisua.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-595">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-596">Kaikki aiemmin luodut varaukset, joihin lyhytkeräilyn sijainnin määräoikaisu vaikuttaa, varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-596">All existing reservations that are affected by the quantity adjustment in the short-picked location are re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-597">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-597">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-598">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-598">No</span></span></td>
<td><span data-ttu-id="bf1e0-599">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-599">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-600">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-600">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-601">Kaikki aiemmin luodut varaukset, joihin lyhytkeräilyn sijainnin määräoikaisu vaikuttaa, poistetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-601">All existing reservations that are affected by the quantity adjustment in the short-picked location are removed.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-602">Määritetään <strong>Lyhyt keräily</strong> -tyypin poikkeus, jossa <strong>Nimikkeen uudelleenosoitus</strong> = <strong>Manuaalinen</strong>, <strong>Varaston oikaisu</strong> = <strong>Kyllä</strong> ja <strong>Poista varaukset</strong> = <strong>Ei/Kyllä</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-602">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No/Yes</strong>.</span></span> <span data-ttu-id="bf1e0-603">Lisäksi <strong>Salli manuaalinen nimikkeiden uudelleenkohdistus</strong> -asetus on käytössä työn tekijän kohdalla.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-603">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="bf1e0-604">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-604">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-605">Valitse valikkovaihtoehto <strong>Lyhyt keräily</strong> varastointisovelluksessa, kun käsittelet keräilytyötä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-605">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-606">Kirjoita <strong>Lyhyesti keräiltävä määrä</strong>-kenttään <strong>0</strong> (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-606">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-607">Valitse <strong>Syy</strong>-kentässä <strong>Lyhytkeräily ja manuaalinen uudelleenkohdistus</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-607">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
<li><span data-ttu-id="bf1e0-608">Valitsee sijainti/rekisterikilpi luettelosta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-608">Select the location/license plate in the list.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-609">Seuraavat toiminnot tapahtuvat kulloisessakin työssä:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-609">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="bf1e0-610">Keräilyrivi suljetaan ja keräiltävä määrä on 0 (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-610">The pick line is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-611">Hyllytysrivi perutaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-611">The put line is canceled.</span></span></li>
<li><span data-ttu-id="bf1e0-612">Uusi keräilyrivi luodaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-612">A new pick line is created.</span></span> <span data-ttu-id="bf1e0-613">Siinä käytetään käyttäjän valitsemaa sijaintia/rekisterikilpeä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-613">It uses the location/license plate that the user selected.</span></span></li>
<li><span data-ttu-id="bf1e0-614">Uusi hyllytysrivi luodaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-614">A new put line is created.</span></span></li>
</ul>
</li>
<li><span data-ttu-id="bf1e0-615"><strong>Inventointi</strong>-tyypin ja <strong>Myyty</strong>-tyypin varasto-ottotyyppi luodaan edustamaan oikaisua.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-615">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-616">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-616">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-617">Määritetään <strong>Lyhyt keräily</strong> -tyypin poikkeus, jossa <strong>Nimikkeen uudelleenosoitus</strong> = <strong>Manuaalinen</strong>, <strong>Varaston oikaisu</strong> = <strong>Kyllä</strong> ja <strong>Poista varaukset</strong> = <strong>Ei</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-617">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No</strong>.</span></span> <span data-ttu-id="bf1e0-618">Lisäksi <strong>Salli manuaalinen nimikkeiden uudelleenkohdistus</strong> -asetus on käytössä työn tekijän kohdalla.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-618">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="bf1e0-619">Nro</span><span class="sxs-lookup"><span data-stu-id="bf1e0-619">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-620">Valitse valikkovaihtoehto <strong>Lyhyt keräily</strong> varastointisovelluksessa, kun käsittelet keräilytyötä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-620">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-621">Kirjoita <strong>Lyhyesti keräiltävä määrä</strong>-kenttään <strong>0</strong> (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-621">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-622">Valitse <strong>Syy</strong>-kentässä <strong>Lyhytkeräily ja manuaalinen uudelleenkohdistus</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-622">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-623">Lyhyt keräilytoiminto epäonnistuu ja ilmenee virhe.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-623">The short-picking action fails, and an error is thrown.</span></span></td>
<td><span data-ttu-id="bf1e0-624">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-624">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-625">Määritetään <strong>Lyhyt keräily</strong> -tyypin poikkeus, jossa <strong>Nimikkeen uudelleenosoitus</strong> = <strong>Manuaalinen</strong>, <strong>Varaston oikaisu</strong> = <strong>Kyllä</strong> ja <strong>Poista varaukset</strong> = <strong>Kyllä</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-625">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>Yes</strong>.</span></span> <span data-ttu-id="bf1e0-626">Lisäksi <strong>Salli manuaalinen nimikkeiden uudelleenkohdistus</strong> -asetus on käytössä työn tekijän kohdalla.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-626">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="bf1e0-627">Nro</span><span class="sxs-lookup"><span data-stu-id="bf1e0-627">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-628">Valitse valikkovaihtoehto <strong>Lyhyt keräily</strong> varastointisovelluksessa, kun käsittelet keräilytyötä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-628">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-629">Kirjoita <strong>Lyhyesti keräiltävä määrä</strong>-kenttään <strong>0</strong> (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-629">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-630">Valitse <strong>Syy</strong>-kentässä <strong>Lyhytkeräily ja manuaalinen uudelleenkohdistus</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-630">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
<li><span data-ttu-id="bf1e0-631">Valitsee sijainti/rekisterikilpi luettelosta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-631">Select the location/license plate in the list.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-632">Seuraavat toiminnot tapahtuvat kulloisessakin työssä:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-632">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="bf1e0-633">Keräilyrivi suljetaan ja keräiltävä määrä on 0 (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-633">The pick line is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-634">Hyllytysrivi perutaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-634">The put line is canceled.</span></span></li>
</ul>
</li>
<li><span data-ttu-id="bf1e0-635"><strong>Inventointi</strong>-tyypin ja <strong>Myyty</strong>-tyypin varasto-ottotyyppi luodaan edustamaan oikaisua.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-635">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="bf1e0-636">Kaikki aiemmin luodut varaukset, joihin lyhytkeräilyn sijainnin/rekisterikilven määräoikaisu vaikuttaa, poistetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-636">All existing reservations that are affected by the quantity adjustment in the short-picked location/license plate are removed.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-637">Määritetään <strong>Lyhyt keräily</strong> -tyypin poikkeus, jossa <strong>Nimikkeen uudelleenosoitus</strong> = <strong>Automaattinen</strong>, <strong>Varaston oikaisu</strong> = <strong>Kyllä/Ei</strong> ja <strong>Poista varaukset</strong> = <strong>Kyllä/Ei</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-637">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Automatic</strong>, <strong>Adjust inventory</strong> = <strong>Yes/No</strong>, and <strong>Remove reservations</strong> = <strong>Yes/No</strong>.</span></span></td>
<td><span data-ttu-id="bf1e0-638">Ei käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-638">Not applicable</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-639">Valitse valikkovaihtoehto <strong>Lyhyt keräily</strong> varastointisovelluksessa, kun käsittelet keräilytyötä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-639">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="bf1e0-640">Kirjoita <strong>Lyhyesti keräiltävä määrä</strong>-kenttään <strong>0</strong> (nolla).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-640">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="bf1e0-641">Valitse <strong>Syy</strong>-kentässä <strong>Lyhytkeräily ja automaattinen uudelleenkohdistus</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-641">In the <strong>Reason</strong> field, select <strong>Short Picking with automatic reallocation</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-642">Lyhtykeräilyä, johon liittyy automaattinen uudelleenkohdistus, ei tueta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-642">Short-picking that involves automatic reallocation isn't supported.</span></span></td>
<td><span data-ttu-id="bf1e0-643">Lyhtykeräilyä, johon liittyy automaattinen uudelleenkohdistus, ei tueta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-643">Short-picking that involves automatic reallocation isn't supported.</span></span></td>
</tr>
</tbody>
</table>

#### <a name="change-the-inventory-status"></a><span data-ttu-id="bf1e0-644">Muuta varaston tilaa</span><span class="sxs-lookup"><span data-stu-id="bf1e0-644">Change the inventory status</span></span>

> [!NOTE]
> <span data-ttu-id="bf1e0-645">Tämä varastotoiminto voidaan suorittaa useista aloituskohdista.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-645">This warehouse action can be performed from multiple entry points.</span></span> <span data-ttu-id="bf1e0-646">Tässä näkyvässä esimerkissä käytetään **Varaston tilanmuutos** -toimintoa **Käytettävissä sijainnin mukaan** -sivulla.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-646">The example that is shown here uses **Inventory status change** action on the **On-hand by location** page.</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="bf1e0-647">Keskeiset määritysparametrit</span><span class="sxs-lookup"><span data-stu-id="bf1e0-647">Key setup parameter</span></span></th>
<th><span data-ttu-id="bf1e0-648">Erämäärä on käytettävissä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-648">Batch quantity is available</span></span></th>
<th><span data-ttu-id="bf1e0-649">Keskeiset käyttäjän vaiheet</span><span class="sxs-lookup"><span data-stu-id="bf1e0-649">Key user steps</span></span></th>
<th><span data-ttu-id="bf1e0-650">Varastotyö</span><span class="sxs-lookup"><span data-stu-id="bf1e0-650">Warehouse work</span></span></th>
<th><span data-ttu-id="bf1e0-651">Tilaussidonnainen erävaraus</span><span class="sxs-lookup"><span data-stu-id="bf1e0-651">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="bf1e0-652"><strong>Varasto</strong>-tietueen <strong>Varasto</strong>-välilehden <strong>Poista varaukset ja merkinnät</strong> -kentän arvo muuttuu muotoon <strong>Varaukset</strong> tai <strong>Merkinnät ja varaukset</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-652">On the <strong>Warehouse</strong> tab, in the <strong>Warehouse</strong> record, the <strong>Remove reservations and markings</strong> field is set to <strong>Reservations</strong> or <strong>Markings and reservations</strong>.</span></span></td>
<td><span data-ttu-id="bf1e0-653">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-653">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-654">Valitse tietty sijainti.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-654">Select a specific location.</span></span></li>
<li><span data-ttu-id="bf1e0-655">Valitse rivi, jolla on tietty nimike, sijainti ja rekisterikilpi (jos sijainti on rekisterikilpihallittu).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-655">Select a line that has a specific item, location, and license plate (if the location is license plate–controlled).</span></span></li>
<li><span data-ttu-id="bf1e0-656">Valitse <strong>Varaston tilanmuutos</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-656">Select <strong>Inventory status change</strong>.</span></span></li>
<li><span data-ttu-id="bf1e0-657">Määritä <strong>Varastotila</strong>-kentän arvoksi <strong>Esto</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-657">Set the <strong>Inventory status</strong> field to <strong>Blocking</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-658">Varaston tilanmuutokset eivät ole sallittuja määrille, jotka on varattu työlle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-658">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-659">Määrä varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-659">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-660">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-660">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></li>
<li><span data-ttu-id="bf1e0-661">Kaksi tyypin <strong>Varaston tilanmuutos</strong> varastotapahtumaa luodaan edustamaan muutosta varastotiladimensiossa.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-661">Two inventory transactions of the <strong>Inventory status change</strong> type are created to represent the change in the inventory status dimension.</span></span></li>
<li><span data-ttu-id="bf1e0-662"><strong>Varastoesto</strong>-tyypin varastotapahtuma ja varasto-ottotyyppi <strong>Varattu fyysinen</strong> luodaan edustamaan estetyn määrän varausta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-662">An inventory transaction of the <strong>Inventory blocking</strong> type and the <strong>Reserved physical</strong> issue type is created to represent the reservation of the blocked quantity.</span></span></li>
</ul>
</td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-663">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-663">No</span></span></td>
<td><span data-ttu-id="bf1e0-664">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-664">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-665">Varaston tilanmuutokset eivät ole sallittuja määrille, jotka on varattu työlle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-665">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="bf1e0-666">Varaus poistetaan.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-666">The reservation is removed.</span></span></li>
<li><span data-ttu-id="bf1e0-667">Kaksi tyypin <strong>Varaston tilanmuutos</strong> varastotapahtumaa luodaan edustamaan muutosta varastotiladimensiossa.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-667">Two inventory transactions of the <strong>Inventory status change</strong> type are created to represent the change in the inventory status dimension.</span></span></li>
<li><span data-ttu-id="bf1e0-668"><strong>Varastoesto</strong>-tyypin varastotapahtuma ja varasto-ottotyyppi <strong>Varattu fyysinen</strong> luodaan edustamaan estetyn määrän varausta.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-668">An inventory transaction of the <strong>Inventory blocking</strong> type and the <strong>Reserved physical</strong> issue type is created to represent the reservation of the blocked quantity.</span></span></li>
</ul>
</td>
</tr>
<tr>
<td rowspan='2'><span data-ttu-id="bf1e0-669"><strong>Varasto</strong>-tietueen <strong>Varasto</strong>-välilehden <strong>Poista varaukset ja merkinnät</strong> -kentän arvo muuttuu muotoon <strong>Ei mitään</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-669">On the <strong>Warehouse</strong> tab, in the <strong>Warehouse</strong> record, the <strong>Remove reservations and markings</strong> field is set to <strong>None</strong>.</span></span></td>
<td><span data-ttu-id="bf1e0-670">Kyllä</span><span class="sxs-lookup"><span data-stu-id="bf1e0-670">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="bf1e0-671">Valitse tietty sijainti.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-671">Select a specific location.</span></span></li>
<li><span data-ttu-id="bf1e0-672">Valitse rivi, jolla on tietty nimike, sijainti ja rekisterikilpi (jos sijainti on rekisterikilpihallittu).</span><span class="sxs-lookup"><span data-stu-id="bf1e0-672">Select a line that has a specific item, location, and license plate (if the location is license plate–controlled).</span></span></li>
<li><span data-ttu-id="bf1e0-673">Valitse <strong>Varaston tilanmuutos</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-673">Select <strong>Inventory status change</strong>.</span></span></li>
<li><span data-ttu-id="bf1e0-674">Määritä <strong>Varastotila</strong>-kentän arvoksi <strong>Esto</strong>.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-674">Set the <strong>Inventory status</strong> field to <strong>Blocking</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="bf1e0-675">Varaston tilanmuutokset eivät ole sallittuja määrille, jotka on varattu työlle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-675">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td><span data-ttu-id="bf1e0-676">Määrä varataan uudelleen samalle erälle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-676">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="bf1e0-677">Järjestelmä määrittää satunnaisesti sijainnin ja rekisterikilven (jos sijainti on rekisterikilpihallittu), joissa määrä on käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-677">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="bf1e0-678">Ei</span><span class="sxs-lookup"><span data-stu-id="bf1e0-678">No</span></span></td>
<td><span data-ttu-id="bf1e0-679">Katso edellinen rivi.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-679">See the previous row.</span></span></td>
<td><span data-ttu-id="bf1e0-680">Varaston tilanmuutokset eivät ole sallittuja määrille, jotka on varattu työlle.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-680">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td><span data-ttu-id="bf1e0-681">Varastotilan muutokset eivät ole sallittuja.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-681">Inventory status changes aren't allowed.</span></span></td>
</tr>
</tbody>
</table>

## <a name="limitations"></a><span data-ttu-id="bf1e0-682">Rajoitukset</span><span class="sxs-lookup"><span data-stu-id="bf1e0-682">Limitations</span></span>

- <span data-ttu-id="bf1e0-683">Joustava varastotason dimensionvaraustoiminto ei tue seuraavia ominaisuuksia:</span><span class="sxs-lookup"><span data-stu-id="bf1e0-683">The flexible warehouse-level dimension reservation functionality doesn't support the following features:</span></span>

    - <span data-ttu-id="bf1e0-684">Todellisen painon hallinta</span><span class="sxs-lookup"><span data-stu-id="bf1e0-684">Catch weight management</span></span>
    - <span data-ttu-id="bf1e0-685">Fyysinen negatiivinen varasto</span><span class="sxs-lookup"><span data-stu-id="bf1e0-685">Physical negative inventory</span></span>
    - <span data-ttu-id="bf1e0-686">Varaus tilatun tarjonnan perusteella</span><span class="sxs-lookup"><span data-stu-id="bf1e0-686">Reservation against ordered supply</span></span>
    - <span data-ttu-id="bf1e0-687">Siirtotilaukset ja raaka-aineiden keräily</span><span class="sxs-lookup"><span data-stu-id="bf1e0-687">Transfer orders and raw material picking</span></span>

- <span data-ttu-id="bf1e0-688">Kontin direktiiviyksiköittäin pakkaamisen konsolidointisäännöllä on rajoituksia.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-688">The container consolidation rule for packing by directive unit has limitations.</span></span> <span data-ttu-id="bf1e0-689">Tilaussidonnaisten varausten osalta suosittelemme välttämää sellaisten kontinrakennusmallien käyttöä, joissa **Pakkaa direktiiviyksiköittäin** -kenttä on käytössä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-689">For order-committed reservations, we recommend that you not use container build templates where the **Pack by directive unit** field is enabled.</span></span> <span data-ttu-id="bf1e0-690">Nykyisessä ratkaisussa sijaintidirektiivejä ei käytetä varastotyön luonnin yhteydessä.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-690">In the current design, location directives aren't used when warehouse work is created.</span></span> <span data-ttu-id="bf1e0-691">Siksi vain yksikön sarjaryhmän alinta yksikköä (varastoyksikköä) käytetään konttiinpakkauksen aaltovaiheen aikana.</span><span class="sxs-lookup"><span data-stu-id="bf1e0-691">Therefore, only the lowest unit in the unit sequence group (the inventory unit) is applied during the containerization wave step.</span></span>
