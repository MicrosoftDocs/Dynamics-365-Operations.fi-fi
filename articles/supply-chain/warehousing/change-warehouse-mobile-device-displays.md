...
> [!NOTE]
> Tämä ominaisuus on vanhentunut. Lisätietoja on kohdassa [Poistetut tai vanhentuneet ominaisuudet](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
