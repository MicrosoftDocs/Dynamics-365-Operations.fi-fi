---
title: Kuljetuskuorman osalähetys
description: Tässä artikkelissa käsitellään kuorman osittaista toimittamista ja kuormituksen kapasiteettisuunnittelun lykkäämistä.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
