...
<span data-ttu-id="3bf8c-128">Nämä parannukset tehostavat etikettien käyttöä pakkauksissa ennen pakkausta kuormalavalle.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-128">These enhancements make it more efficient to label cartons before palletization.</span></span> <span data-ttu-id="3bf8c-129">Niistä on hyötyä etenkin suurille jälleenmyyjille lähettäville yrityksille, sillä ne vahvistavat tilausten vastaanotan lukemalla kunkin pakkauksen erikseen.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-129">They especially benefit companies that ship to large retailers that automatically confirm order receipts by scanning each carton separately.</span></span>
...
<span data-ttu-id="3bf8c-140">Tässä skenaariossa näytetään, miten yritys voi tulostaa lähetyksen etikettejä suurelle jälleenmyyjälle, joka vahvistaa tilausten vastaanotot automaattisesti lukemalla kunkin pakkauksen erikseen.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-140">This scenario shows how a company can print shipping labels for a large retailer that automatically confirms order receipts by scanning each carton separately.</span></span>
...
1. <span data-ttu-id="3bf8c-166">Lisää rivi, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-166">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="3bf8c-171">**Rivin korkeus:** *0*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-171">**Row height:** *0*</span></span>
...
1. <span data-ttu-id="3bf8c-193">Anna **tekstiosion** **Etiketin alatunniste** -kenttään vaadittavan alatunnisteen ZPL-koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-193">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="3bf8c-194">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-194">Here is an example.</span></span>
...
1. <span data-ttu-id="3bf8c-207">Valitse **Varastonhallinta \> Asetukset \> Varasto \> Yksikön sarjaryhmät**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-207">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
...
1. <span data-ttu-id="3bf8c-224">Valinnainen: Jos asiakaskohtainen etikettirakenne määritetään, asiakastilin etsimistä varten on luotava kysely.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-224">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="3bf8c-225">Valitse **Aallon etikettimallin tiedot** -pikavälilehdessä **Muokkaa kyselyä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-225">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="3bf8c-226">Lisää sitten kyselyeditorin valintaikkunan **Alue**-välilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-226">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="3bf8c-227">**Taulukko:** *Lähetykset*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-227">**Table:** *Shipments*</span></span>
...
### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="3bf8c-245">Numerosarjalaajennusten määrittäminen</span><span class="sxs-lookup"><span data-stu-id="3bf8c-245">Configure number sequence extensions</span></span>
...
- <span data-ttu-id="3bf8c-280">Kaikki lähetykset \> Lähetyksen tiedot</span><span class="sxs-lookup"><span data-stu-id="3bf8c-280">All shipments \> Shipment details</span></span>
...
1. <span data-ttu-id="3bf8c-320">Lisää rivi, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-320">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="3bf8c-328">**Riviä sivua kohden:** *5*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-328">**Rows per page:** *5*</span></span>
...
1. <span data-ttu-id="3bf8c-345">Anna **tekstiosion** **Etiketin teksti** -kenttään vaadittavan tekstin ZPL-koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-345">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="3bf8c-346">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-346">Here is an example.</span></span>
...
1. <span data-ttu-id="3bf8c-355">Lisää aallon tasomalli ja määritä seuraavat arvot ylätunnisteessa:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-355">Add a wave level template, and set the following values in the header:</span></span>
    ...
    - <span data-ttu-id="3bf8c-356">**Etikettimallin nimi:** *Konttietiketit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-356">**Label template name:** *Container labels*</span></span>
...
1. <span data-ttu-id="3bf8c-382">Lisää viisi myyntitilausriviä:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-382">Add five sales order lines:</span></span>
    ...
    - <span data-ttu-id="3bf8c-392">Myyntitilausrivi 4:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-392">Sales order line 4:</span></span>
...
- <span data-ttu-id="3bf8c-420">**Aallon etiketin asettelut:** Useita aallon etiketin asetteluja luodaan.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-420">**Wave label layouts:** You will create multiple wave label layouts.</span></span> <span data-ttu-id="3bf8c-421">Jokaisella etiketin tasolla on erillinen etiketin asettelu, minkä lisäksi keskeytysetiketillä on oma asettelu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-421">There will be a separate label layout for each "tier" of labels, and there will also be a break label layout.</span></span>

<span data-ttu-id="3bf8c-422">Tämä skenaario sisältää työnkulun alusta loppuun.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-422">This scenario shows the end-to-end flow.</span></span>

### <a name="make-demo-data-available"></a><span data-ttu-id="3bf8c-423">Demotietojen ottaminen käyttöön</span><span class="sxs-lookup"><span data-stu-id="3bf8c-423">Make demo data available</span></span>

<span data-ttu-id="3bf8c-424">Tämän skenaarion käyttäminen edellyttää, että demotiedot on asennettu ja että **USMF**-yritys on valittu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-424">To follow this scenario, you must have demo data installed, and you must select the **USMF** legal entity.</span></span>

### <a name="set-up-a-wave-process-method"></a><span data-ttu-id="3bf8c-425">Aallon käsittelymenetelmän määrittäminen</span><span class="sxs-lookup"><span data-stu-id="3bf8c-425">Set up a wave process method</span></span>

1. <span data-ttu-id="3bf8c-426">Valitse **Varastonhallinta \> Asetukset \> Aallot \> Aallon käsittelymenetelmät**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-426">Go to **Warehouse management \> Setup \> Waves \> Wave process methods**.</span></span>
1. <span data-ttu-id="3bf8c-427">Varmista, että **waveLabelPrinting** on luettelossa.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-427">Confirm that **waveLabelPrinting** is in the list.</span></span> <span data-ttu-id="3bf8c-428">Jos se ei ole luettelossa, lisää se valitsemalla toimintoruudussa **Luo menetelmät uudelleen**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-428">If it isn't, select **Regenerate methods** on the Action Pane to add it.</span></span>
1. <span data-ttu-id="3bf8c-429">Valitse **waveLabelPrinting**-menetelmässä **Tee menetelmästä toistettava** -valintaruutu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-429">For the **waveLabelPrinting** method, select the **Make method repeatable** check box.</span></span>

### <a name="set-up-a-wave-template"></a><span data-ttu-id="3bf8c-430">Aaltomallin asetuksien määrittäminen</span><span class="sxs-lookup"><span data-stu-id="3bf8c-430">Set up a wave template</span></span>

1. <span data-ttu-id="3bf8c-431">Valitse **Varastonhallinta \> Asetukset \> Aallot \> Aaltomallit**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-431">Go to **Warehouse management \> Setup \> Waves \> Wave templates**.</span></span>
2. <span data-ttu-id="3bf8c-432">Valitse malli, kuten **62 Lähetyksen oletus**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-432">Select a template, such as **62 Shipping Default**.</span></span>
3. <span data-ttu-id="3bf8c-433">Siirrä **Aallon etiketin tulostus** -menetelmä **Menetelmät**-pikavälilehdessä **Valitut menetelmät** -sarakkeeseen.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-433">On the **Methods** FastTab, move the **Wave label printing** method to the **Selected methods** column.</span></span>
4. <span data-ttu-id="3bf8c-434">Määritä **Valitut menetelmät** -sarakkeessa **Aallon vaihekoodi** -arvo, kuten *Pakkaus*, **Aallon etiketin tulostus** -menetelmään.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-434">In the **Selected methods** column, assign a **Wave step code** value, such as *Carton*, to the **Wave label printing** method.</span></span> <span data-ttu-id="3bf8c-435">Lisätietoja aallon vaihekoodeista on kohdassa [Aallon vaihekoodit](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="3bf8c-435">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>
5. <span data-ttu-id="3bf8c-436">Siirrä **Aallon etiketin tulostus** -menetelmä **Valitut menetelmät** -sarakkeeseen toisen kerran.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-436">Move the **Wave label printing** method to the **Selected methods** column a second time.</span></span>
6. <span data-ttu-id="3bf8c-437">Määritä **Valitut menetelmät** -sarakkeessa toinen **Aallon vaihekoodi** -arvo, kuten *Kuormalava*, toiseen **Aallon etiketin tulostus** -menetelmään.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-437">In the **Selected methods** column, assign a different **Wave step code** value, such as *Pallet*, to the second **Wave label printing** method.</span></span> <span data-ttu-id="3bf8c-438">Lisätietoja aallon vaihekoodeista on kohdassa [Aallon vaihekoodit](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="3bf8c-438">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>

### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="3bf8c-439">Kolmen aallon etikettiasettelun luominen</span><span class="sxs-lookup"><span data-stu-id="3bf8c-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="3bf8c-440">Valitse **Varastonhallinta \> Asetukset \> Asiakirjan reititys \> Aallon etiketin asettelut**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
1. <span data-ttu-id="3bf8c-441">Luo tietue, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-442">**Etiketin asettelutunnus:** *Pakkaus*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="3bf8c-443">**Kuvaus:** *Pakkaus (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="3bf8c-444">Valitse toimintoruudussa **Tallenna**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-444">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="3bf8c-445">Valitse toimintoruudussa **Aallon etiketin riviasetukset**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="3bf8c-446">**Aallon etiketin riviasetukset** -sivu avautuu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="3bf8c-447">Etiketin dynaaminen osa määritetään tällä sivulla.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="3bf8c-448">Lisää rivi, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-449">**Rivin tunnus:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="3bf8c-450">**Rivin taulukon nimi:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="3bf8c-451">**Rivin lähtökohta:** *0*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="3bf8c-452">Tämä kenttä määrittää pystysuunnassa paikan, josta rivi alkaa etiketissä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="3bf8c-453">**Rivin korkeus:** *0*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-453">**Row height:** *0*</span></span>

        <span data-ttu-id="3bf8c-454">Tämä kenttää määrittää kunkin rivin korkeuden (pisteinä) ZPL-standardin mukaisesti.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="3bf8c-455">Rivin korkeus on positiivinen vaakasuuntaisissa etiketeissä ja negatiivinen pystysuuntaisissa etiketeissä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="3bf8c-456">Koska tässä esimerkissä on vain yksi rivi, arvoksi voidaan määrittää *0* (nolla).</span><span class="sxs-lookup"><span data-stu-id="3bf8c-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="3bf8c-457">**Riviä sivua kohden:** *1*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="3bf8c-458">Tämä kenttä määrittää, kuinka monta riviä kuhunkin etikettiin tulostetaan.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="3bf8c-459">Tämän asetuksen seurauksena kullekin aallon etikettitaulun tietueelle tulostetaan erillinen ZPL-etiketti.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="3bf8c-460">Sulje sivu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-460">Close the page.</span></span>
1. <span data-ttu-id="3bf8c-461">Valitse toimintoruudussa **Muokkaa kyselyä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="3bf8c-462">Lisää kyselyeditorin valintaikkunan **Alue**-välilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-463">**Taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-464">**Johdettu taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-465">**Kenttä:** *Työtyyppi*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="3bf8c-466">**Ehdot:** *Keräily*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="3bf8c-467">Tämä kysely varmistaa, että etikettiin tulostetaan vain keräilytyyppiset työrivit, eikä siis poispanotyyppisiä työrivejä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="3bf8c-468">Jos haluat tulostaa rahtikirjan tunnuksen valitse **Liitokset**-välilehdessä **Työrivit**-taulu ja liitä **Lähetykset**-taulu siihen.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="3bf8c-469">Sulkee kyselyeditorin valintaikkuna.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="3bf8c-470">**Tulostimen tekstiasettelu** -pikavälilehdessä on kolme osaa, johon voi kirjoittaa tulostinkoodin: **ylätunnisteosio**, **tekstiosio** ja **alatunnisteosio**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="3bf8c-471">Anna **ylätunnisteosion** **Etiketin ylätunniste** -kenttään vaadittavan ylätunnisteen koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="3bf8c-472">Jos käytössä on esimerkiksi Zebra-tulostimet voit käyttää seuraavaa koodia.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="3bf8c-473">Anna **tekstiosion** **Etiketin teksti** -kenttään vaadittavan tekstin ZPL-koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="3bf8c-474">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-474">Here is an example.</span></span>
...
1. <span data-ttu-id="3bf8c-475">Anna **tekstiosion** **Etiketin alatunniste** -kenttään vaadittavan alatunnisteen ZPL-koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="3bf8c-476">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="3bf8c-477">Tämä asetus tulostaa yhden kopion kustakin etiketistä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="3bf8c-478">Jos kopioita tarvitaan enemmän (esimerkiksi yksi kuormalavan kummallekin puolelle), määritä alatunnisteen **\^PQn**-osan **n**-arvoksi tarvittava määrä kopioita.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="3bf8c-479">Jos kutakin etikettiä halutaan tulostaa neljä kappaletta, käytä määritystä **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="3bf8c-480">Ensimmäinen etiketti on nyt käyttövalmis.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="3bf8c-481">Luo toinen asettelutietue, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-482">**Etiketin asettelutunnus:** *Kuormalava*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="3bf8c-483">**Kuvaus:** *Kuormalava*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="3bf8c-484">Valitse toimintoruudussa **Tallenna**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="3bf8c-485">Valitse toimintoruudussa **Aallon etiketin riviasetukset**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="3bf8c-486">**Aallon etiketin riviasetukset** -sivu avautuu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="3bf8c-487">Etiketin dynaaminen osa määritetään tällä sivulla.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="3bf8c-488">Lisää rivi, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-489">**Rivin tunnus:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="3bf8c-490">**Rivin taulukon nimi:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="3bf8c-491">**Rivin lähtökohta:** *0*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="3bf8c-492">Tämä kenttä määrittää pystysuunnassa paikan, josta rivi alkaa etiketissä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="3bf8c-493">**Rivin korkeus:** *0*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-493">**Row height:** *0*</span></span>

        <span data-ttu-id="3bf8c-494">Tämä kenttää määrittää kunkin rivin korkeuden (pisteinä) ZPL-standardin mukaisesti.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="3bf8c-495">Rivin korkeus on positiivinen vaakasuuntaisissa etiketeissä ja negatiivinen pystysuuntaisissa etiketeissä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="3bf8c-496">Koska tässä esimerkissä on vain yksi rivi, arvoksi voidaan määrittää *0* (nolla).</span><span class="sxs-lookup"><span data-stu-id="3bf8c-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="3bf8c-497">**Riviä sivua kohden:** *1*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="3bf8c-498">Tämä kenttä määrittää, kuinka monta riviä kuhunkin etikettiin tulostetaan.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="3bf8c-499">Tällä asetuksella kullekin aallon etikettitaulun tietueelle tulostetaan erillinen ZPL-etiketti.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="3bf8c-500">Sulje sivu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-500">Close the page.</span></span>
1. <span data-ttu-id="3bf8c-501">Valitse toimintoruudussa **Muokkaa kyselyä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="3bf8c-502">Lisää kyselyeditorin valintaikkunan **Alue**-välilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-503">**Taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-504">**Johdettu taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-505">**Kenttä:** *Työtyyppi*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="3bf8c-506">**Ehdot:** *Keräily*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="3bf8c-507">Tämä kysely varmistaa, että etikettiin tulostetaan vain keräilytyyppiset työrivit, eikä siis poispanotyyppisiä työrivejä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="3bf8c-508">Jos haluat tulostaa rahtikirjan tunnuksen valitse **Liitokset**-välilehdessä **Työrivit**-taulu ja liitä **Lähetykset**-taulu siihen.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="3bf8c-509">Sulkee kyselyeditorin valintaikkuna.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="3bf8c-510">**Tulostimen tekstiasettelu** -pikavälilehdessä on kolme osaa, johon voi kirjoittaa tulostinkoodin: **ylätunnisteosio**, **tekstiosio** ja **alatunnisteosio**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="3bf8c-511">Anna **ylätunnisteosion** **Etiketin ylätunniste** -kenttään vaadittavan ylätunnisteen koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="3bf8c-512">Jos käytössä on esimerkiksi Zebra-tulostimet voit käyttää seuraavaa koodia.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="3bf8c-513">Anna **tekstiosion** **Etiketin teksti** -kenttään vaadittavan tekstin ZPL-koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="3bf8c-514">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-514">Here is an example.</span></span>
...
1. <span data-ttu-id="3bf8c-515">Anna **tekstiosion** **Etiketin alatunniste** -kenttään vaadittavan alatunnisteen ZPL-koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="3bf8c-516">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="3bf8c-517">Tämä asetus tulostaa yhden kopion kustakin etiketistä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="3bf8c-518">Jos kopioita tarvitaan enemmän (esimerkiksi yksi kuormalavan kummallekin puolelle), määritä alatunnisteen **\^PQn**-osan **n**-arvoksi tarvittava määrä kopioita.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="3bf8c-519">Jos kutakin etikettiä halutaan tulostaa neljä kappaletta, käytä määritystä **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="3bf8c-520">Toinen etiketti on nyt käyttövalmis.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="3bf8c-521">Luo kolmas asettelutietue, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-522">**Etiketin asettelutunnus:** *Keskeytys*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="3bf8c-523">**Kuvaus:** *Keskeytysetiketti*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="3bf8c-524">Valitse toimintoruudussa **Tallenna**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="3bf8c-525">**Tulostimen tekstiasettelu** -pikavälilehdessä on kolme osaa, johon voi kirjoittaa tulostinkoodin: **ylätunnisteosio**, **tekstiosio** ja **alatunnisteosio**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="3bf8c-526">Anna **ylätunnisteosion** **Etiketin ylätunniste** -kenttään vaadittavan ylätunnisteen ZPL-koodi.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="3bf8c-527">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-527">Here is an example.</span></span>
...
1. <span data-ttu-id="3bf8c-528">Tällä kertaa tekstiosaa ei tarvita.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-528">This time, no body is required.</span></span> <span data-ttu-id="3bf8c-529">Anna tämän vuoksi tarvittava teksti **alatunnisteosiossa**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="3bf8c-530">Esimerkki:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="3bf8c-531">Kolmas etiketti on nyt käyttövalmis.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="3bf8c-532">Tämä kolmas etiketti on keskeytysetiketti, joka erottaa etikettirullat toisistaan.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="3bf8c-533">Kahden aallon etikettityypin luominen</span><span class="sxs-lookup"><span data-stu-id="3bf8c-533">Create two wave label types</span></span>

1. <span data-ttu-id="3bf8c-534">Valitse **Varastonhallinta \> Asetukset \> Asiakirjan reititys \> Aallon etikettityypit**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="3bf8c-535">Luo tietue, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-536">**Etikettityyppi:** *Pakkaus*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="3bf8c-537">**Kuvaus:** *Pakkaus*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="3bf8c-538">Luo toinen tietue, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-539">**Etikettityyppi:** *Kuormalava*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="3bf8c-540">**Kuvaus:** *Kuormalava*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="3bf8c-541">Määritä yksikön sarjaryhmät</span><span class="sxs-lookup"><span data-stu-id="3bf8c-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="3bf8c-542">Valitse **Varastonhallinta \> Asetukset \> Varasto \> Yksikön sarjaryhmät**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="3bf8c-543">Valitse tai luo **Kpl laatikko KL** -ryhmä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="3bf8c-544">Määritä **Laatikko**-rivin **Aallon tasotyyppi** -kentän arvoksi *Pakkaus*.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="3bf8c-545">Määritä **Kuormalava**-rivin **Aallon tasotyyppi** -kentän arvoksi *Kuormalava*.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="3bf8c-546">Aallon etikettimallien luominen</span><span class="sxs-lookup"><span data-stu-id="3bf8c-546">Create wave label templates</span></span>

1. <span data-ttu-id="3bf8c-547">Valitse **Varastonhallinta \> Asetukset \> Asiakirjan reititys \> Aallon etikettimallit**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="3bf8c-548">Luo etikettimalli, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-549">**Etikettimallin nimi:** *Pakkausetiketit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="3bf8c-550">**Kuvaus:** *Pakkausetiketit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="3bf8c-551">**Aallon vaihekoodi:** *Pakkaus*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="3bf8c-552">**Varasto**: *62*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="3bf8c-553">Valitse **Yleinen**-pikavälilehden **Aallon etikettityyppi**-kentässä arvo, kuten *Pakkaus*.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="3bf8c-554">Lisää **Aallon etikettimallin tiedot** -pikavälilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-555">**Etiketin asettelutunnus:** *Pakkaus*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="3bf8c-556">**Tulostimen nimi:** valitse sopiva ZPL-tulostin.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="3bf8c-557">**Suorita kysely:** *Kyllä* (Tämä asetus on valinnainen, mutta sen käyttöä suositellaan suorituskyvyn optimoinnin vuoksi.)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="3bf8c-558">Valitse toimintoruudussa **Tallenna**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="3bf8c-559">Valinnainen: Jos asiakaskohtainen etikettirakenne määritetään, asiakastilin etsimistä varten on luotava kysely.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="3bf8c-560">Valitse **Aallon etikettimallin tiedot** -pikavälilehdessä **Muokkaa kyselyä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="3bf8c-561">Lisää sitten kyselyeditorin valintaikkunan **Alue**-välilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-562">**Taulukko:** *Lähetykset*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="3bf8c-563">**Johdettu taulu:** *Lähetykset*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="3bf8c-564">**Kenttä:** *Tilin numero*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="3bf8c-565">**Ehdot:** anna soveltuvan asiakastilin numero.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="3bf8c-566">Kun olet valmis, sulje kyselyeditorin valintaikkuna valitsemalla **OK**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="3bf8c-567">Avaa koko etikettimallin kyselyeditorin valintaikkuna valitsemalla toimintoruudussa **Muokkaa kyselyä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="3bf8c-568">Lisää kyselyeditorin valintaikkunan **Lajittelu**-välilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-569">**Taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-570">**Johdettu taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-571">**Kenttä:** *Viittauksen kuormarivin tunnus (tietuetunnus)*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="3bf8c-572">**Hakusuunta:** *Laskeva*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="3bf8c-573">Lisää toinen rivi, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-574">**Taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-575">**Johdettu taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-576">**Kenttä:** *Lähetyksen tunnus*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="3bf8c-577">**Hakusuunta:** *Laskeva*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="3bf8c-578">Sulje kyselyeditorin valintaikkuna valitsemalla **OK**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="3bf8c-579">Avautuva sanomaruutu pyytää vahvistamaan ryhmittelyn nollaustoiminnon.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="3bf8c-580">Jatka valitsemalla **Kyllä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="3bf8c-581">Valitse Toimintoruudussa **Aallon etiketin malliryhmä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="3bf8c-582">Määritä **Aalloin etiketin malliryhmä** -valintaikkunassa seuraavat arvot sille riville, jonka **Viitekentän nimi** -kentän asetuksena on *Lähetyksen tunnus*:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="3bf8c-583">**Tulosta keskeytysetiketti:** valitse tämä valintaruutu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="3bf8c-584">**Etiketin asettelutunnus:** Valitse keskeytysetiketti.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="3bf8c-585">(Valitse esimerkiksi aiemmin tässä skenaariossa luotu *Keskeytys*-etiketti.)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="3bf8c-586">**Tulostiminen nimi:** Valitse keskeytysetiketin tulostin.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="3bf8c-587">(Yleensä etikettirullien jakamista varten on syytä valita sama tulostin, joka valittiin **Aallon etikettimallin tiedot** -pikavälilehdessä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="3bf8c-588">Muutkin skenaariot ovat kuitenkin mahdollisia.)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="3bf8c-589">Valitse rivillä, jonka **Viitekentän nimi** -kentän asetuksena on *Viittauksen kuormarivin tunnus*, **Etiketin luontitunnus** -valintaruutu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="3bf8c-590">Tämä asetus luo kullekin kuormariville yhden etikettisarjan (Pakkaus 1/X) koko aallon osalta työn ryhmittelyasetuksesta riippumatta.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="3bf8c-591">Tämä etikettisarja voidaan tulostaa etikettiasetteluun.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="3bf8c-592">Lisäksi eri lähetysten etiketit erotetaan valitulla keskeytysetiketillä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="3bf8c-593">Sulje **Aallon etiketin malliryhmä** -valintaikkuna valitsemalla **OK**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="3bf8c-594">Luo toinen etikettimalli, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-595">**Etikettimallin nimi:** *Kuormalavaetiketit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="3bf8c-596">**Kuvaus:** *Kuormalavaetiketit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="3bf8c-597">**Aallon vaihekoodi:** *Kuormalava*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="3bf8c-598">**Varasto**: *62*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="3bf8c-599">Valitse **Yleinen**-pikavälilehden **Aallon etikettityyppi**-kentässä arvo, kuten *Kuormalava*.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="3bf8c-600">Lisää **Aallon etikettimallin tiedot** -pikavälilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-601">**Etiketin asettelutunnus:** *Kuormalava*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="3bf8c-602">**Tulostimen nimi:** valitse sopiva ZPL-tulostin.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="3bf8c-603">**Suorita kysely:** *Kyllä* (Tämä asetus on valinnainen, mutta sen käyttöä suositellaan suorituskyvyn optimoinnin vuoksi.)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="3bf8c-604">Valitse toimintoruudussa **Tallenna**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="3bf8c-605">Valinnainen: Jos asiakaskohtainen etikettirakenne määritetään, asiakastilin etsimistä varten on luotava kysely.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="3bf8c-606">Valitse **Aallon etikettimallin tiedot** -pikavälilehdessä **Muokkaa kyselyä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="3bf8c-607">Lisää sitten kyselyeditorin valintaikkunan **Alue**-välilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-608">**Taulukko:** *Lähetykset*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="3bf8c-609">**Johdettu taulu:** *Lähetykset*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="3bf8c-610">**Kenttä:** *Tilin numero*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="3bf8c-611">**Ehdot:** anna soveltuvan asiakastilin numero.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="3bf8c-612">Kun olet valmis, sulje kyselyeditorin valintaikkuna valitsemalla **OK**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="3bf8c-613">Avaa koko etikettimallin kyselyeditorin valintaikkuna valitsemalla toimintoruudussa **Muokkaa kyselyä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="3bf8c-614">Lisää kyselyeditorin valintaikkunan **Lajittelu**-välilehdessä rivi, jolla on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-615">**Taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-616">**Johdettu taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-617">**Kenttä:** *Viittauksen kuormarivin tunnus (tietuetunnus)*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="3bf8c-618">**Hakusuunta:** *Laskeva*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="3bf8c-619">Lisää toinen rivi, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-620">**Taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-621">**Johdettu taulu:** *Työrivit*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="3bf8c-622">**Kenttä:** *Lähetyksen tunnus*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="3bf8c-623">**Hakusuunta:** *Laskeva*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="3bf8c-624">Sulje kyselyeditorin valintaikkuna valitsemalla **OK**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="3bf8c-625">Avautuva sanomaruutu pyytää vahvistamaan ryhmittelyn nollaustoiminnon.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="3bf8c-626">Jatka valitsemalla **Kyllä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="3bf8c-627">Valitse Toimintoruudussa **Aallon etiketin malliryhmä**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="3bf8c-628">Määritä **Aalloin etiketin malliryhmä** -valintaikkunassa seuraavat arvot sille riville, jonka **Viitekentän nimi** -kentän asetuksena on *Lähetyksen tunnus*:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="3bf8c-629">**Tulosta keskeytysetiketti:** valitse tämä valintaruutu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="3bf8c-630">**Etiketin asettelutunnus:** Valitse keskeytysetiketti.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="3bf8c-631">(Valitse esimerkiksi aiemmin tässä skenaariossa luotu *Keskeytys*-etiketti.)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="3bf8c-632">**Tulostiminen nimi:** Valitse keskeytysetiketin tulostin.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="3bf8c-633">(Yleensä etikettirullien jakamista varten on syytä valita sama tulostin, joka valittiin **Aallon etikettimallin tiedot** -pikavälilehdessä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="3bf8c-634">Muutkin skenaariot ovat kuitenkin mahdollisia.)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="3bf8c-635">Valitse rivillä, jonka **Viitekentän nimi** -kentän asetuksena on *Viittauksen kuormarivin tunnus*, **Etiketin luontitunnus** -valintaruutu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="3bf8c-636">Tämä asetus luo kullekin kuormariville yhden etikettisarjan (Pakkaus 1/X) koko aallon osalta työn ryhmittelyasetuksesta riippumatta.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="3bf8c-637">Tämä etikettisarja voidaan tulostaa etikettiasetteluun.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="3bf8c-638">Lisäksi eri lähetysten etiketit erotetaan valitulla keskeytysetiketillä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="3bf8c-639">Numerosarjalaajennusten määrittäminen</span><span class="sxs-lookup"><span data-stu-id="3bf8c-639">Configure number sequence extensions</span></span>

<span data-ttu-id="3bf8c-640">Numerosarjalaajennuksilla hallitaan tiettyjen numerosarjojen GS1-vaatimustenmukaisuutta.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="3bf8c-641">Tämä määritys on valinnainen nykyisessä skenaariossa.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="3bf8c-642">Lisätietoja ja määritysohjeet ovat kohdassa [Numerosarjalaajennusten määrittäminen](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="3bf8c-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="3bf8c-643">Myyntitilauksen luominen ja sen vapauttaminen varastoon</span><span class="sxs-lookup"><span data-stu-id="3bf8c-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="3bf8c-644">Valitse **Myynti ja markkinointi \> Myyntitilaus \> Kaikki myyntitilaukset**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="3bf8c-645">Luo myyntitilaus, jossa on seuraavat asetukset:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="3bf8c-646">**Asiakastili:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="3bf8c-647">**Varasto**: *62*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="3bf8c-648">Lisää kaksi myyntitilausriviä:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="3bf8c-649">Myyntitilausrivi 1:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-649">Sales order line 1:</span></span>

        - <span data-ttu-id="3bf8c-650">**Nimiketunnus:** *A0001*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="3bf8c-651">**Määrä** *9024*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="3bf8c-652">**Yksikkö:** *kpl* (9024 kpl = 376 laatikkoa = 47 kuormalavaa)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="3bf8c-653">Myyntitilausrivi 2:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-653">Sales order line 2:</span></span>

        - <span data-ttu-id="3bf8c-654">**Nimiketunnus:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="3bf8c-655">**Määrä** *9016*</span><span class="sxs-lookup"><span data-stu-id="3bf8c-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="3bf8c-656">**Yksikkö:** *kpl* (9016 kpl = 322 laatikkoa = 46 kuormalavaa)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="3bf8c-657">Nämä nimikkeet ja määrät ovat vain esimerkkejä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="3bf8c-658">Niiden on käytettävä aiemmin määritettyä yksikön sarjaryhmää, niille on määritettävä soveltuva yksikkömuunnos *kappaleesta* *laatikkoon* ja edelleen *kuormalavaksi* ja niiden varaston on oltava varastossa *62*.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="3bf8c-659">Lisätietoja on kohdassa [Mittayksikkö ja varastointikäytännöt](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="3bf8c-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="3bf8c-660">Valitse tilausrivi 1.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-660">Select sales order line 1.</span></span> <span data-ttu-id="3bf8c-661">Valitse sitten **Myyntitilausrivi**-osan **Varasto**-valikossa **Varaukset**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="3bf8c-662">Valitse **Varaus**-sivun toimintoruudussa **Varaa erä** ja sulje sitten sivu.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="3bf8c-663">Toista vaiheet 4 ja 5 myyntitilausriville 2.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="3bf8c-664">Valitse toimintoruudussa **Varasto**-välilehdellä **Vapauta varastoon**.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="3bf8c-665">Seuraavat tapahtumat:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-665">The following events occur:</span></span> 

    - <span data-ttu-id="3bf8c-666">Järjestelmä käsittelee luodun lähetyksen käyttämällä etiketin tulostusvaiheen sisältävää mallia.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="3bf8c-667">Etiketin asettelun avulla määritetään etiketin muoto, ja näin saatu etiketti tulostetaan etikettimallissa valitulla tulostimella.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="3bf8c-668">Aallon etiketit luodaan ja tulostetaan.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="3bf8c-669">Etikettien määrä on sama kuin pakkausten määrä. (Tässä esimerkissä rivillä 1 on 376 laatikkoetikettiä ja rivillä 2 on 322 laatikkoetikettiä; rivillä 1 on 47 kuormalavaetikettiä ja rivillä 2 on 47 kuormalavaetikettiä, minkä lisäksi kahdessa keskeytysetiketissä on lähetyksen tunnus.)</span><span class="sxs-lookup"><span data-stu-id="3bf8c-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="3bf8c-670">Lähetyksille luodaan uusi rahtikirjan tunnus.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="3bf8c-671">Jos numerosarjalaajennukset määritettiin, aallon etikettitunnus noudattaa **SSCC-18**-lukumuotoilua.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="3bf8c-672">Voit tarkastella aallon etikettejä ja tulostaa niitä uudelleen seuraavilta sivuilta:</span><span class="sxs-lookup"><span data-stu-id="3bf8c-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="3bf8c-673">Kaikki lähetykset \> Lähetyksen tiedot</span><span class="sxs-lookup"><span data-stu-id="3bf8c-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="3bf8c-674">Kaikki kuormat \> Kuorman tiedot</span><span class="sxs-lookup"><span data-stu-id="3bf8c-674">All loads \> Load details</span></span>
- <span data-ttu-id="3bf8c-675">Kaikki aallot</span><span class="sxs-lookup"><span data-stu-id="3bf8c-675">All waves</span></span>
- <span data-ttu-id="3bf8c-676">Aalto-otsikot</span><span class="sxs-lookup"><span data-stu-id="3bf8c-676">Wave labels</span></span>
- <span data-ttu-id="3bf8c-677">Aallon etikettihistoria</span><span class="sxs-lookup"><span data-stu-id="3bf8c-677">Wave label history</span></span>

<span data-ttu-id="3bf8c-678">Useimmilla näistä sivuista sopiva toiminto löytyy valitsemalla **Aallon etiketit** toimintoruudun **Lähetykset**-välilehden **Liittyvät tiedot** -ryhmässä.</span><span class="sxs-lookup"><span data-stu-id="3bf8c-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>

## <a name="additional-resources"></a><span data-ttu-id="3bf8c-679">Lisäresurssit</span><span class="sxs-lookup"><span data-stu-id="3bf8c-679">Additional resources</span></span>

- [<span data-ttu-id="3bf8c-680">Aallon etikettien tulostaminen uudelleen ja mitätöinti</span><span class="sxs-lookup"><span data-stu-id="3bf8c-680">Reprint and void wave labels</span></span>](reprint-and-void-wave-labels.md)
