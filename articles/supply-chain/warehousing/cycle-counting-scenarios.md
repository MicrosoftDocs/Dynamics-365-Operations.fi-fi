...
Ennen kuin voit käyttää uutta Warehouse Management -mobiilisovellusta, sinun on lisättävä sen tuki järjestelmään. Järjestelmänvalvojat voivat käyttää [toimintojen hallinnan](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) asetuksia ja tarkistaa toiminnon tilan sekä laittaa sen päälle tarvittaessa. **Ominaisuuksien hallinta** -työtilassa ominaisuus on luetteloitu seuraavalla tavalla:
...
1. Määritä **Varasto**-pikavälilehdessä seuraavat arvot:
    ...
    - **Käytä varastonhallintaprosessia:** *Kyllä* (Tämä arvo mahdollistaa fyysisen varaston varastonhallintaprosessit.)
