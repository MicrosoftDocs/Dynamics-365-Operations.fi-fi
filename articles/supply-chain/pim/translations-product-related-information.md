...
description: Tässä artikkelissa kuvataan, kuinka tuotteiden, tuotteen dimensioarvojen ja tuotemääritteiden käännöksiä hallitaan.
author: t-benebo
ms.date: 08/06/2020
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa kuvataan, kuinka tuotteiden, tuotteen dimensioarvojen ja tuotemääritteiden käännöksiä hallitaan. 
