...
description: Tässä ohjeaiheessa käsitellään Microsoft Dynamics 365 for Finance and Operationsin myynninedistämispalkkioiden hallintaa.
author: t-benebo
manager: AnnBe
ms.date: 08/17/2018
ms.topic: article
