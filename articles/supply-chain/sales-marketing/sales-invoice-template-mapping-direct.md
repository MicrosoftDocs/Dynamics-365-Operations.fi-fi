...
Tässä ohjeaiheessa käsitellään malleja ja tehtäviä, joilla Microsoft Dynamics 365 for Finance and Operations, Enterprise editionin myyntilaskujen otsikot ja rivit synkronoidaan suoraan Microsoft Dynamics 365 for Salesiin.
