...
description: Tässä artikkelissa on yleiskuvaus Dynamics 365 Supply Chain Managementin ja Dynamics 365 Salesin välisestä Prospektista käteiseksi -ratkaisusta.
author: Henrikan
ms.date: 04/25/2018
ms.topic: article
ms.prod: ''
