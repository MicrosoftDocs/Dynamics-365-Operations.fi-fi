...
Tässä aiheessa kuvataan toimipaikkojen ja varastojen tietojen integraatiota Finance and Operationsin ja Common Data Servicen välillä. Toiminnalliset toimipaikat ja varastot ovat toimitusketjunhallintasovelluksessa yleisiä käsitteitä. Niitä käytetään yrityksen toimitusketjun mallintamiseen.
...
## <a name="operational-sites"></a>Toimipaikat

Toiminnalliset toimipaikat ovat käytettävissä Common Data Servicessa seuraavien yhdistämismääritysten avulla.
...
## <a name="warehouses"></a>Varastot

Varastot ovat käytettävissä seuraavien yhdistämismääritysten avulla.
