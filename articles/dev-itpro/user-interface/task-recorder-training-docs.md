...
ms.locfileid: "1570996"
---
# <a name="create-documentation-or-training-by-using-task-recordings"></a>Dokumentaation tai koulutuksen luominen tehtävätallenteiden avulla
...
> [!IMPORTANT]
> Vaikka voit tallentaa omia Dynamics 365 for Talent -tehtäväoppaita, et voi tallentaa niitä tällä hetkellä BPM- eli liiketoimintaprosessin mallintajakirjastoon tai avata niitä Ohje-ruudusta. Voit tallentaa ne paikallisesti tai verkkosijaintiin sekä avata ja toistaa ne tehtävien tallennustoiminnolla. 
