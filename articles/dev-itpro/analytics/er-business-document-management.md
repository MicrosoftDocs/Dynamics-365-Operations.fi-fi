...
Yritystiedostojen hallinnan käyttäminen mallien muokkaamiseen Excel- tai Word-muodoissa Microsoft Office -työpöytäsovellusten avulla edellyttää, että asennettuna on Microsoft Office 2010 tai uudempi. Tätä tuetaan Finance and Operationsin pilvipohjaisessa ja paikallisessa käyttöönotossa.
...
Sinun on tuotava yritysasiakirjojen malleja sisältäviä ER-konfiguraatioita nykyiseen Finance and Operations -esiintymään. Suorita nämä toimet lataamalla ja ja tallentamalla paikallisesti seuraavat tiedostot.
...
Lisätietoja uusien ominaisuuksien aktivoinnista on kohdassa [ominaisuuksien hallinnan yleiskuvaus](../../fin-and-ops/get-started/feature-management/feature-management-overview.md).
...
Lisätietoja tarvittavien tiedoston hallintaparametrien ja tiedostotyyppien määrittämisestä on kohdassa [tiedostojen hallinnan määrittäminen](../../fin-and-ops/organization-administration/configure-document-management.md).
...
1. Kirjaudu sisään Finance and Operationsiin käyttäjänä, jolla on käyttöoikeus **Liiketoiminta-asiakirjan parametrit** -sivulle.
...
1. Kirjaudu sisään Finance and Operationsiin käyttäjänä, jolla on käyttöoikeus **Käyttöoikeuksien määritys** -sivulle.
...
Kun tämä asetus on käytössä, kaikki sellaiseen käyttöoikeusrooliin määritetyt käyttäjät, jotka on määritetty suorittamaan tehtävä **Liiketoiminta-asiakirjamallien hallinta** (AOT-nimi **ERBDManageTemplates**), voivat avata yritysasiakirjan hallinnan työtilan ja muokata mitä tahansa Finance and Operationsissa käytettävissä olevaa mallia.
...
> [!NOTE]
> **Määrityskohtaiset käyttöoikeudet** -säännöt tallennetaan käyttämällä ER-muotokonfiguraation yksilöivää tunnusta. Tämä tarkoittaa, että näitä sääntöjä ei poisteta, kun niihin viittaava ER-konfiguraatio poistetaan. Kun tuot poistetut konfiguraatiot takaisin tähän Finance and Operations -esiintymään, nämä säännöt viittaavat niihin uudelleen. Sääntöjä ei tarvitse määrittää uudelleen poistettujen konfiguraatioiden tuomisen jälkeen.
...
1. Kirjaudu sisään Finance and Operationsiin käyttäjänä, jolla on käyttöoikeus liiketoiminta-asiakirjojen hallinnan työtilaan.
...
Finance and Operationsin **BDM-mallieditorin** sivu avautuu. Valittu malli on käytettävissä online-muokkausta varten käyttämällä Office 365:tä.
...
1. Vaihda **USMF**-yritykseen Finance and Operationsissa.
...
Tämä on tunnettu ongelma, jossa Office 365 uudelleenohjaa takaisin Finance and Operationsiin. Näin tapahtuu, kun kirjaudut Office 365:een ensimmäisen kerran. Voit välttää tämän ongelman valitsemalla selaimesi **Takaisin**-painikkeen ja siirtymällä takaisin Finance and Operationsiin.
...
Olet todennäköisesti kirjauduit Azure AD -toimialueen nykyiseen Finance and Operations -esiintymään, joka eroaa Azure AD -toimialueesta, jota käytettiin tämän Finance and Operations -esiintymän käyttöönotossa. Koska SharePoint-palvelu, johon tallennetaan malleja, joiden avulla niitä voidaan muokata Office-työpöytäsovellusten avulla, kuuluu samaan toimialueeseen kuin Finance and Operations, meillä ei ole oikeuksia käyttää SharePoint-palvelua. Voit ratkaista tämän ongelman kirjautumalla nykyiseen Finance and Operations -esiintymään käyttäen oikean Azure AD -toimialueen käyttäjän tunnistetietoja.
