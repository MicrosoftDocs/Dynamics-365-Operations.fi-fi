...
1. Siirry kohtaan Organisaation hallinto > Työtilat > Sähköinen raportointi.
    ...
    * Oletetaan, että suunnittelet saapuvien tiliotteiden jäsennysprosessia sovellustietojen päivitys varten. Saat saapuvat tiliotteet TXT-tiedostoina, joissa on IBAN-koodeja. IBAN-koodit on tarkistettava tiliotteiden osana tuontiprosessia. Tähän tarkistukseen käytetään Dynamics 365 for Finance and Operationsiin sisältyvää logiikkaa.   
