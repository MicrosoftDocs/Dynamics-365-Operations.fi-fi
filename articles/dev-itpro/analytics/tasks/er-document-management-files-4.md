...
---
# <a name="run-format-to-use-document-management-files-in-format-outputs"></a>Tiedostonhallinnan tiedostojen käyttäminen muodon tuotoksissa suorittamalla muoto 
