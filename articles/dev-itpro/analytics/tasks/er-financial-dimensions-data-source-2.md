...
---
# <a name="map-models--to-use-financial-dimensions-as-a-data-source-for-electronic-reporting-er"></a>Mallien yhdistäminen käyttämään taloushallinnon dimensioita tietolähteenä sähköistä raportointia varten (ER)
