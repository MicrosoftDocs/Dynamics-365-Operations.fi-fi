...
---
# <a name="prepare-data-model-to-use-document-management-files-in-format-outputs"></a>Tiedostonhallinnan tiedostojen käyttäminen muodon tuotoksissa valmistelemalla tietomalli
