...
Raportin suunnittelija voi luoda sarakeotsikoita automaattisesti automaattisen tekstin koodien perusteella. Automaattisen tekstin koodit ovat muuttujia, jotka päivitetään aina raportin luomisen yhteydessä. Mikä tahansa sarakeotsikko voi sisältää näitä koodeja. Ne määrittävät raportin muuttuvia tietoja, kuten päivämääriä ja jaksojen numeroita. Tämän vuoksi useissa raportin määrityksissä, ajanjaksoissa ja raportointipuissa voidaan käyttää yhtä sarakkeen määritystä. Koska koodit käyttävät kalenteritietoja sarakemäärityksen tietoriveistä, autotext-koodeja tuetaan vain <strong>CALC</strong>-, <strong>FD</strong>- ja <strong>WKS</strong>-sarakkeissa. Tapa, jolla automaattisen tekstin koodi näkyy sarakeotsikon solussa, vaikuttaa siihen, miten tiedot näkyvät raportissa. - <strong>Sarakkeen otsikko</strong> -valintaikkunassa automaattisen tekstin koodit näkyvät eri kirjainkokoina. Tämän vuoksi teksti näkyy näin myös raportissa. Esimerkiksi vakiokalenterivuosi <strong>@CalMonthLong</strong> muuntaa kuukauden <strong>7</strong> <strong>heinäkuuksi</strong>. Jos kuukauden nimi tulee kirjoittaa isoilla kirjaimilla (esimerkiksi <strong>HEINÄKUU</strong>), syötä automaattisen tekstin koodi isoilla kirjaimilla <strong>Sarakeotsikon teksti</strong> -kenttään. Kirjoita esimerkiksi <strong>@CALMONTHLONG</strong>. Tekstissä voi käyttää sekä isoja ja pieniä kirjaimia. Syötät esimerkiksi seuraavan otsikkotekstin: <strong>Kausi @FiscalPeriod-@FiscalYear - @StartDate,@EndDate</strong>. Luotu raportin otsikko muistuttaa seuraavaa tekstiä: <strong>Jakso 1–02 01/01/02–01/31/02</strong>. <strong>Huomautus:</strong> Joidenkin tekstien muoto, kuten pitkä päivämäärä, riippuu Finance and Operations -palvelimen alueellisista asetuksista. Voit muuttaa näitä asetuksia valitsemalla <strong>Käynnistä</strong>-painikkeen, <strong>Ohjauspaneeli</strong>-kohdan ja valitsemalla sitten <strong>Alue ja kieli</strong> -kohdan. Seuraavassa taulukossa luetellaan sarakeotsikoiden käytettävissä olevat automaattisen tekstin asetukset.
...
|----------------------------------------------|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|         Kansallinen/alkuperäinen valuutta         | <strong>JENI</strong> |                                                                   <strong>6 000 Y</strong> – tulos näyttää vain ne tapahtumat, jotka on syötetty JENIN määräisinä.                                                                   |
| Perusvaluutta yrityksen tiedoista | <strong>JENI</strong> |          <strong>60 $</strong> - tulos näyttää vain ne tapahtumat, jotka on syötetty JENI-määräisinä, ja näyttää ne USD-määräisinä. <strong>Huomautus:</strong> muuntokurssi on noin 100 JPY yhtä Yhdysvaltain dollaria kohden.           |
| Perusvaluutta yrityksen tiedoista |        Tyhjä         | <strong>2 310\*\</strong>* – Tuloksessa näytetään kaikki tiedot yrityksen tiedoissa määritetyssä perusvaluutassa. <strong>Huomautus:</strong> tämä määrä on perusvaluuttasumma kaikissa tapahtumissa. |
|         Kansallinen/alkuperäinen valuutta         |        Tyhjä         |                                                       <strong>2 250 $</strong> – tulos näyttää kaikki valuutan summat, jossa tapahtuma suoritettiin.                                                        |

### <a name="calculation-column-in-a-column-definition"></a>Laskenta-sarake sarakkeen määrityksessä

Sarakemäärityksen saraketyyppi (**LASK**) tukee monimutkaisia laskelmia <strong>Kaava</strong>-solussa. Se voi sisältää operaattoreita (<strong>+</strong>,<strong>-</strong>, <strong>\</strong> ja **/*) sekä myös <strong>IF/THEN/ELSE</strong>-lausekkeita. Laskenta-sarake, voi myös viitata toiseen sarakkeeseen, myös seuraaviin sarakkeisiin. Laskelmasarake voi myös sisältää tilikauden ja jakson, jotka tukevat sarakkeen otsikoita. Laskentakaavan pituus voi olla enintään 1 024 merkkiä. Käytä erityistä muotoilun ohitusta, jos haluat esittää laskutoimituksen tuloksen prosenttilukuna. <strong>Huomautus:</strong> Kaavojen laskemisen tulokset eivät sisällä arvoja tulostumattomista sarakealueista. <strong>A:D</strong>-laskelma esimerkiksi tulostaa arvon <strong>0</strong> (nolla), kun taas tulostumattomien arvojen <strong>A+B+C</strong>-laskelma laskee arvon.
