...
## [Paikalliset ISV-käyttöoikeudet](dev-tools/isv-licensing-on-prem.md)
...
#### [Paikallisten ympäristöjen käyttöönotto Platform update 8- ja Platform update 11 -päivityksillä](deployment/setup-deploy-on-premises-pu8-pu11.md)

### [Mukautettujen mallien kehittäminen ja käyttöönotto paikallisissa ympäristöissä](deployment/develop-deploy-custom-models-on-premises.md)
...
## [Ympäristöpalvelujen käynnistäminen uudelleen](lifecycle-services/restart-environment-services.md)
