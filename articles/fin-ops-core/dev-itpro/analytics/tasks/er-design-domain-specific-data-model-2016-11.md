...
description: Tässä artikkelissa käsitellään sellaisen uuden sähköisen raportoinnin (ER) määrityksen luontia, joka sisältää sähköisten maksuasiakirjojen tietomallin.
author: kfend
ms.date: 08/29/2018
