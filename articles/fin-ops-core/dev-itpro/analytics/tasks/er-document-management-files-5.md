...
description: Tässä artikkelissa käsitellään sähköisen raportoinnin (ER) muodon määrittämisestä käyttämään tiedostonhallinnan tiedostoja (liitteitä) ER-tuotoksissa. (Osa 5)
author: kfend
ms.date: 08/29/2018
