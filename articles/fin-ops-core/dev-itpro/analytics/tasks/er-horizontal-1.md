...
description: Tässä artikkelissa käsitellään sähköisen raportoinnin (ER) muodon määrittämistä luomaan raportteja OPENXML-laskentataulukkomuotoisina Excel-tiedostoina. (Osa 1)
author: NickSelin
ms.date: 04/23/2021
