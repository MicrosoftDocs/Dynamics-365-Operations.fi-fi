...
description: Tässä artikkelissa on tietoja tavasta, jolla käyttäjä voi suunnitella ER-muodon määrityksen tuomaan tiedostoja valinnaisia määritteitä sisältävän XML-muodon.
author: kfend
ms.date: 07/01/2019
