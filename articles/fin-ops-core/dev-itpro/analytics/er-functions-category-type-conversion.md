...
description: Tässä artikkelissa on tietoja sähköisen raportoinnin (ER) tukemista muunnosfunktioista.
author: kfend
ms.date: 12/05/2019
ms.prod: ''
ms.technology: ''
...
ms.locfileid: "9292613"
---
# <a name="list-of-er-functions-in-the-type-conversion-category"></a>Luettelo ER-funktioista tyypinmuutosluokassa

[!include [banner](../includes/banner.md)]

Sähköisen raportoinnin (ER) tyyppimuuntofunktioita voidaan käyttää arvojen muuntamiseen tyyppien välillä. Tässä artikkelissa on yhteenveto näistä funktioista.
