...
4. Huomaa, että valitun **BACS (Iso-Britannia)** -ER-muodon lisäksi myös muita tarvittavia ER-konfiguraatioita tuotiin. Varmista, että konfiguraatiopuussa ovat saatavilla seuraavat ER-konfiguraatiot:
    ...
    - **Maksumalli** – tämä konfiguraatio sisältää [tietomallin](general-electronic-reporting.md#data-model-and-model-mapping-components) ER-osan, joka esittää maksun liiketoimintatoimialueen tietorakenteen.
