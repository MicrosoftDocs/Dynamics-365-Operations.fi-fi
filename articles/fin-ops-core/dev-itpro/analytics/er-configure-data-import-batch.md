...
description: Tässä ohjeaiheessa kerrotaan, miten tiedot tuodaan manuaalisesti valituista tiedostoista erätilassa.
author: NickSelin
ms.date: 01/07/2022
ms.topic: article
ms.prod: ''
...
Tässä ohjeaiheessa kerrotaan, miten suoritetaan tietojen tuonti manuaalisesti valitusta tiedostosta erätilassa. Esimerkissä käytetään toimittajatapahtumia liiketoimintatietoina. Näiden esimerkkien vaiheet voidaan suorittaa **USMF**-yrityksessä. Koodausta ei tarvita.
