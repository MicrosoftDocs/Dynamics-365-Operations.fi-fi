---
title: Luotujen raporttitulosten seuraaminen ja vertaaminen perusarvoihin
description: Tässä artikkelissa on tietoja tavasta, jolla voit verrata tuloksia luoduista sähköisen raportoinnin (ER) raporteista perusriviraportin arvoihin.
author: NickSelin
ms.date: 06/17/2019
ms.topic: article
ms.prod: ''
