...
Tässä esimerkissä näytetään, miten käyttäjä, jolla on rooli **Järjestelmänvalvoja** tai  **Sähköisen raportoinnin toiminnallinen konsultti**  voii määrittää ER-muodon luodun asiakirjan pakkaamista varten.
