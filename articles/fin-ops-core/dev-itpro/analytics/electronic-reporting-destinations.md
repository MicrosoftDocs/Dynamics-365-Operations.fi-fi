...
Financen **versiosta 10.0.9** eteenpäin PDF-muunnoksen asetus on käytettävissä vain pilvikäyttöönotoissa. Finance-versiosta **10.0.27** alkaen PDF-muuntovaihtoehto on käytettävissä kaikissa paikallisissa käyttöönotoissa, joissa on käytössä [Internet-yhteys](../user-interface/client-disconnected.md).
