...
description: Tässä artikkelissa kerrotaan, miten ER-siirron tyhjennystoiminnon avulla voidaan ratkaista ER:n malleihin liittyviä ongelmia.
author: kfend
ms.date: 04/29/2020
ms.topic: article
ms.prod: ''
