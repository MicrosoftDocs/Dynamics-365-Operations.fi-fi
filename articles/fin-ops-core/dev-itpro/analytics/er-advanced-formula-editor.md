...
## <a name="ActivateAdvEditor">Kehittyneen kaavaeditorin aktivointi</a>
...
## <a name="Autoformatting">Koodin automaattinen muotoilu</a>
...
## <a name="CodeCompletion">Ennakoiva koodinsyöttö</a>
...
## <a name="CodeNavigation">Koodin selaus</a>
...
## <a name="CodeStructuring">Koodin jäsentäminen</a>
...
## <a name="FindAndReplace">Etsi ja korvaa</a>
...
## <a name="DataPasting">Tietolähteiden ja toimintojen liittäminen</a>
...
## <a name="SyntaxColorization">Syntaksin värittäminen</a>
