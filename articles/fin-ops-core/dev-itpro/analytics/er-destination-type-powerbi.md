...
Voit määrittää Microsoft Power BI -kohteen kullekin lähteviä asiakirjoja luomaan määritetylle sähköisen raportoinnin (ER) muodon kansio- tai tiedostokomponentille. Luotu tiedosto tallennetaan aiemmin määritettyyn SharePoint-kansioon kohteen asetuksen mukaan.
