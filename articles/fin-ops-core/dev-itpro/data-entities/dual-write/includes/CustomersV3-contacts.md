## <a name="customers-v3-to-contacts"></a>Asiakkaat V3 yhteyshenkilöihin

Tämä malli synkronoi tiedot Finance and Operations -sovellusten ja Common Data Servicen välillä.

Lähdesuodatin: ((PartyType == "Person"))

Käänteinen lähdesuodatin: msdyn_sellable eq true  and msdyn_contactpersonid ne ''
