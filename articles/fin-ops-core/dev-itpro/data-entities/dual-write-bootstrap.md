...
Sinulla on ehkä aiemmin luotu Common Data Servicen tai muunDynamics 365 -sovelluksen esiintymä, jossa on yritystietoja, ja haluat ottaa siihen liittyvän kaksoiskirjoitusyhteyden käyttöön. Siinä tapauksessa Common Data Service tai muu Dynamics 365 -sovellus on käynnistettävä yritystietoja käyttäen ennen kaksoiskirjoitusyhteyden ottamista käyttöön.  
...
4. Ota **Cdm_companies**-entiteettikartta käyttöön. Se synkronoi Finance and Operations -sovelluksen yritykset Common Data Serviceen.  
    > [!div class="mx-imgBorder"]
...
6. Kun käynnistys on tehty ja järjestelmä on valmis reaaliaikaiseen synkronointiin, ota entiteettikartat käyttöön.  

    Entiteettikarttojen ottaminen käyttöön käynnistää käyttöönotettujen entiteettikarttojen ensimmäisen tietojen synkronoinnin. Kaksoiskirjoitusyhteydessä valittuja yrityksiä vastaavat tiedot synkronoidaan Finance and Operations -sovelluksen ja Common Data Servicen välillä. 
 
## <a name="how-to-i-use-the-code-sample"></a>Miten koodinäytettä käytetään?
Näytekoodi on C#-sovellus, jonka voi ladata Visual Studiossa. Se käyttää NuGet-paketin riippuvuuksia Common Data Servicen SDK:ssa, ja niitä voi päivittää Visual Studio -vakiotyökaluilla. 
