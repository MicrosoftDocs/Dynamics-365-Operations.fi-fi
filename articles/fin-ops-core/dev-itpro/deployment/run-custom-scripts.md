...
1. Valitse talous- ja toimintosovelluksessa **Järjestelmänvalvonta \> Kausittaiset tehtävät \> Tietokanta \> Mukautetut komentosarjat**.
...
Sen sijaan, että otat käyttöön käyttöönotettavan paketin talous- ja toimintosovellusten käyttöliittymässä edellisessä osassa kuvatulla tavalla, voit ladata sen LCS-palveluun ja ottaa sen käyttöön tavalliseen tapaan. Lisätietoja: [Käyttöönotettavien pakettien asentaminen komentoriviltä](../deployment/install-deployable-package.md).
