...
| \*Tositteen jatkuvuustarkistus – Kiina                                                                                               | Kiina                             |
...
| \*Verojen perusintegrointiprofiilin määrittäminen – Kiina                                                                                 | Kiina                             |
...
| \*EUR-00015 Osaouolen haku ALV-tunnuksen avulla                                                                                            | Eurooppa                            |
...
### <a name="performance-management"></a>Suorituskyvyn hallinta

| BPM-tunnistusrivi                                                     | Maa/alue |
|--------------------------------------------------------------|----------------|
| \*Merkintöjen lisääminen työsuorituksen kirjauskansioon ja kehujen lähettäminen | Yleinen         |
| \*Tavoitteen luominen                                              | Yleinen         |
| \*Työsuorituksen arvioinnin luominen                                | Yleinen         |
...
| \*Luo tuotenumeroiden nimikkeistö esimääritetyille tuotevarianteille | Yleinen         |
| \*Luo tuotenumeroiden nimikkeistö määritetyille tuotevarianteille | Yleinen         |
...
| \*Automaattisten tuotesuositusten määrittäminen   | Yleinen         |
...
| \*Määritä vähittäismyyntikanavan tietoliikenne (CDX)                   | Yleinen         |
...
| \*Luo valikkokohde mobiililaitteelle rekisterikilven konsolidointia varten          | Yleinen         |
