...
description: Tässä artikkelissa kerrotaan, miten manuaalisen tehtävän ominaisuudet määritetään.
author: ChrisGarty
ms.date: 08/23/2017
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa kerrotaan, miten manuaalisen tehtävän ominaisuudet määritetään.
