---
title: Palkanlaskennan alkusaldojen syöttäminen
description: Tässä artikkelissa käsitellään vaiheet, joilla ansiokoodien, vähennysten, etujen ja verojen alkusaldot annetaan.
...
ms.locfileid: "8850015"
---
# <a name="enter-payroll-beginning-balances"></a>Palkanlaskennan alkusaldojen syöttäminen

[!include [banner](../../includes/banner.md)]

Tässä artikkelissa käsitellään vaiheet, joilla ansiokoodien, vähennysten, etujen ja verojen alkusaldot annetaan. Kumppanit arvostavat näitä tietoja, sillä niiden avulla he voivat siirtää tiedot toisesta järjestelmästä uuteen käyttöönotettuun palkanlaskentaan. Palkanlaskennan alkusaldojen antamista varten tarkistetaan seuraavat tiedot:
