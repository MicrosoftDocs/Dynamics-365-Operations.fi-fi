...
- Seuraa kassatilannetta ja -ennusteita.
- Suodata tiedot siten, että näkyvissä on niiden yritysten osajoukko, joille tilannevedokset luotiin.
- Muokkaa järjestelmän luomaa kassatilannetta ja -ennusteita.
- Suorita mitä jos -analyysi, jos haluat tarkastella kassavirran optimistisia, pessimistisiä ja todennäköisimpiä näkymiä.
- Vertaa todellista taloudellista suorituskykyä ennusteeseen, joka on tallennettu tilannevedokseen.

Voit luoda tilannevedoksen valitsemalla **Uusi tilannevedos** **Kassatilanne**- tai **Kassaennuste**-välilehdessä **Kassavirtaennusteet**-työtilassa. Kun tilannevedos on luotu, sen saapuvia ja lähteviä virtoja voi muokata ja tallentaa. Kaikki tallennetut tilannevedokset ovat käytettävissä **Tilannevedokset**-välilehdessä. Voit avata tilannevedoksen valitsemalla sen nimen.
