...
description: Tässä artikkelissa on vianmääritystietoja, jotka voivat auttaa, kun vero kirjataan tositteen väärälle kirjanpitotilille.
author: qire
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
Kirjaamisen aikana vero saatetaan kirjata tositteen väärälle kirjanpitotilille. Voit ratkaista tämän ongelman noudattamalla seuraavien osien ohjeita tarpeen mukaan. Tämän artikkelin esimerkeissä myyntitilausta käytetään liiketoiminta-asiakirjana.
