...
description: Tässä artikkelissa käsitellään tehtäviä, jotka yleensä viimeistellään, kun suoritetaan kirjanpidon kauden sulkemista.
author: aprilolson
ms.date: 08/01/2017
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa käsitellään tehtäviä, jotka yleensä viimeistellään, kun suoritetaan kirjanpidon kauden sulkemista. 
