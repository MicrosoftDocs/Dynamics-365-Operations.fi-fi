...
description: Tässä aiheessa esitellään jaksotukset ja annetaan tietoja niiden määrittämisestä ja tapahtumien luomisesta.
author: aprilolson
ms.date: 01/11/2018
ms.topic: overview
ms.prod: ''
...
Tässä aiheessa esitellään jaksotukset ja annetaan tietoja niiden määrittämisestä ja tapahtumien luomisesta.
