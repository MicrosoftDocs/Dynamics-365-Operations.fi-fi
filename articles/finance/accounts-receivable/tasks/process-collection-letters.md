...
description: Tässä artikkelissa kerrotaan, miten maksukehotuksia luodaan, tulostetaan ja kirjataan.
...
ms.locfileid: "8909124"
---
# <a name="process-collection-letters"></a>Käsittele maksukehotuksia

[!include [banner](../../includes/banner.md)]

Tässä artikkelissa kerrotaan, miten maksukehotuksia luodaan, tulostetaan ja kirjataan. Tässä tehtävässä käytetään esittely-yritystä USMF.
