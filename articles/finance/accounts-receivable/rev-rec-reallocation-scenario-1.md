...
description: Tässä artikkelissa käydään läpi uudelleenkohdistusskenaario, jossa kaksi myyntitilausta syötetään mutta ainoastaan vahvistetaan. Sama skenaario tuottaa samanlaisia tuloksia, jos enemmän kuin kaksi myyntitilausta on vahvistetussa tilassa.
author: bking
ms.date: 12/21/2020
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "9348314"
---
# <a name="revenue-recognition-reallocation--scenario-1"></a>Tuottokirjauksen uudelleenkohdistus – skenaario 1

[!include [banner](../includes/banner.md)]

Tässä artikkelissa käydään läpi uudelleenkohdistusskenaario, jossa kaksi myyntitilausta syötetään mutta ainoastaan vahvistetaan. Sama skenaario tuottaa samanlaisia tuloksia, jos enemmän kuin kaksi myyntitilausta on vahvistetussa tilassa.
