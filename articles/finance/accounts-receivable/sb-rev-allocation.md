...
description: Tässä artikkelissa kerrotaan, miten tuoton kohdistusta käytetään tilauslaskutuksessa.
...
ms.locfileid: "8864365"
---
# <a name="revenue-allocation"></a>Tuoton kohdistus

Tässä artikkelissa kerrotaan, miten tuoton kohdistuksen parametrit määritetään laskutusaikataululle. Voit määrittää tuoton kohdistuksen tai muokata sitä, kun luot laskutusaikataulun. Kun avaat aktiivisen tai lopetetun laskutusaikataulun **Tuottojen kohdistus** -sivun, kentät ovat vain luku -kenttiä.
