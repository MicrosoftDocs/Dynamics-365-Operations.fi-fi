...
description: Tämä aihe opastaa sinua skenaariossa, jossa useita osittaisia maksuja suoritetaan toimittajalle, jolla on useita käteisalennuksia.
author: abruer
ms.date: 08/22/2017
ms.topic: article
ms.prod: ''
...
Tämä aihe opastaa sinua skenaariossa, jossa useita osittaisia maksuja suoritetaan toimittajalle, jolla on useita käteisalennuksia. 
