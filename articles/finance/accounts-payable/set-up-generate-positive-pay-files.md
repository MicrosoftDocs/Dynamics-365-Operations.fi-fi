...
> [!NOTE]
> Tämä toiminto vanhentuu syyskuussa 2022, joten uusien käyttäjien kannattaa käyttää sähköistä raportointia. Lisätietoja on kohdassa [Positive Pay -tiedostojen määrittäminen sähköisen raportoinnin avulla](set-up-positive-pay-er.md).
