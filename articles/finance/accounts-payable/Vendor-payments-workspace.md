...
description: Tässä artikkelissa on tietoja toimittajamaksujen työtilasta. Toimittajamaksujen työtilassa näkyy toimittajan maksujen käsittelyyn liittyviä tietoja.
author: abruer
ms.date: 10/16/2020
ms.topic: article
ms.prod: ''
