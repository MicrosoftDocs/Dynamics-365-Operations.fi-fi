...
description: Tässä artikkelissa kerrotaan, kuinka organisaatiot, jotka maksavat toimittajille toistuvassa aikataulussa, voivat automatisoida toimittajan maksuehdotusten luonnin.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
