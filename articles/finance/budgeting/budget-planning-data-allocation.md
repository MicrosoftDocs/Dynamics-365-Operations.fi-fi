...
description: Tässä artikkelissa tietoja Microsoft Dynamics 365 Financen käytettävissä olevista kohdistustavoista ja niiden käyttämisestä.
author: panolte
ms.date: 03/05/2020
ms.topic: article
ms.prod: ''
