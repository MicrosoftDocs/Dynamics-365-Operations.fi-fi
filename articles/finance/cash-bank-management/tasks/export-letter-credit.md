...
Suorita **Määritä pankin limiitit ja kirjausprofiilit**- ja **Luo pankin limiittisopimus remburssia varten** -menettelyt ennen tätä menettelyä. USMF-demoyritys on oltava valittuna, muuten menettelyn suorittaminen ei onnistu.
...
7. Klikkaa **Toimipaikka**-kentässä avattavan valikon painiketta avataksesi haun.
...
3. Napsauta luettelossa valitulla rivillä olevaa linkkiä.
    * Tarkista, että **vientiremburssin** **lähetyksen tila** on **Laskutettu**.  
...
5. Napsauta luettelossa valitulla rivillä olevaa linkkiä.
6. Valitse **Rivit**.
7. Syötä **Päivämäärä**-kenttään päivämäärä.
