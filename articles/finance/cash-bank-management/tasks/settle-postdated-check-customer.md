...
Voit maksaa myöhemmäksi päivätyn sekin sen jälkeen, kun pankki on selvittänyt sekin. Tämä kirjanpitotapahtuma selvittää myös myöhemmäksi päivätyn sekin välitilin tapahtuman. 

Seuraavat tehtävät on suoritettava ennen tämän aloittamista:

1) Määritä jälkeen päin päivitetyt sekit

2) Rekisteröi ja kirjaa asiakkaan myöhemmäksi päivitetty sekki 



Tämä tehtäväopastuksen rooli on Rahastonhoitaja.
