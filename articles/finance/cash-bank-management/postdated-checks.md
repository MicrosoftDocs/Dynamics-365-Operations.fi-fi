...
description: Tässä artikkelissa on tietoja myöhemmäksi päivättyjen sekkien tuesta. Myöhemmäksi päivätyt sekit ovat sekkejä, jotka on asetettu tulevan päivämäärän omaavien maksujen vastaanottamista varten.
author: angelad116
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
