---
title: Jäännöspoisto
description: Tässä aiheessa on yleiskuvaus poiston jäännösarvopoistomenetelmästä.
author: moaamer
ms.date: 04/25/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8725314"
---
# <a name="reduce-balance-depreciation"></a>Jäännöspoisto

[!include [banner](../includes/banner.md)]

Tässä aiheessa on yleiskuvaus poiston jäännösarvopoistomenetelmästä.
