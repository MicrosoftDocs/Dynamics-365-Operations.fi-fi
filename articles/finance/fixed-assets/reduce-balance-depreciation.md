...
Voit määrittää jäännösarvopoiston tekemällä valinnat myös **Poistoprofiilit**-lomakkeen **Yleinen**-pikavälilehden kentissä. Valitse ensin vuosi **Poistovuosi**-kentässä. Tekemäsi valinnan mukaan **Kausiväli**-kentässä näkyy erilaisia vaihtoehtoja, kuten seuraavissa osissa kerrotaan. 
...
**Kalenteri**-vaihtoehto päivittää poistokannan, joka on tavallisesti nettokirjanpitoarvo vähennettynä jäännösarvolla, kunkin vuoden tammikuun 1. päivänä. Myöhemmin tässä artikkelissa olevassa jäännöspoistoesimerkeissä poistokanta on laskelmien sarakkeen ensimmäisen lausekkeen osoittaja. 
...
Jos valitset kohdan **Tilivuosi**, seuraavat vaihtoehdot ovat käytettävissä **Kausiväli**-kentässä:
