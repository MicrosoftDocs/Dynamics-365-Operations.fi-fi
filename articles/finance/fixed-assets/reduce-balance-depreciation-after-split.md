...
description: Tässä artikkelissa kuvataan menetelmä, jota käytetään resurssissa poiston laskemiseen sen jälkeen, kun resurssi on jaettu käyttämällä jäännöspoistomenetelmää.
author: moaamer
ms.date: 11/17/2020
ms.topic: article
ms.prod: ''
