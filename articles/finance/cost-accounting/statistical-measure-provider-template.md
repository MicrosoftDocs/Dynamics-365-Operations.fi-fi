...
description: Tämä artikkeli sisältää tietoja tilastodimension jäsenistä ja tilastomittauksen lähdemalleista.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
Tilastomittaukset voivat olla peräisin monenlaisista lähteistä. Dynamics 365 Finance on erinomainen tilastomittausten lähde. Voit käyttää tilastomittauksen lähdemallia määrittämään helposti tuotavia tilastomittauksia.
