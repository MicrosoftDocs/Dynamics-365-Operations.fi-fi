...
ms.locfileid: "5890326"
---
# <a name="finance-home-page"></a>Financen aloitussivu

[!include [banner](includes/banner.md)]

Tässä aiheessa on luettelo Microsoft Dynamics 365 Finance -ohjelman taloushallinnon toimintoja koskevista ohjeaiheista ja muista resursseista. 
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        - [Kulujenhallinta](/dynamics365/project-operations/prod-exp/expense-management)
        - [Taloushallinnon raportointi](../fin-ops-core/dev-itpro/analytics/financial-reporting-intro.md?toc=%2ffin-and-ops%2ftoc.json)
        ...
        - [Projektinhallinta ja kirjanpito](/dynamics365/project-operations/prod-pma/overview-project-management-accounting)
...
Maiden/alueiden säädökset vaikuttavat veroasetuksiin ja taloushallinnon muihin alueisiin. Ohjeiden [Lokalisointi- ja säädösominaisuudet](../fin-ops-core/dev-itpro/lcs-solutions/country-region.md?toc=%2ffin-and-ops%2ftoc.json) -osassa on lisätietoja maa-/aluekohtaisista ominaisuuksista.
...
Online-kursseista ja -koulutuksesta saat tietoa [Dynamics 365 Financein Microsoft Learn -sivulta](/learn/browse/?products=dynamics-finance&resource_type=learning+path).
