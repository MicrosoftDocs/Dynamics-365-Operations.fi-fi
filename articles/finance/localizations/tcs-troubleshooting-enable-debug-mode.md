...
2. Kun valitset **Arvonlisävero**-kohdan laskeaksesi arvonlisäveron, palvelimeen kohtaan **C:\AXWeb_SMBShare\temporary-file\\{%session%}\\** siepataan tekstitiedosto nimeltä **TaxServiceTroubleshootingLog.txt**. **TaxServiceTroubleshootingLog.txt**-tiedosto sisältää **TaxableDocument**- ja laskentaparametrin. Nämä tulokset palautetaan veropalvelusta ja poikkeustiedot vianmääritystä varten.
