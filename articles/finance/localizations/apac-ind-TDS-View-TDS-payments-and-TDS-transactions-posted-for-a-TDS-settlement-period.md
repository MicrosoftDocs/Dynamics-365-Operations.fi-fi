...
description: Tässä artikkelissa on tietoja siitä, miten voit tarkastella tilityskaudelle kirjattuja Vero vähennettynä lähteissä (TDS) -maksuja ja -tapahtumia.
author: kailiang
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa on tietoja siitä, miten voit tarkastella tilityskaudelle kirjattuja Vero vähennettynä lähteissä (TDS) -maksuja ja -tapahtumia.
