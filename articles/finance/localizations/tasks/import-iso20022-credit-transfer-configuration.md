...
7. Käytä seuraavaa suodatinta Kirjoita suodattimen arvoksi "ISO20022 Credit transfer (DE)" Konfiguraation nimi -kenttään niin, että suodatinoperaattori on Alkaa.
    * Voit vaihtoehtoisesti myös etsiä konfiguraation luettelosta, valita sen ja siirtää konfiguraation Tuo tehtävä -kohtaan.  
8. Valitse Tuo.
