...
description: Tämä artikkeli sisältää yhteenvedon Regulatory Configuration Servicen (RCS) ominaisuuksista ja tietoja palvelun käytön ominaisuudesta.
author: kfend
ms.date: 06/04/2021
ms.topic: overview
ms.prod: ''
...
> [!NOTE] 
> RCS ei ole tällä hetkellä saatavissa Government Community Cloud (GCC) -ympäristössä.
