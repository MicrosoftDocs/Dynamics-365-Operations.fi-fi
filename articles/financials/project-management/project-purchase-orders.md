...
Microsoft Dynamics 365 for Finance and Operations -sovelluksessa voit luoda projektin ostotilauksia monella eri tavalla. Käytettävä menetelmä määräytyy ostotilauksen tarkoituksen, ostettujen nimikkeiden kulutusajankohdan sekä ostettujen nimikkeiden veloitusajankohdan mukaan.
