...
Tässä ohjeaiheessa käsitellään mallia ja tehtävää, joilla projektin tehtävät synkronoidaan suoraan Microsoft Dynamics 365 for Project Service Automationista Microsoft Dynamics 365 for Finance and Operationsiin.
