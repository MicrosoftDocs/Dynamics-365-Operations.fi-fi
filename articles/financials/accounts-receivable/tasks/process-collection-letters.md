...
1. Valitse **Luotonvalvonta > Asetukset > Asiakkaan kirjausprofiilit**.
2. Valitse **Muokkaa**.
...
1. Valitse **Luotonvalvonta > Maksukehotus > Luo maksukehotukset**.
...
2. Valitse asetus **Maksukehotus**-kentässä.
3. Anna maksukehotuksen päiväys.
4. Valitse kirjausprofiili, jos muutit **Käytettävä kirjausprofiili** -asetukseksi **Valitse**. Käytettävissä ovat seuraavat kaksi kirjausprofiilivaihtoehtoa:   
...
6. Valitse **Suodatin**.
7. Anna **Ehdot**-kentässä asiakkaan tunnus. Syötä arvoksi esimerkiksi US-001.
8. Napsauta **OK**.
9. Napsauta **OK**.
...
9. Kirjaa maksukehotus.
   ...
   3. Laajenna **Sisällytettävät tietueet** -osa.
   4. Napsauta **OK**.
   5. Valitse **Tila**-kentässä **Kirjattu**.
   6. Valitse asetus **Tulostettu**-kentässä.
...
1.  Valitse ensin **Luotonvalvonta > Asetukset > Myyntireskontran parametrit** ja sitten **Perintä**-välilehti. 
2.  Muuta **Luo maksukehotus per** -arvoksi **Asiakas**. 
3.  Valitse **Luotonvalvonta > Maksukehotus > Tarkastele ja käsittele maksukehotuksia**. Asiakkaan kaikille erääntyneille tapahtumille luodaan vain yksi maksukehotus.
