...
Ympäristömuutokset sisältyvät tämän viikon julkaisuun. Lisätietoja on [Talous- ja toimintosovellusten version 10.0.10 käyttöympäristön päivityksissä (toukokuu 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md). Tämä versio sisältää ohjelmakorjauksia ja tallennettujen näkymien muutoksia.
