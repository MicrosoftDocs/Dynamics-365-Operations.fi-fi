...
description: Tässä artikkelissa käsitellään Microsoft Dynamics 365 Human Resourcesin 14. toukokuuta 2020 julkaistuja uusia tai muuttuneita ominaisuuksia.
...
Tässä artikkelissa käsitellään Dynamics 365 Human Resourcesin uusia tai muuttuneita toimintoja. Muutokset koskevat koontiversion numeroa 8.1.3244. Joissakin otsikoissa suluissa olevat luvut viittaavat Lifecycle Services (LCS) -palveluiden tukinumeroihin.

## <a name="platform-changes"></a>Alustan muutokset

Ympäristömuutokset sisältyvät tämän viikon julkaisuun. Lisätietoja on [Rahoitus ja toiminnot -sovellusten version 10.0.10 alustan päivityksissä (toukokuu 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md). Tämä versio sisältää ohjelmakorjauksia ja tallennettujen näkymien muutoksia.
