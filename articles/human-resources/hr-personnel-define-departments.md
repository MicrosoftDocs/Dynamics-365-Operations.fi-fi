...
1. Valitse Henkilöstöhallinto > Osastot > Osastot.
2. Avaa valintaikkuna valitsemalla Uusi.
3. Kirjoita arvo Nimi-kenttään.
    * Esimerkki: projektin laskutus  
4. Kirjoita arvo Muistio-kenttään.
    * Esimerkki: projektin laskutus  
5. Anna tai valitse arvo Esimies-kentässä.
    * Esimerkki: Jodi Christiansen  
6. Valitse Tallenna.
7. Sulje sivu.
8. Valitse Henkilöstöhallinto > Osastot > Osastohierarkia.
9. Valitse Muokkaa.
10. Valitse Lisää.
11. Valitse Osasto.
12. Etsi haluamasi tietue luettelosta ja valitse se.
    * Esimerkki: projektin laskutus  
13. Valitse OK.
14. Valitse Julkaise, jolloin valintaikkuna avautuu.
15. Syötä päivämäärä ja kellonaika Voimaantulopäivä-kenttään.
    * Voit valita osastohierarkiaa julkaistaessa, milloin muutokset tulevat voimaan. Muutokset voidaan päivätä tulevaisuuteen. Voit esimerkiksi tietää, että tilivuoden alussa lisätään osasto. Voit määrittää voimaantulopäivän tilivuoden alkuun ja hierarkian muutokset tulevat voimaan kyseisenä päivänä.  
