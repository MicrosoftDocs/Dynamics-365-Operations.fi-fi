...
ms.locfileid: "9643903"
---
# <a name="request-time-off"></a>Pyydä vapaata
...
>[!NOTE] 
> **Peruuta poissaolo** on käytettävissä, kun **Lomapyyntötyönkulun käyttökokemuksen parannukset** -ominaisuus on käytössä **Ominaisuuksien hallinta** -työtilassa.  
