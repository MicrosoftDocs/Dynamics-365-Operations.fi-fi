...
description: Tässä artikkelissa on tietoja, jotka liittyvät henkilöstöhallinnon hallitsemien tietojen integroimiseen.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa on tietoja, jotka liittyvät Dynamics 365 Human resourcesin hallitsemien tietojen integroimiseen. Siinä kuvataan erilaisia integrointitekniikoita, joiden avulla voit päättää, mitkä tekniikat sopivat parhaiten tarpeisiisi.
...
| Tietojen integrointiohjelma        | Kyllä, tietojen integrointiohjelmassa ajoitettuna        | Asynkroninen, erä                                | Ei                                        | Vaihtelee käyttötapauksen mukaan                                       | Tukee kaikkia Dataverse-tauluja           |
