...
description: Tämä artikkeli sisältää tietoja ja esimerkkikyselyn Palkanlaskennan muuttava kompensaatiosuunnitelma -yksiköstä Dynamics 365 Human Resourcesissa.
author: twheeloc
ms.date: 06/15/2021
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa kuvataan Dynamics 365 Human Resourcesin Palkanlaskennan muuttava kompensaatiosuunnitelma -yksikkö.
