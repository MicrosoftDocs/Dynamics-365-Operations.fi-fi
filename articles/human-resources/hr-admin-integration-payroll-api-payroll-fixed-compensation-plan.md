...
description: Tämä artikkeli sisältää tietoja ja esimerkkikyselyn palkanlaskennan kiinteän kompensaatiosuunnitelman yksiköstä Dynamics 365 Human Resourcesissa.
author: jcart
ms.date: 08/25/2021
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa kuvataan Dynamics 365 Human Resourcesin Palkanlaskennan kiinteä kompensaatiosuunnitelma -yksikkö.
