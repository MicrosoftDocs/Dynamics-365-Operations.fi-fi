...
description: Tässä artikkelissa käsitellään, mitä tapahtuu, kun päivämäärä- ja aikakenttiä käytetään Microsoft Dynamics 365 Human Resourcesissa.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
