...
2. Määritä **Suorita elämäntapahtuman kelpoisuusprosessi** -valintaruudussa arvot seuraaville kentille:

   | Kenttä | Kuvaus |
   | --- | --- |
   | **Rekisteröitymiskausi** | Rekisteröintijakso, jonka elämäntapahtumakelpoisuus käsitellään. |
