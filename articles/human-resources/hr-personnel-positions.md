---
title: Toimet
description: Tässä artikkelissa kuvataan käsitteelliset elementit, joita toimi voi sisältää. Se tarjoaa myös esimerkkejä, jotka osoittavat, miten voit käyttää näitä elementtejä organisaatiossasi.
author: twheeloc
ms.date: 06/24/2021
ms.topic: article
ms.prod: ''
...
Tässä artikkelissa kuvataan käsitteelliset elementit, joita toimi voi sisältää. Se tarjoaa myös esimerkkejä, jotka osoittavat, miten voit käyttää näitä elementtejä organisaatiossasi.
