...
description: Tässä artikkelissa käsitellään Microsoft Dynamics 365 Human Resourcesin 20. toukokuuta 2021 julkaistuja uusia tai muuttuneita ominaisuuksia.
author: marcelbf
ms.date: 05/20/2021
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Platform Update 10.0.18 (42) | -- | [Talous- ja toimintosovellusten (toukokuu 2021) käyttöympäristön päivitysversio 10.0.18](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-18) |
