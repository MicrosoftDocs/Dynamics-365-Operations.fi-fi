...
ms.locfileid: "6057403"
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="c8b23-103">Esimerkkikysely työhönottopyyntöä varten</span><span class="sxs-lookup"><span data-stu-id="c8b23-103">Example query for Recruiting request</span></span>

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

<span data-ttu-id="c8b23-104">Tämä ohjeaihe sisältää esimerkkikyselyn Työhönottopyyntö-yksikölle Dynamics 365 Human Resourcesissa.</span><span class="sxs-lookup"><span data-stu-id="c8b23-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="c8b23-105">Seuraavasta kyselystä ilmenee, miten voit käyttää $expand-kyselyasetusta GET-toiminnossa noutaaksesi määritetyn työhönottopyyntötietueen sekä kaikki määritettyyn pyyntöön liittyvät toimet, vaadittavat osaamisalueet ja koulutusvaatimukset.</span><span class="sxs-lookup"><span data-stu-id="c8b23-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="c8b23-106">Esimerkkivastaus osoittaa työhönottopyynnön, jossa on kaksi toimea ja toimien edellyttämät osaamisalueet ja koulutukset.</span><span class="sxs-lookup"><span data-stu-id="c8b23-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="c8b23-107">**Pyyntö**</span><span class="sxs-lookup"><span data-stu-id="c8b23-107">**Request**</span></span>
...
<span data-ttu-id="c8b23-108">**Vastaus**</span><span class="sxs-lookup"><span data-stu-id="c8b23-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="c8b23-109">Lisätietoja</span><span class="sxs-lookup"><span data-stu-id="c8b23-109">See also</span></span>

[<span data-ttu-id="c8b23-110">Hakijan seurantajärjestelmän integroinnin sovellusliittymän esittely</span><span class="sxs-lookup"><span data-stu-id="c8b23-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>
