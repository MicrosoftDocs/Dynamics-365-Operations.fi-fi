...
description: Tämä artikkeli sisältää esimerkkikyselyn Työhönottopyyntö-yksikölle Dynamics 365 Human Resourcesissa.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858211"
---
# <a name="example-query-for-recruiting-request"></a>Esimerkkikysely työhönottopyyntöä varten
...
Tämä artikkeli sisältää esimerkkikyselyn Työhönottopyyntö-yksikölle Dynamics 365 Human Resourcesissa.

Seuraavasta kyselystä ilmenee, miten voit käyttää $expand-kyselyasetusta GET-toiminnossa noutaaksesi määritetyn työhönottopyyntötietueen sekä kaikki määritettyyn pyyntöön liittyvät toimet, vaadittavat osaamisalueet ja koulutusvaatimukset. Esimerkkivastaus osoittaa työhönottopyynnön, jossa on kaksi toimea ja toimien edellyttämät osaamisalueet ja koulutukset.
