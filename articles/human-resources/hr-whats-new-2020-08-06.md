...
description: Tässä artikkelissa käsitellään Microsoft Dynamics 365 Human Resourcesin 6. elokuuta 2020 julkaistuja uusia tai muuttuneita ominaisuuksia.
...
Tässä artikkelissa käsitellään Dynamics 365 Human Resourcesin uusia tai muuttuneita toimintoja. Muutokset koskevat koontiversion numeroa 8.1.3444. Joissakin otsikoissa suluissa olevat luvut viittaavat tukinumeroihin LCS-palveluissa.

## <a name="platform-update-1001236-is-now-available"></a>Platform Update 10.0.12(36) on nyt saatavana

Lisätietoja on [Talous- ja toimintosovellusten version 10.0.12 käyttöympäristön päivityksissä (elokuu 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-10-0-12.md).
