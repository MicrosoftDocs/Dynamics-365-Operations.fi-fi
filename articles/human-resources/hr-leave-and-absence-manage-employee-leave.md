...
## <a name="adjust-leave-balances"></a>Loma saldojen säätäminen

1. Valitse työntekijän tietueesta **Loma**.

2. Valitse **Lomien ja poissaolojen asettaminen**.

3. Valitse **Muuta saldoa**.

4. Valitse **Poissaolon tyyppi**.

5. Syötä **Muutoksen määrä**. 
