...
Tässä osassa kuvatut muutokset koskevat koontiversiota 8.1.2709. Joissakin otsikoissa suluissa olevat luvut viittaavat tukinumeroihin Microsoft Dynamics Lifecycle Services (LCS) -palveluissa.

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>Järjestelmä ei voi luoda kalenteripäiviä, kun se tuodaan tiedonhallintajärjestelmän kautta (381195)

Tämä muutos korjaa ongelman, jossa kalenteripäivien tuonti aiheuttaa virheen **Virheellinen päivämäärämuoto**. Tämä virhe estää työkalenterin päivämäärärivien luomisen.
