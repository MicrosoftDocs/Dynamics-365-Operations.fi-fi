...
Määritä LinkedIn Recruiter System Connect (RSC) -integraatio. Kun olet muodostanut LinkedIn-yhteyden LinkedIn-tunnistetiedoilla, voit synkronoida ehdokkaan LinkedIn-profiilin, hakemukset, haastattelun palautteen ja työhönottoryhmän muistiinpanot. Täysi LinkedIn Recruiter -käyttöoikeus on pakollinen. Lisätietoja RSC:stä on kohdassa [Recruiter System Connect (RSC) – usein kysytyt kysymykset](https://www.linkedin.com/help/recruiter/answer/90483).
