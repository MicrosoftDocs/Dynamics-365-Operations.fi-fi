...
Attractin ja Onboardin osalta kaikki tiedot ovat alkuperäisiä Common Data Services (CDS) for Appsin tietoja.
...
CDS for Apps -ratkaisussa ei ole tällä hetkellä taloushallinnon dimensioita, joten ne eivät sisälly oletusmalliin. Tätä yksikköä suunnitellaan, mutta julkaisuajankohta ei ole tällä hetkellä tiedossa.
...
Kenttiä voi lisätä integrointitehtävään tai poistaa niitä siitä. Kaikkia CDS for Apps (CDS 2.0) -yksikössä olevia tietokenttiä ei täytetä Core HR:stä.
...
Tietojen integrointiohjelman ensimmäinen ajo on täydellinen ajo. Seuraavat ajot perustuvat muutosten seurantaan. Kun virheajo suoritetaan, se poistaa tietueet ajosta ja lähettää viimeisimmät muutokset CDS:stä.
...
Kyllä. Nykyisiin malleihin voi lisätä kenttiä, ja niitä voidaan myös poistaa siitä. Malli voidaan mukauttaa sisältämään lisätietoja muista CDS for Apps -yksiköistä. Yksikön on oltava CDS for Apps -ratkaisussa, jotta sen voi sisällyttää malliin. 
...
- Tiedonsiirto aiheutti sen, että tietueet noudettiin lähteestä (CDS) kahdesti.

- Tiedonsiirrossa Finance and Operationsin pakollisilla kentillä on tyhjäarvo. Tarkista, että tiedot ovat CDS:ssä ja että ne vastaavat Finance and Operationsin vaatimuksia.
...
Integrointi Finance and Operationsiin tapahtuu kahdessa vaiheessa. Tarkista ensin, että Talentin tiedot on päivitetty ja käytettävissä CDS:ssä. Tämä synkronointi tapahtuu lähes reaaliaikaisesti, ja se voidaan tarkistaa PowerAppsissa katsomalla tietoyksiköiden tietoja.

![CDS:n tiedot](media/DataInCDS.png)

Jos tiedot eivät näy odotetusti CDS:ssä, tarkista, että yksikön integrointia tuetaan. Jos CDS:ään halutaan sisällyttää lisätietoja, se edellyttää muutosta Microsoft puolella.

Jos yksikköä tuetaan ja tiedot ovat käytettävissä CDS:ssä, tarkista, että yhdistämismääritys on oikein tietojen integrointiohjelmassa. Jos integrointiohjelman yhdistämismääritys näyttää olevan kunnossa, varmista seuraavaksi, että tietojen hallintatyöt on suoritettu. Erätöitä suoritettaessa voi tapahtua virheitä. Lisätietoja tietojen hallinnasta on kohdassa [Tietojen hallinta](https://docs.microsoft.com/en-us/dynamics365/unified-operations/dev-itpro/data-entities/data-entities-data-packages?toc=/fin-and-ops/toc.json).
...
**Sijainnin tunnus** -asetuksen numerosarja käyttää samaa mallia sekä Talentissa että Finance and Operationsissa. Kummallakin puolella on oltava yksilöllinen numerosarja, jotta osoiteongelmia ei tule, kun tiedot integroidaan CDS:stä Finance and Operationsiin.
...
Varmista, että yhdistämismääritys tehdään oikeisiin yrityksiin. Yrityksen synkronointi ei sisälly oletusmalliin, joten oletuksena on, että jokainen Talentissa ja CDS:ssä oleva yritys on myös Finance and Operationsissa.
...
- Tietojen integrointiohjelma: 
  ...
  - [Tietojen integrointi Common Data Service for Appsiin](https://docs.microsoft.com/en-us/powerapps/administrator/data-integrator)
  ...
  - [Järjestelmän muodostamien lokien DSR-pyyntöihin vastaaminen PowerAppsissa, Microsoft Flow'ssa ja Common Data Service for Appsissa](https://docs.microsoft.com/en-us/powerapps/administrator/powerapps-gdpr-dsr-guide-systemlogs)
