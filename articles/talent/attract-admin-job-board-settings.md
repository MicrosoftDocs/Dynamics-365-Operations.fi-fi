...
---
# <a name="enable-broadbean-integration-in-attract"></a>Broadbean-integroinnin ottaminen käyttöön Attractissa
...
3. Muodosta yhteys Broadbeaniin ja anna tietosi **Käyttäjätunnus**-, **Asiakastunnus**- ja **Salaustunnus** -kentissä.
