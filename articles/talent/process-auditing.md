...
Voit tarkastella jäljitettyjä tietoja Power BIssä OData-yhdistimen avulla. Lisätietoja on kohdassa [Yhdistä OData-syötteisiin kohteessa Power BI Desktop](https://docs.microsoft.com/power-bi/desktop-connect-odata).

## <a name="track-changes"></a>Muutosten seuranta
Voit määrittää rekrytointitietojen muutosten seurannan seuraavasti:

1. Valitse [Power Appsissa](https://web.powerapps.com) sopiva ympäristö.
