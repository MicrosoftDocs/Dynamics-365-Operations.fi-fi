...
ms.locfileid: "2896655"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Dynamics 365 Talent:n uudet tai muuttuneet ominaisuudet (12. marraskuuta 2019)
...
Tässä osassa kuvatut muutokset koskevat koontiversiota 8.1.2604. Joissakin otsikoissa suluissa olevat luvut viittaavat tukinumeroihin Microsoft Dynamics Lifecycle Services (LCS) -palveluissa.

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Toimiston sijaintia ei päivitetä Excel-työkirjan kautta (369727)

Tämän muutoksen myötä toimiston sijainnin voi nyt päivittää Office-työkirjan suunnittelutoimintoa,
