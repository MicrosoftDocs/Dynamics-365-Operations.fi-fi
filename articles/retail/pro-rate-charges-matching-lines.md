...
Tämä skenaario havainnollistaa, mitä tapahtuu, kun automaattisten kulujen asetuksissa **Jaa suhteellisesti vastaaville myyntiriveille** -asetuksen arvoksi valitaan **Ei**. (Tämä toiminta vastaa otsikko tason kuluja versiota 10.0.1 edeltävissä Retail-versioissa.)
...
2. Järjestelmä etsii sellaisen otsikkotason automaattisten kulujen määrityksen, joka vastaa asiakkaan ja kunkin nimikeryhmän toimitustapa-asetuksia. Jos määritys löytyy, järjestelmä etsii tasomäärityksestä käytettävän kulun toimitustaparyhmän nimikkeiden tuotearvon kokonaissumman perusteella.
    ...
    **Toimitustapa 11**
    ...
    - Vähittäismyynnin tuotteen kokonaisarvo = 70 $
    - **Kulujen arvo = 7 $**

    **Toimitustapa 99**

    - Vähittäismyynnin tuotteen kokonaisarvo = 80 $
    - **Kulujen arvo = 15 $**

    **Toimitustapa 21**

    - Vähittäismyynnin tuotteen kokonaisarvo = 15 $
