...
Voit tämän artikkelin tietojen avulla ottaa yhteyttä Microsoftiin, jos sinulla on Retailia koskevia teknisiä kysymyksiä.

### <a name="retail-support"></a>Retail-tuki

Voit saada Retail-tukea käyttämällä seuraavan taulukon resursseja. Nämä resurssit mainitaan siinä järjestyksessä, jossa niitä kannattaa vianmäärityksessä käyttää.
...
<td>Voit etsiä <a href="https://lcs.dynamics.com/">LCS</a>-sivustossa ongelmahaun avulla nopeasti Microsoft Knowledge Base (KB) -artikkeleita, hotfix-korjauksia ja Retailin ilmoitettujen ongelmien ratkaisuehdotuksia. Näet, mitä ilmoitettuja ongelmia korjataan parhaillaan tai mitkä on jo korjattu tiettyjen toiminta-alueiden osalta. Lisätietoja on kohdassa <a href="https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/lifecycle-services/issue-search-lcs">Ongelmahaku (Lifecycle Services, LCS)</a>.</td>
</tr>
<tr>
