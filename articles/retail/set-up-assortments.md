...
description: Tässä artikkelissa kuvataan, mikä valikoima on, ja kerrotaan, kuinka voit määrittää valikoimia Dynamics 365 Retailissa.
author: jblucher
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
ms.locfileid: "2024911"
---
# <a name="set-up-assortments"></a>Valikoimien määrittäminen

[!include [banner](includes/banner.md)]

Tässä artikkelissa kuvataan, mikä valikoima on, ja kerrotaan, kuinka voit määrittää valikoimia Dynamics 365 Retailissa.
