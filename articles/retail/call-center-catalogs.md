...
Määritä luettelo valitsemalla **Vähittäismyynti** \> **Luettelot ja valikoimat** \> **Kaikki luettelot**.
...
Lisää luetteloon tuotteita. Ensin on valittava siirtymishierarkia. Siirtymishierarkia tukee luettelon luokitusrakennetta. Valitse yksi siirtymishierarkia, joka on linkitetty vähittäismyynnin kanaviin, jotka on valittu **Vähittäismyyntikanavat**-pikavälilehdessä **Luettelo**-sivulla. Jos siirtymiskanavaa ei ole linkitetty kanavaan aiemmin, valitse **Vähittäismyynti** \> **Kanavan asetukset** \> **Kanavaluokat ja tuotemääritteet** ja linkitä oletussiirtymishierarkia kuhunkin vähittäismyyntikanavaan.
