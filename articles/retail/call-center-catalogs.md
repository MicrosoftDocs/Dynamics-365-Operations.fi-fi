...
Siirry **Retail** > **Luettelot ja valikoimat** > **Kaikki luettelot** luettelon määrittämiseksi.

Luodessasi uuden luettelon, luettelo on linkitettävä vähintään yhteen vähittäismyynnin kanavaan. Tämä tehdään **Vähittäismyyntikanavat**-pikavälilehdessä **Luettelon asetukset** -lomakkeessa. Valitse **Lisää** ja valitse vähintään yksi vähittäismyynnin kanava. Vain sellaisia nimikkeitä voi käyttää luetteloa luodessa, jotka on linkitetty valitun kanavan [valikoimiin](https://docs.microsoft.com/en-us/dynamics365/unified-operations/retail/assortments).

Lisää luetteloon tuotteita. Ensin on valittava siirtymishierarkia. Siirtymishierarkia tukee luettelon luokitusrakennetta. Valitse yksi siirtymishierarkia, joka on linkitetty vähittäismyynnin kanaviin, jotka on valittu **Vähittäismyyntikanavat**-pikavälilehdessä **Luettelo**-sivulla. Jos siirtymiskanavaa ei ole linkitetty kanavaan aiemmin, siirry kohtaan **Vähittäismyynti** > **Kanavan asetukset** > **Kanavaluokat ja tuotemääritteet** ja linkitä oletussiirtymishierarkia kuhunkin vähittäismyyntikanavaan.
...
Kun oikeellisuustarkistus on vahvistettu, valitsemalla **Työnkulku** valikosta aloitat hyväksyntätyönkulun. Valitse **Lähetä** **Työnkulku**-valikossa suorittaaksesi prosessin. Määritä työnkulun valtuutetut käyttäjät ja vaiheet kohdassa**Vähittäismyynti** > **Pääkonttorin asetukset** > **Vähittäismyynnin työnkulut**. Työnkulku määrittää vaiheet, jotka tarvitaan saamaan luettelo tilaan **Hyväksytty**. Luettelon ollessa **Hyväksytty**-tilassa voit valita **Julkaise**-toiminnon **Luettelot**-valikossa suorittaaksesi prosessin loppuun. Kun luettelo on **Julkaistu**-tilassa, sitä voidaan käyttää puhelinkeskuksen tilaustenkäsittelyn ja luettelon lähettämisen prosesseissa.
...
Voit määrittää luettelokohtaiset hinnat valitsemalla **Hintaryhmät**-vaihtoehdon **Luettelot**-välilehdessä linkittääksesi yhden tai useamman hintaryhmän luetteloon. Kaikki kauppasopimukset, hinnanoikaisun kirjauskansiot ja vähittäismyynnin lisäalennukset (raja, määrä, yhdistelmäalennus), jotka on linkitetty samaan hintaryhmään otetaan käyttöön, kun asiakkaat tilaavat tästä luettelosta.
...
Määritettäessä tuotteita luettelossa käytä **Tuotesivun asettelu** -toimenpide määrittääksesi nimikkeelle tietyt sivut, sivun prosenttiosuus ja sivun tietojen sijainti. Näiden tietojen määrittämisen avulla käyttäjät voivat käyttää **Luetteloalueen analyysiraportti** -raporttia. Tämä raportti löytyy valitsemalla **Vähittäismyynti** > **Puhelinkeskuksen raportit** > **Luetteloalueen analyysiraportti**. Tämä raportti analysoi luetteloon liityvän myynnin (myyntitilaukset, missä luettelon lähteen tunnus on sidottu tilauksen otsikkoon tai riviin) ja siihen liittyvän sivun prosenttiosuuden ja kustannukset, jotta saadaan perinteiselle suoralle markkinoinnille **Neliötuuma-analyysi** -raportti.
