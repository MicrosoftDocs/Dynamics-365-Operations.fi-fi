...
1. Siirry Hakemuksen kirjanmerkit -kohtaan.
2. Etsi haluamasi vastaustoimenpide luettelosta ja valitse se.
3. Valitse Muokkaa.
4. Etsi haluamasi tietue luettelosta ja valitse se.
    * Valitse kentät, joita haluat käyttää valitun vastaustoimenpiteen sähköpostimallissa, ja siirrä ne kirjanmerkkikenttiin.  
5. Sulje sivu.

## <a name="create-an-email-template"></a>Sähköpostimallin luominen
1. Valitse Henkilöstöhallinto > Työhönotto > Viestintä > Sähköpostimallit.
2. Valitse Uusi.
3. Valitse Vastaustoimenpide-kentässä Haastattelu.
    * Valitse vastaustoimenpide, joka sisältää tämän tyyppisessä sähköpostiviestinnässä käytettävät kirjanmerkit.  
