...
### [Dynamics 365 for Finance and Operations -videot](get-started/videos.md) 
...
##### [Sähköisen veroilmoituksen määrittäminen](../dev-itpro/analytics/tasks/setup-electronic-tax-declaration-germany.md?toc=/fin-and-ops/toc.json)
...
###### [NF-e XML- ja DANFE-tiedostojen tuonti ja tarkistus](../financials/localizations/latam-bra-import-verify-nf-e-xml-documents-danfe-emails.md)
...
###### [Sähköpostiviestien luonti hyväksytyille NF-e-kohteille ja DANFE PDF- ja NF-e XML -tiedostojen liittäminen viesteihin](../financials/localizations/tasks/br-00053-3-generate-emails-approved-nf-e-attach-danfe-pdf-files-nf-e-xml-files-emails.md)
...
###### [Liittovaltion NF-e-parametrien määrittäminen](../financials/localizations/tasks/br-00053-1-set-up-nf-e-federal-parameters.md)
...
###### [Ostotarjouksen arvonlisäveron laskenta](../financials/localizations/tasks/br-00031-tax-calculation-purchase-quotation.md)
...
###### [PIS- ja COFINS-taulujen määrittäminen](../financials/localizations/tasks/br-10006-1-set-up-pis-cofins-tables.md)
...
###### [Myyntitarjousten vero](../financials/localizations/tasks/br-00057-brazilian-taxes-sales-quotation.md)
###### [Ennakonpidätykset ](../financials/localizations/tasks/br-00009-brazilian-withholding-taxes.md)
...
#### Meksiko
##### [Lokalisoinnin laajuus](../financials/localizations/latam-mex-scope.md)
...
### Lähi-itä
#### [Arvonlisävero](../financials/localizations/apac-sau-sales-tax.md)
...
#### [Osaston luominen ja liittäminen osastohierarkiaan](../talent/create-department-add-department-hierarchy.md)
...
#### [Kustannusten hallinta](../dev-itpro/analytics/cost-management-content-pack.md?toc=/fin-and-ops/toc.json)
...
#### [Yksikön myymälän ylläpito](../dev-itpro/analytics/entity-store-maintenance.md)
...
#### [Luo tuotteiden hankintaluettelo](../supply-chain/procurement/tasks/create-procurement-catalog.md)
...
#### [Ostotilausten manuaalinen luonti](../supply-chain/procurement/purchase-order-creation.md)
...
#### [Aseta menettelytavat hankintaluokkahierarkioille](../supply-chain/procurement/tasks/set-up-policies-procurement-category-hierarchies.md)
...
#### [Toimittajien hyväksyminen tiettyihin hankintaluokkiin](../supply-chain/procurement/tasks/approve-vendors-specific-procurement-categories.md)
#### [Toimittajien hyväksyminen tietyille tuotteille](../supply-chain/procurement/tasks/approve-vendors-specific-products.md)
#### [Toimittajahaku](../supply-chain/procurement/tasks/search-vendors.md)
...
#### [Projektin resurssitietojen määrittäminen](../supply-chain/procurement/tasks/set-up-project-resource-information.md)
...
#### [Tilausten lähettäminen suoratoimituksina](../supply-chain/sales-marketing/tasks/ship-orders-direct-deliveries.md)
...
#### [Myyntitilausten luonti](../supply-chain/sales-marketing/tasks/create-sales-orders.md)
...
#### [Myyntitarjousten joukkoluonti](../supply-chain/sales-marketing/tasks/mass-sales-quotations.md)
...
### Provisio
#### [Myyntiprovisioiden rekisteröinti](../supply-chain/sales-marketing/tasks/register-sales-commissions.md)
#### [Määritä myyntiprovision säännöt](../supply-chain/sales-marketing/tasks/set-up-sales-commission-rules.md)


## [Huollon hallinta](../supply-chain/service-management/service-management-home-page.md)
### Asiakaspalvelun määrittäminen
#### [Huoltosopimusten määrittäminen](../supply-chain/service-management/service-agreement-groups.md)
##### [Huoltosopimusten luominen](../supply-chain/service-management/create-service-agreements.md)
##### [Huoltovälit](../supply-chain/service-management/service-intervals.md)
##### [Huoltovälien määrittäminen](../supply-chain/service-management/set-up-service-intervals.md)
##### [Aikaikkunat](../supply-chain/service-management/time-windows.md)
##### [Aikaikkunoiden luominen](../supply-chain/service-management/create-time-windows.md)
##### [Huoltomalliryhmän luominen](../supply-chain/service-management/create-service-template-group.md)
#### [Huoltotehtävien määrittäminen](../supply-chain/service-management/service-tasks.md)
##### [Huoltotehtävän suhteiden luominen](../supply-chain/service-management/create-service-task-relations.md)
#### [Huoltokohteiden määrittäminen](../supply-chain/service-management/service-objects.md)
##### [Huoltokohteiden luominen](../supply-chain/service-management/create-service-task-relations.md)
##### [Varastonimikkeiden liittäminen huoltokohteisiin](../supply-chain/service-management/attach-inventory-items-service-objects.md)
##### [Huoltokohderyhmät](../supply-chain/service-management/service-object-groups.md)
##### [Mallin määrittäminen objektien esittämiseksi asiakkaan sivustolla](../supply-chain/service-management/set-up-template-to-represent-objects-at-customer-site.md)
##### [Huoltokohteen suhteet](../supply-chain/service-management/service-object-relations.md)
##### [Huoltokohteen suhteiden luominen](../supply-chain/service-management/create-service-object-relations.md)
##### [Mallituoterakenteet](../supply-chain/service-management/template-boms.md)
##### [Mallituoterakenteen luominen](../supply-chain/service-management/create-template-bom.md)
##### [Mallien liittäminen huoltokohteisiin](../supply-chain/service-management/attach-templates-service-objects.md)
#### [Huoltotilausten syykoodien määrittäminen](../supply-chain/service-management/reason-codes-service-orders.md)
##### [Huoltotilauksen vaiheet](../supply-chain/service-management/service-order-stages.md)
##### [Huoltotilauksen vaiheiden määrittäminen](../supply-chain/service-management/set-up-service-order-stages.md)
##### [Syykoodien luominen](../supply-chain/service-management/create-reason-codes.md)
#### [Huolto- ja ylläpitosopimusten määrittäminen](../supply-chain/service-management/service-level-agreements.md)
##### [Ylläpitosopimuksen myyntihinnat](../supply-chain/service-management/subscription-sales-prices.md)
##### [Ylläpitosopimusryhmät](../supply-chain/service-management/subscription-groups.md)
##### [Ylläpitosopimusryhmien määrittäminen](../supply-chain/service-management/set-up-subscription-groups.md)
##### [Käytä vaiheen syykoodeja](../supply-chain/service-management/use-stage-reason-codes.md)
##### [Huoltosopimusten ja projektien integrointi](../supply-chain/service-management/integration-service-agreements-projects.md)
#### [Korjausten hallinnan määrittäminen](../supply-chain/service-management/repair-management.md)
#### [Asiakaspalautusten määrittäminen](../supply-chain/service-management/disposition-and-return-reason-codes.md)
##### [Käsittelykoodien määrittäminen](../supply-chain/service-management/set-up-disposition-codes.md)
##### [Palautusten syykoodien määrittäminen](../supply-chain/service-management/set-up-return-reason-code.md)
##### [Palautettujen nimikkeiden poistotavan määrittäminen](../supply-chain/service-management/specify-how-to-dispose-of-returned-items.md)
### [Asiakaspalvelun käyttäminen](../supply-chain/service-management/working-with-customer-service.md)
#### [Huoltosopimusten täyttäminen](../supply-chain/service-management/fulfill-service-agreements-overview.md)
##### [Sopimusten laatiminen](../supply-chain/service-management/service-agreements.md)
###### [Huoltosopimusten luominen](../supply-chain/service-management/create-service-agreements.md)
###### [Huollon ylläpitosopimukset](../supply-chain/service-management/service-subscriptions.md)
###### [Huoltomallit](../supply-chain/service-management/service-template.md)
###### [Huoltomallin rivien kopioiminen](../supply-chain/service-management/copy-service-template-lines.md)
##### [Huoltotilauksen vaiheen muuttaminen](../supply-chain/service-management/change-service-order-stage.md)
##### Sopimusten päivittäminen ja arviointi
###### [Mallituoterakenteiden hallitseminen kohteiden suhteissa](../supply-chain/service-management/manage-template-boms-on-object-relations.md)
###### [Huoltotuoterakenteen poistaminen](../supply-chain/service-management/delete-service-bom.md)
###### [Indeksoidut myyntihinnat](../supply-chain/service-management/indexed-sales-prices.md)
###### [Ylläpitosopimusmaksujen päivien vähentäminen](../supply-chain/service-management/reduce-the-days-on-subscription-fees.md)
###### [Esimerkki vähennyspäivistä](../supply-chain/service-management/reduction-days-example.md)
###### [Ylläpitosopimuksen myyntihintojen päivittäminen ja indeksoiminen](../supply-chain/service-management/update-and-index-subscription-sales-prices.md)
#### [Asiakaskyselyjen käsitteleminen](../supply-chain/service-management/fulfill-service-agreements-overview.md)
##### [Huoltotilauksen ajanseurannan aloittaminen ja pysäyttäminen](../supply-chain/service-management/start-and-stop-time-recording-on-a-service-order.md)
##### [Huoltotilauksen alkamisajan ja keston tarkasteleminen](../supply-chain/service-management/view-the-start-time-and-duration-of-a-service-order.md)
##### [Vaiheen syykoodien tarkasteleminen](../supply-chain/service-management/view-stage-reason-codes.md)
##### [Palvelutasosopimusten yhteensopivuuden tarkasteleminen](../supply-chain/service-management/view-compliance-with-service-level-agreements.md)
#### Asiakaspalautusten valtuutus
##### [Käsittelykoodit ja palautussyykoodit](../supply-chain/service-management/disposition-and-return-reason-codes.md)
##### [Palautuksen kustannushinta ja erätunnus](../supply-chain/service-management/return-cost-price-and-return-lot-id.md)
##### [Palautustilauksen peruuttaminen](../supply-chain/service-management/cancel-return-order.md)
##### [Nimikkeen korvaavan tilauksen luominen](../supply-chain/service-management/create-item-replacement-order.md)
##### [Palautustilauksen poistaminen](../supply-chain/service-management/delete-return-order.md)
##### [Palautettujen nimikkeiden siirtäminen tarkistettaviksi](../supply-chain/service-management/pass-returned-items-on-to-inspection.md)
##### [Saapumiskirjauskansion postittaminen palautettuja tuotteita varten](../supply-chain/service-management/post-arrival-journal-for-returned-products.md)
##### [Palautettujen nimikkeiden osittaisten toimitusten vastaanottaminen](../supply-chain/service-management/receive-partial-deliveries-returned-items.md)
##### [Palautettujen nimikkeiden vastaanottaminen](../supply-chain/service-management/receiving-returned-items.md)
##### [Palautettujen nimikkeiden vastaanoton rekisteröiminen](../supply-chain/service-management/register-the-receipt-of-returned-items.md)
##### [Palautettujen nimikkeiden vastaanottaminen tarkastuksen kautta](../supply-chain/service-management/take-returned-items-through-inspection.md)
##### [Palautusten pakkausluettelopäivitykset](../supply-chain/service-management/packing-slip-updates-returns.md)
##### [Laskun päivitysten suorittaminen palautuksille](../supply-chain/service-management/perform-invoice-updates-for-returns.md)
#### Huollon toimittaminen 
##### Huoltotilausten suunnitteleminen ja kohdistaminen
###### [Huoltotilaukset](../supply-chain/service-management/service-orders.md)
###### [Huoltotilausten automaattinen luonti](../supply-chain/service-management/auto-create-service-orders.md)
###### [Huollon tilan ja edistymisen kenttien vuorovaikutus](../supply-chain/service-management/service-status-and-progress-field-interaction.md)
###### [Huoltotilausten luominen automaattisesti](../supply-chain/service-management/create-service-orders-automatically.md)
###### [Nimiketarpeiden luominen huoltotilauksiin](../supply-chain/service-management/create-item-requirements-service-orders.md)
###### [Huoltotilauksen nimiketarpeet](../supply-chain/service-management/service-order-item-requirements.md)
###### [Ylläpitosopimuksen työnkulun yleiskuvaus](../supply-chain/service-management/subscription-workflow-overview.md)
###### [Yhdistä huoltotilaukset](../supply-chain/service-management/combine-service-orders.md)
###### [Huollon ylläpitosopimusten luominen ylläpitosopimusryhmästä](../supply-chain/service-management/create-service-subscriptions-from-subscription-group.md)
###### [Huoltosopimukseen liitetty projekti](../supply-chain/service-management/project-attached-to-service-agreement.md)
###### [Projektin huollon ylläpitosopimusten luominen](../supply-chain/service-management/create-service-subscriptions-from-project.md)
##### Huoltotilaustehtävien resursointi
###### [Huoltotehtävät](../supply-chain/service-management/service-activities.md)
###### [Resursointitaulu](../supply-chain/service-management/dispatch-board.md)
###### [Huoltotehtävätyyppien määrittäminen](../supply-chain/service-management/set-up-service-activity-types.md)
###### [Ensisijaisen teknikon määrittäminen](../supply-chain/service-management/set-up-preferred-technician.md)
###### [Resursointiryhmien määrittäminen](../supply-chain/service-management/set-up-dispatch-teams.md)
###### [Huoltotilausten priorisoiminen](../supply-chain/service-management/prioritize-service-orders.md)
###### [Huoltotilausten tilan tarkasteleminen](../supply-chain/service-management/view-the-status-of-service-orders.md)
###### [Huoltotehtävien valvonta](../supply-chain/service-management/monitor-service-activities.md)
###### [Tehtävien kohdistaminen uudelleen](../supply-chain/service-management/reassign-activities.md)
###### [Muutosten peruuttaminen resursointitaulussa](../supply-chain/service-management/reverse-changes-in-a-dispatch-board.md)
###### [Resursoimattomien huoltotilausten tarkasteleminen](../supply-chain/service-management/view-undispatched-service-orders.md)
###### [Huoltotuoterakenteen muokkaaminen ](../supply-chain/service-management/modify-service-bom.md)
##### Huollon toimittaminen
###### [Ylläpitosopimustapahtumien hyvittäminen](../supply-chain/service-management/credit-subscription-transactions.md)
###### [Ylläpitosopimuksen maksutapahtumien luominen](../supply-chain/service-management/create-subscription-fee-transactions.md)
###### [Ylläpitosopimusten jaksottaminen](../supply-chain/service-management/accruing-subscriptions.md)
###### [Huoltotilausrivien siirtäminen](../supply-chain/service-management/move-service-order-lines.md)
###### [Peruuta huoltotilaukset](../supply-chain/service-management/cancel-service-orders.md)
###### [Huoltotilausten luominen manuaalisesti](../supply-chain/service-management/create-service-orders-manually.md)
###### [Ylläpitosopimuksen tuoton jaksottaminen](../supply-chain/service-management/accrue-subscription-revenue.md)
###### [Poista huoltotilaukset](../supply-chain/service-management/delete-service-orders.md)
###### [Ylläpitosopimustapahtumien laskuttaminen](../supply-chain/service-management/invoice-subscription-transactions.md)



## [Kuljetusten hallinta](../supply-chain/transportation/transportation-management-overview.md)
### [Kuljetustenhallintamoduulit](../supply-chain/transportation/transportation-management-engines.md)
...
#### [Aaltokäsittelyn konfigurointi](../supply-chain/warehousing/tasks/configure-wave-processing.md)
...
#### [Kuormituksen käyttöasteen ajoittaminen](../supply-chain/warehousing/schedule-load-utilization.md)
#### [Kuormituskapasiteetin ajoittaminen](../supply-chain/warehousing/schedule-workload-capacity.md)
...
#### [Mobiililaitteiden viivakoodituki](../supply-chain/warehousing/mobile-barcode-support.md)
### [Varaston työkäytännöt](../supply-chain/warehousing/warehouse-work-policies.md)
...
### Osittainen vapautus ja osatoimitus
...
#### [Yhdistetyn rekisterikilven vastaanotto mobiililaitteella](../supply-chain/warehousing/mixed-license-plate-receiving.md)
...
### Päivitys ja siirto
#### [Varastonhallintaprosessien päivittäminen Microsoft Dynamics AX 2012:sta Finance and Operationsiin](../supply-chain/warehousing/upgrade-migration-warehouse-management-processes.md)
### Rekisteröintien ja poispanojen vastaanotot 
#### [Rekisteröi nimikkeet erikoisvarastointikäyttöön tarkoitetuksi nimikkeiksi käyttäen nimikkeen saapumisen kirjauskansiota](../supply-chain/warehousing/tasks/register-items-advanced-warehousing.md)
