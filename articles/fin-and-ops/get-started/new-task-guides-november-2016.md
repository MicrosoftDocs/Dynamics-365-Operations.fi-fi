...
| Poiskirjauksen kirjauskansion luominen asiakkaalle                                          | Yleinen         |
...
### <a name="address-book"></a>Osoitekirja
...
### <a name="cash-management"></a>Kassanhallinta
...
| BPM-tunnistusrivi             | Maa/alue |
|----------------------|----------------|
| Luo kustannustasot | Yleinen         |
| Kustannusobjektien luominen  | Yleinen         |
...
|                                                       Määritä Australian BAS-raportin syykoodit                                                       |     Australia ja Uusi-Seelanti     |
|                                                <strong>\</strong>*Tositteen jatkuvuustarkistus – Kiina                                                |               Kiina               |
|                                         <strong>\</strong>*CN-00010 Kiinan tilikarttojen hierarkia                                          |               Kiina               |
|                                       <strong>\</strong>*CN-00016 Kiinan työsäännön mukainen käyttäjän toimintoloki                                        |               Kiina               |
|                                              <strong>\</strong>*Golden tax -veron integraation viennin määritys                                               |               Kiina               |
|                                     <strong>\</strong>*Tositteiden kirjaaminen muista moduuleista, kuten myyntilaskuista                                      |               Kiina               |
|                                             <strong>\</strong>*Tositteiden kirjaaminen kirjauskansiosta                                             |               Kiina               |
|                                         <strong>\</strong>*Verojen perusintegrointiprofiilin määrittäminen – Kiina                                         |               Kiina               |
|                                                    <strong>\</strong>*Tositteiden määrittäminen – Kiina                                                     |               Kiina               |
...
|                                                            Määritä maksutositteen muoto                                                             |              Tanska              |
|                                             <strong>\</strong>*EEU-00047 Ennakkomaksu työntekijälle                                              |          Itä-Eurooppa           |
...
|                                           <strong>\</strong>*EE-00015 Maksuviitteen luontityökalu                                           |              Eurooppa               |
|                                                  EUR-00002 EU Intrastat -ilmoituksen luominen                                                   |              Eurooppa               |
|                             <strong>\</strong>*EUR-00002 Rahtiosoitteen määrittäminen yhteisönsisäiselle tapahtumalle                              |              Eurooppa               |
...
|                                              <strong>\</strong>*EUR-00015 Osapuolen haku ALV-tunnuksen avulla                                               |              Eurooppa               |
|                                            <strong>\</strong>*EUR-00015 Toimittajan ALV-tunnuksen rekisteröinti                                             |              Eurooppa               |
|                                                    <strong>\</strong>*EUR-00015 ALV-tunnuksen määrittäminen                                                     |              Eurooppa               |
|                                               <strong>\</strong>*HU-00001 Vaihtokurssin laskeminen                                               |              Eurooppa               |
|                                                   Tuo ISO20022-tilisiirron konfiguraatio                                                   |              Eurooppa               |
|                                                    Tuo ISO20022-suoraveloituksen konfiguraatio                                                     |              Eurooppa               |
|  <strong>\</strong>*LT-00003 Siirtoasiakirja tavaroiden siirrolle yrityksen sisällä / Siirtoasiakirjan luominen sisäiselle varastosiirrolle  |              Eurooppa               |
| <strong>\</strong>*LT-00003 Siirtoasiakirja tavaroiden siirrolle yrityksen sisällä / Siirtoasiakirjojen määrittäminen tavaroiden siirrolle yrityksen sisällä |              Eurooppa               |
|                                         <strong>\</strong>*NO-00002 Asiakasmaksu maksutunnuksen perusteella                                          |              Eurooppa               |
...
|                                               Maksutavan määrittäminen ISO20022-tilisiirtoja varten                                               |              Eurooppa               |
...
|                                                   FR-00004 Asiakkaan maksutavan päivitys                                                   |              Ranska               |
...
|                                                             ER Kohteiden määrittäminen                                                             |              Saksa              |
|                                      ER Määritä muoto suorittamaan laskenta ja summaus (osa 1: muodon luominen)                                       |              Saksa              |
...
|                                                 ER Lataa kokoonpano Lifecycle Services -palveluun                                                 |              Saksa              |
|                                  ER Tiedostojenhallinnan tiedostojen käyttö muodon tuloksissa (osa 1: tietomallin valmistelu)                                  |              Saksa              |
|                                  ER Tiedostojenhallinnan tiedostojen käyttö muodon tuloksissa (osa 2: tietomallin laajennus)                                   |              Saksa              |
|                                    ER Tiedostojenhallinnan tiedostojen käyttö muodon tuloksissa (osa 3: muodon luominen)                                     |              Saksa              |
|                                      ER Tiedostojenhallinnan tiedostojen käyttö muodon tuloksissa (osa 4: muodon suorittaminen)                                      |              Saksa              |
|                                ER Tiedostojenhallinnan tiedostojen käyttö muodon tuloksissa (osa 5: muodon muokkaaminen ja suorittaminen)                                 |              Saksa              |
|                                     ER Taloushallinnon dimensioiden käyttö tietolähteenä (osa 1: tietomallin suunnittelu)                                      |              Saksa              |
|                                       ER Taloushallinnon dimensioiden käyttö tietolähteenä (osa 2: mallin määritys)                                        |              Saksa              |
|                                     ER Taloushallinnon dimensioiden käyttö tietolähteenä (osa 3: raportin suunnittelu)                                      |              Saksa              |
|                                       ER Taloushallinnon dimensioiden käyttö tietolähteenä (osa 4: raportin suorittaminen)                                       |              Saksa              |
|                     ER Vaakasuunnassa laajennettavien alueiden käyttö sarakkeiden dynaamiseen lisäykseen Excel-raportissa (osa 1: muodon suunnittelu)                     |              Saksa              |
...
|                                              <strong>\</strong>*EUR-00018 ALV-täsmäytysraportti                                               |              Islanti              |
...
|                                           Luo nopeutetun poiston profiili ja liitä se kirjaan                                           |               Japani               |
...
|                                            Määritä käyttöomaisuuden odotusaika ja vahvista poistoprosessi                                             |               Japani               |
...
|                                                   Käyttöomaisuuden poisto vähennysviennillä                                                   |               Japani               |
...
|                                                 EFT-maksutiedoston luominen JBA-muodossa                                                  |               Japani               |
|                                                       Luo Japanin kulutusveroraportti                                                       |               Japani               |
|                                                 Asiakasmaksun tuonti JBA-tiedostomuodossa                                                  |               Japani               |
...
|                                      Käännetyn arvonlisäveron alaisia nimikkeitä sisältävän ostotilauksen luominen                                     |          Iso-Britannia           |
|                                       Käännetyn arvonlisäveron alaisia nimikkeitä sisältävän myyntitilauksen luominen                                       |          Iso-Britannia           |
|                                       GB-00002 Käänteisen verovelvollisuuden nimikeryhmien, sääntöjen ja parametrien määrittäminen                                       |          Iso-Britannia           |
...
|                                                 Nimikkeen arvonlisäveroryhmän määrittäminen käänteiselle verovelvollisuudelle                                                |          Iso-Britannia           |
|                                                   Käänteisen verovelvollisuuden arvonlisäveroryhmien määrittäminen                                                   |          Iso-Britannia           |
...
| BPM-tunnistusrivi                                                  | Maa/alue |
|-----------------------------------------------------------|----------------|
| Käyttöomaisuuden poistojen laskenta eri yrityksissä  | Yleinen         |
...
| Luokittele käyttöomaisuus uudelleen                                   | Yleinen         |
| Käyttöomaisuuskirjan asetukset                                 | Yleinen         |
...
### <a name="inbound-consignment"></a>Saapuva tavaralähetys

|                                          BPM-tunnistusrivi                                           | Maa/alue |
|---------------------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*Tavaralähetysvaraston omistajuuden muuttaminen tuotannon kysynnän perusteella |     Yleinen     |
|                 <strong>\</strong>*Tavaralähetyksen täydennystilauksen luominen                 |     Yleinen     |
|         <strong>\</strong>*Tavaralähetysvaraston valvonta toimittajayhteistyön avulla         |     Yleinen     |
...
| BPM-tunnistusrivi                                  | Maa/alue |
|-------------------------------------------|----------------|
| Konsernin sisäisen suunnitelman luominen               | Yleinen         |
| Näytä lähtevä suunniteltu konserniyritysten välinen kysyntä | Yleinen         |
...
|                                   BPM-tunnistusrivi                                    | Maa/alue |
|-------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*Merkinnän lisääminen suorituskyvyn kirjauskansioon ja kehujen lähettäminen |     Yleinen     |
|                       <strong>\</strong>*Tavoitteen luominen                        |     Yleinen     |
|                <strong>\</strong>*Suorituskykyarvion luominen                 |     Yleinen     |
...
| Määritä määrittäville tuotteille määritepohjainen hinnoittelu                | Yleinen         |
...
| BPM-tunnistusrivi                                              | Maa/alue |
|-------------------------------------------------------|----------------|
| Edeltäjän lisääminen tuotantovirran tehtävään       | Yleinen         |
| Aiemmin luodun tehtävän lisääminen tuotantovirran versioon | Yleinen         |
| Poista käytöstä tuotantovirran versio                  | Yleinen         |
| Määritä tuotantovirran versiolle viimeinen myyntipäivä   | Yleinen         |
...
| <strong>\</strong>*Automaattisten tuotesuositusten määrittäminen |     Yleinen     |
|        Myyntiedustajan toimintoprofiilin määrittäminen         |     Yleinen     |
|        <strong>\</strong>*Myyntipisteen visuaalisen profiilin luominen (marraskuu 2016)         |     Yleinen     |
...
|         <strong>\</strong>*Vähittäismyynnin kanavan tietoliikenteen määrittäminen (CDX)         |     Yleinen     |
|                          Kanta-asiakaspalkkioiden oikaisut                          |     Yleinen     |
|                              Valikoimien hallinta                               |     Yleinen     |
|                       Arvonlisäveron määrittäminen ja ohitus                       |     Yleinen     |
|        Määritä säännöt ja parametrit cross docking ja ostotarjonnalle         |     Yleinen     |
|                           Jatkuvuusohjelman käyttäminen                            |     Yleinen     |
...
| Määritä arvonlisäveroryhmät                            | Yleinen         |
...
| <strong>\</strong>*Mobiililaitteen valikkokohteen luominen rekisterikilven konsolidointia varten |     Yleinen     |
...
|                           Määritä kuljetuksen maksuväline                            |     Yleinen     |
|                       Rahdin automaattisen täsmäytyksen määrittäminen                       |     Yleinen     |
|              <strong>\</strong>*Nimikkeen uudelleenkohdistussääntöjen määrittäminen lyhyttä keräilyä varten              |     Yleinen     |
