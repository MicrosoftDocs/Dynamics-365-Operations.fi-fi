...
Tässä ohjeaiheessa kuvataan Dynamics 365 for Finance and Operationsissa käytettyjä käyttöliittymäelementtejä. Ennen kuin käyttäjät voivat navigoida käyttöliittymässä, on tärkeää tietää niiden elementtien nimet ja toiminnot, jotka muodostavat käyttöliittymän.
