...
# <a name="videos-for-dynamics-365-for-finance-and-operations"></a>Dynamics 365 for Finance and Operations -videot

[!include [banner](../includes/banner.md)]

Tällä sivulla on lueteltu Microsoftin luomat toimintaohjeita ja teknisiä keskusteluja sisältävät Dynamics 365 for Finance and Operations -videot, jotka ovat saatavilla YouTubessa ja muissa sivustoissa.

## <a name="dynamics-365-youtube-channel"></a>Dynamics 365:n YouTube-kanava
[Microsoft Dynamics 365:n YouTube-kanavalta](https://www.youtube.com/channel/UCJGCg4rB3QSs8y_1FquelBQ) löydät Microsoftin luomia videoita, jotka esittelevät kattavasti Dynamics 365 -tuotteiden liiketoimintaratkaisuja. Tässä osassa on luettelo kanavan Dynamics 365 for Finance and Operations -opetusvideoista.

Videot on listattu ominaisuuksien mukaan, joten selaa alaspäin nähdäksesi kaikki videosisällöt.  
...
- [Visual Studio Team Servicesin integrointi Lifecycle Servicesin kanssa.](https://www.youtube.com/watch?v=0QyyyUp1zHQ&t=1s)

#### <a name="explore-the-user-interface"></a>Käyttöliittymään tutustuminen
- [Lisää mukautettuja kenttiä](https://www.youtube.com/watch?v=gWSGZI9Vtnc)
- [PowerApps-sovellusten upottaminen](https://www.youtube.com/watch?v=x3qyA1bH-NY)
...
- [Koodin päivityksen ja työkaluprosessin hallinta Dynamics 365 for Finance and Operationsissa](https://www.youtube.com/watch?v=M-AtR6ocYM8&feature=youtu.be)
...
[FastTrack for Dynamics 365:n teknisiä tietoja](https://infopedia.eventbuilder.com/index?landingpageid=92tzhl) sisältää teknisiä näkemyksiä ja parhaita käytäntöjä, jotka tarjoavat asiakkaille ja kumppaneille tarkkaa liiketoiminta-aluekohtaista tietoa. Seuraavassa osassa on luettelo FastTrackin teknisiä tietoja sisältävistä tallenteista, jotka voidaan suoratoistaa tai ladata. Voit myös ladata esityksen PDF-version Tech Talk -sivustolta. 

#### <a name="data-management"></a>Tietojen hallinta
- [Kopiointi yritykseen (DYN383PAL)](https://infopedia.eventbuilder.com/event?eventid=q3h0m7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Tietojen hallinta (DYN445PAL2)](https://infopedia.eventbuilder.com/event?eventid=a7n1v0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Tietojen tuonti- ja vientiajan lyhentäminen määritysten avulla (DYN315PAL)](https://infopedia.eventbuilder.com/event?eventid=s6v1q3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="demo-data"></a>Demotiedot
- [Esittelytietopaketit (DYN443PAL)](https://infopedia.eventbuilder.com/event?eventid=m2r4o6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Analyyttisten työtilojen laajentaminen tai luominen (DYN321PAL)](https://infopedia.eventbuilder.com/event?eventid=r7z0f5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
#### <a name="intelligence"></a>Business Intelligence
- [Analytiikka- ja raportointivaihtoehdot, tulostaminen ja asiakirjareitityksen agentti (DYN442PAL)](https://infopedia.eventbuilder.com/event?eventid=r6d9a6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Analyysityötilojen esittely (DYN317PAL)](https://infopedia.eventbuilder.com/event?eventid=h6e1a7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="mobile"></a>Matkapuhelin
- [Kulujen ja projektin mobiilityötila (DYN379PAL2)](https://infopedia.eventbuilder.com/event?eventid=u0g9h5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Mobiilikehys (VIR824PAL)](https://infopedia.eventbuilder.com/event?eventid=p2o7n7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="procurement-and-sourcing"></a>Osto ja hankinta
- [Siirtyminen (DYN332PAL2)](https://infopedia.eventbuilder.com/event?eventid=w5u5q8&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Toimittajayhteistyö (DYN327PAL)](https://infopedia.eventbuilder.com/event?eventid=c3e4c0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Ylläpito (VIR805PAL)](https://infopedia.eventbuilder.com/event?eventid=c2k8k3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="upgrade-and-migration"></a>Päivitys ja siirto
- [AX 2009 – Dynamics 365 for Operations -siirtotyökalut (VIR809PAL)](https://infopedia.eventbuilder.com/event?eventid=c3g5k3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [AX 2009 -siirtotyökalut (DYN306PAL2)](https://infopedia.eventbuilder.com/event?eventid=u3g7s0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [AX 2012 – Dynamics 365 for Operations -päivitys (VIR817PAL2)](https://infopedia.eventbuilder.com/event?eventid=t9e9e5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Päivittäminen 7.2 (heinäkuu 2017) -versiosta 7.0 (RTW)- /7.1 (Release 1611) -versioon (DYN338PAL2)](https://infopedia.eventbuilder.com/event?eventid=q0w9p0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Visual Studio Team Services (VSTS) -määritys (VIR782PAL)](https://infopedia.eventbuilder.com/event?eventid=g9f8g1&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="warehouse-management"></a>Varastonhallinta  
- [Yhdistetyn rekisterikilven vastaanottoa koskevat lisäykset (DYN331PAL)](https://infopedia.eventbuilder.com/event?eventid=e0u6t2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Kysynnän täydennys raaka-aineiden keräilyä varten (DYN333PAL2)](https://infopedia.eventbuilder.com/event?eventid=i5p9d2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Nimikkeen ja varaston siirtoprosessi varastonhallinnan lisätoimintojen käyttämiseksi (DYN316PAL)](https://infopedia.eventbuilder.com/event?eventid=w0k4b4&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
