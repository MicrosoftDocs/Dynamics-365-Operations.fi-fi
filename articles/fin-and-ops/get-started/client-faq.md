...
## <a name="why-arent-symbols-loaded-when-i-use-finance-and-operations"></a>Miksi symboleita ei ole ladattu käyttäessäni Finance and Operationsia?
...
Jos kaksoisnapsautat kenttäotsikkoa tai ohjausobjektin vain luku -arvoa, näkyviin tulee Finance and Operations -pikavalikko.

Helpottaaksemme näppäimistöön pääsyä, suunnittelemme sellaisen pikanäppäimen käyttöönottoa tulevaisuudessa, joka avaa Finance and Operations -pikanäppäimistön.

## <a name="where-is-the-view-details-functionality-in-finance-and-operations"></a>Missä on Finance and Operationsin Näytä tiedot -toiminto?
