---
title: Tilauksen täyttämisen määrittäminen myymälöille
description: Tässä artikkelissa käsitellään myymälän tilauksen täyttämisen määrittämistä.
author: BrianShook
ms.date: 10/30/2017
ms.topic: article
ms.prod: ''
