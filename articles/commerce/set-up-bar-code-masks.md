...
description: Tässä artikkelissa kuvataan, miten määrität viivakoodin muodon merkit, viivakoodin muodot, ja miten viivakoodin muodot liitetään viivakoodeihin.
author: BrianShook
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
| Kuponkikoodi      | Ilmaisee kuponkikoodin viivakoodille, joka lisää alennuksen tilaukseen. Tämä korvaa alennuskoodin. |
