...
Kokeen elinkaaren vaiheen voi tarkistaa sivustonmuodostimen **Kokeet**-välilehdessä. Näkyvissä on koeluettelo sekä kunkin kokeen tila sekä Commercessa että siinä kolmannen osapuolen palvelussa, jossa kokeet luodaan, variaatiot määritetään ja tiedot analysoidaan.
