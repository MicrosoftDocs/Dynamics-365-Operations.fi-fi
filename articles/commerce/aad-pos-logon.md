...
---
# <a name="enable-azure-active-directory-authentication-for-pos-sign-in"></a>Azure Active Directory -todennuksen ottaminen käyttöön myyntipistekirjautumisessa
