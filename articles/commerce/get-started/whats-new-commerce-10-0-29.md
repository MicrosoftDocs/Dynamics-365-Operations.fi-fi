...
Tässä artikkelissa käsitellään Microsoft Dynamics 365 Commercen version 10.0.29 uusia tai muuttuneita ominaisuuksia. Tämän version koontinumero on 10.0.1326. Se on käytettävissä seuraavan aikataulun mukaisesti:
