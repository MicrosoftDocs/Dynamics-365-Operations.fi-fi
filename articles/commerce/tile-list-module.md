...
1. Valitse **Lisää moduuli** -valintaikkunasta **Ruutuluettelo**-moduuli ja valitse sitten **OK**.
...
1. Valitse **Lisää moduuli** -valintaikkunasta **Ruutumoduuli**-moduuli ja valitse sitten **OK**.
