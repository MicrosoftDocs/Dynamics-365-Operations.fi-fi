...
Käyttäjäprofiilisivulla näkyvät käyttäjätilin tiedot, kuten käyttäjän nimi ja sähköpostiosoite. Se käyttää käyttäjäprofiilimoduulia. Vaikka sähköpostiosoitetta ei voi poistaa, sitä voi muokata.
