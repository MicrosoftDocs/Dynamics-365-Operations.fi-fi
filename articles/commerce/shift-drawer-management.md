...
description: Tässä artikkelissa käsitellään miten määritetään ja käytetään vuoroja Commercen myyntipisteessä (POS).
author: josaw1
ms.date: 05/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9287454"
---
# <a name="shift-and-cash-drawer-management"></a>Vuoron ja kassan hallinta

[!include [banner](includes/banner.md)]

Tässä artikkelissa käsitellään miten määritetään ja käytetään vuoroja Commercen myyntipisteessä (POS).
