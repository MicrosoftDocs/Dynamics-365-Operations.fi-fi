...
1. Lataa kirjanpidon yhdistimien ja kirjanpitoasiakirjan toimittajien määritystiedostot.
    ...
    1. Lataa veroasiakirjan tarjoajan määritystiedosto kohdassa **Määritykset \> DocumentProviders \> DocumentProviderFiscalEFRSampleGermany.xml**.
