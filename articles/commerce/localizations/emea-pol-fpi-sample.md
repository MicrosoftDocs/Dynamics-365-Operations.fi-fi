...
1. Lataa kirjanpidon yhdistimien ja kirjanpitoasiakirjan toimittajien määritystiedostot.
    ...
    1. Lataa veroasiakirjan tarjoajan määritystiedosto kohdassa **CommerceRuntime \> DocumentProvider.PosnetSample \> Määritys \> DocumentProviderPosnetSample.xml**.
    1. Lataa veroliittimen määritystiedosto kohdassa **HardwareStation \> ThermalDeviceSample \> Määritys \> ConnectorPosnetThermalFVEJ.xml**.
