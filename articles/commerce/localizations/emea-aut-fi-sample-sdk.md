...
> [!IMPORTANT]
> Seuraa tämän artikkelin ohjeita vain, jos käytössä on Microsoft Dynamics 365 Commercen versio 10.0.28 tai aiempi versio. Itävallan verorekisteröintipalvelun integraatioesimerkki on saatavilla Commercen versiosta 10.0.29 alkaen Commerce SDK:ssa. Lisätietoja on kohdassa [Kanavan osien määrittäminen](./emea-aut-fi-sample.md#configure-channel-components).

Tässä artikkelissa on ohjeita, jotka koskevat Itävallan verorekisteröintipalvelun integroinnin käyttöönottoa Dynamics 365 Commerce Retail SDK:sta kehittäjän virtuaalitietokoneessa (VM) Microsoft Dynamics Lifecycle Servicesissa (LCS). Lisätietoja verointegroinnin esimerkistä on kohdassa [Verorekisteröintipalvelun integroinnin esimerkki (Itävalta)](emea-aut-fi-sample.md). 
