...
Tässä artikkelissa on ohjeita, jotka koskevat Italian verotulostimen integrointiesimerkin käyttöönottoa Dynamics 365 Commerce Retail SDK:sta kehittäjän virtuaalitietokoneessa (VM) Microsoft Dynamics Lifecycle Servicesissa (LCS). Lisätietoja verointegroinnin esimerkistä on kohdassa [Verotulostimen integroinnin esimerkki (Italia)](emea-ita-fpi-sample.md). 
