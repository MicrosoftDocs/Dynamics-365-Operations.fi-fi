---
title: Taloudellinen täsmäytys vähittäismyymälöissä
description: Tässä artikkelissa kuvataan vähittäismyymälöiden taloushallinnon täsmäytystä myyntipisteille Microsoft Dynamics 365 Commercessa.
author: anpurush
ms.date: 06/09/2020
ms.topic: article
ms.prod: ''
