---
title: Toimitusvaihtoehtomoduuli
description: Tässä artikkelissa on tietoja toimitusvaihtoehtomoduuleista ja niiden määrittämisestä Microsoft Dynamics 365 Commerce -sovellukseen.
author: anupamar-ms
ms.date: 02/24/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8894555"
---
# <a name="delivery-options-module"></a>Toimitusvaihtoehtomoduuli

[!include [banner](includes/banner.md)]

Tässä artikkelissa on tietoja toimitusvaihtoehtomoduuleista ja niiden määrittämisestä Microsoft Dynamics 365 Commerce -sovellukseen.
