...
description: Tässä artikkelissa kerrotaan, miten olemassa olevaa sivua muokataan Microsoft Dynamics 365 Commerce -sovelluksessa.
author: josaw1
ms.date: 04/14/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9286915"
---
# <a name="modify-an-existing-site-page"></a>Aiemmin luodun sivuston sivun muokkaaminen

[!include [banner](includes/banner.md)]

Tässä artikkelissa kerrotaan, miten olemassa olevaa sivua muokataan Microsoft Dynamics 365 Commerce -sovelluksessa.
