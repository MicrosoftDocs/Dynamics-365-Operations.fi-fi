...
description: Tässä artikkelissa esitetään yleiskatsaus toimintoon, jonka avulla vähittäiskauppiaat voivat määrittää alennuksia tietyille maksuvälinetyypeille.
author: bebeale
ms.date: 10/30/2019
ms.topic: article
ms.prod: ''
