...
description: Tässä artikkelissa on yleisiä tietoja tuotesuosituksista. Tuotesuositusten avulla asiakkaat löytävät helposti ja nopeasti tuotteita, joita he haluavat. He löytävät jopa tuotteita, joita he eivät alun perin aikoneet ostaa.
author: Moonma
ms.date: 05/26/2020
ms.topic: overview
ms.prod: ''
...
Tämä palvelu on Dynamics 365 Commercen lisäosa. Saat lisätietoja lataamalla uusimman [Microsoft Dynamics 365 -käyttöoikeusoppaan](https://go.microsoft.com/fwlink/?LinkId=866544).
