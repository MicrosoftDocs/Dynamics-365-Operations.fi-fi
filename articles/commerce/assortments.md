...
description: Tässä artikkelissa selitetään Dynamics 365 Commercen valikoimien hallinnan peruskäsitteitä ja pohditaan projektin käyttöönottovaihtoehtoja.
author: josaw1
ms.date: 03/12/2018
ms.topic: article
ms.prod: ''
