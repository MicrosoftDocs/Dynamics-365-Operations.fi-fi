...
description: "Lähes kaikkien yritysten, jotka käyttävät Microsoft Dynamics 365 for Operationsin Financials-toiminnallisuutta, pitää voida luoda raportteja, joissa budjetoituja arvoja verrataan toteutuneisiin. Tässä artikkelissa kerrotaan pienin kokoonpano, joka vaaditaan, jotta voidaan luoda budjetteja Dynamics 365 for Operationsissa tai ladata ne kolmannen osapuolen ohjelmasta."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Lähes kaikkien yritysten, jotka käyttävät Microsoft Dynamics 365 for Operationsin Financials-toiminnallisuutta, pitää voida luoda raportteja, joissa budjetoituja arvoja verrataan toteutuneisiin. Tässä artikkelissa kerrotaan pienin kokoonpano, joka vaaditaan, jotta voidaan luoda budjetteja Dynamics 365 for Operationsissa tai ladata ne kolmannen osapuolen ohjelmasta.
...
Dynamics 365 for Operationsissa on useita tapoja luoda budjettitapahtumia:
