...
Projekti on ryhmä toimintaa, jonka tarkoituksena on tarjota palvelun, tuotteen tai tuloksen saavuttamiseksi. Kuluttaa resursseja ja taloudelliset tulokset luovat tuloja tai varoja.

## <a name="projects-across-industries"></a>Projektit eri aloilla
Projektinhallinnan ja kirjanpidon toimintoja voidaan käyttää useilla aloilla kuvassa esitetyllä tavalla. [![Projektien industries](./media/projects-accross-industries.jpg)](./media/projects-accross-industries.jpg) 

Puhelinpalvelukeskuksessa, lipun avulla voidaan kuvata joukko toimenpiteitä, joita puhelun ratkaiseminen edellyttää. Hallinnan tekninen konsultointi, organisaatiot tai virastot, mainonta konsultointi yrityksille viittaavat toimintaansa projekteiksi. Markkinointi, kampanja edustaa joukko, joka toimitetaan työ. Projektiin perustuvassa valmistuksessa, tuotantotilaus liittyy eri töihin, jotka on tehtävä valmiiden tuotteiden tuottamiseksi. Niitä käytetään nimi, nämä hanke resurssien, aikataulujen ja kustannusten ja projektinhallinnan ja kirjanpidon toimintoja Microsoft Dynamics-365 toiminnoissa apua suunnittelu, suorituksen ja analyysi näistä hankkeista.
...
Useat keskeiset prosessit ilmenevät projektin aloittamisen. Voit toimittaa asiakkaalle arvioitu työn, kustannukset ja materiaalien projektitarjouksen. Voit tallentaa laskutuksen ehdot, rajoitukset ja sopimusten projektisopimus. Voit suunnitella ja arvioida työtä työrakenne (WBS). Voit määrittää ennusteita ja budjetteja, jotka ohjaavat projektin suorittamisen. Seuraavassa kuvassa näkyy projektin rakennetta. [![projektin rakenne](./media/project-structure1.jpg)](./media/project-structure1.jpg)  
...
Jos organisaatiossasi on toiminnallinen näkökulma ja keskitytään tuottoihin ja kustannuksiin, jotka ovat peräisin tietyistä tapahtumista, voidaan käyttää ennusteita. Mutta jos organisaatiosi keskittyy enemmän taloushallinnon summiin, voit käyttää budjetointia. Kummallakin menetelmällä on omat etunsa. Lisätietoja on kohdassa [Projektien budjetit ja ennusteet](project-forecasts-budgets.mdhttps:/ax.help.dynamics.com/en/wiki/project-forecasts-and-budgets/).

### <a name="create-projects"></a>Luo projektit

Voit luoda Microsoft Dynamics-365 työvaiheiden kuudelle eri projektityypille. Kullekin projektityypille määritetään eri tavoin kustannusten ja tuoton kirjaaminen. Valitsemasi projektityyppi määräytyy projektin tarkoituksen mukaan. Seuraavassa taulukossa kuvataan jokaisen projektityypin tavallinen käyttötarkoitus.
...
| Kiinteä hinta       | Kiinteähintaisissa projekteissa laskut muodostuvat ennakkolaskutapahtumat. Kiinteähintainen projekti laskutetaan, joka perustuu projektisopimukseen laskutuksen aikataulun mukaisesti. Kiinteähintaisen projektien tuotto voidaan laskea ja kirjata koko projektin ajan käyttämällä valmistumisprosenttimenetelmää. Vaihtoehtoisesti, tuotto voidaan laskea ja kirjata, kun projekti on valmis, käyttämällä valmissopimus-menetelmää. Yritykset voivat usein hyötyä käyttämällä KET-arvoa projektin tai projektien ryhmän valmiusasteen laskentaan.                                                                                                                                     |
| Investointi        | Investointiprojektit ovat projekteja, jotka eivät tuota tuloja välittömästi. Niitä käytetään tavallisesti pitkäaikaisissa, sisäisissä projekteissa, joissa kustannukset täytyy aktivoida. Investointiprojektille voidaan tallentaa vain nimikkeiden, tuntien ja kulujen kustannukset. Investointiprojektiin kustannuksia seurataan ja hallitaan käyttämällä arviointitoimintoa. Investointiprojekteille voidaan määrittää valinnainen enimmäisaktivointi. Investointiprojektin edistyessä kirjaat kustannuksia KET-tileille, joilla kustannukset pidetään projektin valmistumiseen saakka. Kun projekti eliminoidaan, KET-arvo siirretään käyttöomaisuuteen, kirjanpitotilille tai uuteen projektiin.
> [!NOTE] 
> Investointiprojektien tapahtumat eivät näy **kustannukset kirjataan**, **jaksotetaan**, tai **Luo laskuehdotuksia** sivulla.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | | Projektin kustannukset | Investointihankkeille, kuten Kustannusprojektien käytetään yleensä seurata sisäiset projektit vain tunnit, kulut ja nimikkeet voidaan kirjata ne. Kustannusprojektit ovat kuitenkin tavallisesti lyhyempiä kuin investointiprojektit. Lisäksi, investointiprojekteista poiketen, kustannusprojekteja ei voida aktivoida tasetileille. Sen sijaan niiden projektitapahtumat kirjataan vain tulostileihin. 
[!NOTE] 
> Kustannusprojektien tapahtumat eivät ole näkyvät **kustannukset kirjataan**, **jaksotetaan**, tai **Luo laskuehdotuksia** sivulla. Koska hankkeet, joiden kustannukset ovat yleensä sisäisten projektien seurannassa, yleensä olisikaan, joka liittyy asiakkaan tilille. Kuitenkin asetusten vaatiessa nimikevaatimuksien luontia ostotilauksia varten, täytyy kustannusprojekti yhdistää asiakkaan kanssa. Tämä yhdistäminen tarvitaan, koska nimiketarpeita hallitaan myyntitilausriveinä ja järjestelmä edellyttää, että asiakas on määritettävä. Tämä asetus ei kuitenkaan aiheuta nimiketarpeiden automaattista luomista ostotilauksesta. Kustannusprojekteissa **luo nimiketarve**-asetusta ei oteta huomioon. Tarvitessasi nimiketarvetta kustannusprojektissa voit luoda sen manuaalisesti, edellyttäen että asiakas on liitetty projektiin. | | Sisäinen | Sisäisissä projekteissa käytetään projektissa, joka on organisaation sisäinen, kustannusten seurantaan. Sisäisissä projekteissa voi tarjota suunnittelun avulla voit hallita resurssien kulutus. **Huomautus:** sisäisten projektien tapahtumat eivät ole näkyvät **jaksotetaan** tai **Luo laskuehdotuksia** sivulla.                                                                                                                                                                                                                                                                       | | Aika | Aikaprojekteja käytetään seurata aikaa, joka on liitetty ei-veloitettava ja tuottamattomien toimintoja, kuten projektin työntekijöiden seurantaan sairasloma. Aikaprojektien tapahtumia ei kirjata kirjanpitoon. Sen sijaan ne on sisällytetty työntekijän käyttöasteen raportteihin. Aikaprojekteissa voi tallentaa vain tuntitapahtumia. Voit rekisteröidä nämä tunnit projektiin kirjauskansion tai aikaraportin avulla. Tunnit rekisteröidään, kun Projektitapahtumat näkyvät, mutta ei ole vastaavaa Tositetapahtumat.

> [!NOTE] 
> Aikaprojektien tehtävät eivät näy **kustannukset kirjataan**, **jaksotetaan**, tai **Luo laskuehdotuksia** sivulla.                                                                                                                                                                                       |
...
Seuraavassa on joitakin tapoja, joita voit käyttää toimintojen ajoitukseen resurssin:
...
On kaksi tapaa hallita ja ohjata projekteja: projektin ennusteisiin ja budjetteihin project. Jos organisaatiossasi on toiminnallinen näkökulma ja keskitytään tuottoihin ja kustannuksiin, jotka ovat peräisin tietyistä tapahtumista, voidaan käyttää ennusteita. Mutta jos organisaatiosi keskittyy enemmän taloushallinnon summiin, voit käyttää budjetointia.

Lisätietoja on kohdassa [Projektien budjetit ja ennusteet](project-forecasts-budgets.mdhttps:/ax.help.dynamics.com/en/wiki/project-forecasts-and-budgets/).
...
-   Jos haluat tilata nimikkeitä yrityksen varastosta, sinun on syötettävä tilaus nimiketarpeena. Jos käytät **kohdan vaatimukset** -sivulla voit määrittää vaatimusta niin, että vastaanotat nimikkeet osatoimituksina. Siksi voi lykätä nimikkeiden kulutusta kunnes niitä tarvitaan.
-   Tilataksesi nimikkeitä ulkoiselta toimittajalta, sinun on luotava tilaus ostotilauksena **Ostotilaus**-sivulla.

> [!NOTE] 
> Projektiin liittyvät myyntitilauksen pakkausluettelon ei voi peruuttaa, jos nimikkeet on jo merkitty pakkausluettelon. 
...
Microsoft Dynamics-365 toiminnoissa ei automaattisesti vähentää ennustettu arviot. Siksi on suositeltavaa säilyttää alkuperäinen ennustemalli kiinteähintaisessa projektissa, jotta sitä voi käyttää vertailussa, kun projekti on valmis. 
> [!NOTE]Kun valitset tämän vaihtoehdon, käytä vähintään kaksi ennustemalleja. Alkuperäinen ennuste tulee sisältää yhteen malliin. Toista mallia varten sinun on kopioitava ennustetapahtumat toisesta mallista. Tämä kenttä on voimassa oleva vain kiinteähintaisissa projekteissa ja investointiprojekteissa.</td>
> </tr>
<tr class="odd">
...
-   **Laskun päivämäärä:** 31. maaliskuuta 2012. Päivämäärä määräytyy laskutusprojektille määritetyn laskutusvälin mukaan. Tässä esimerkissä määrität laskutusvälin nykyiselle kuukaudelle. Joten kaikki maaliskuun aikana kirjatut tapahtumat laskutetaan kuukauden viimeisenä päivänä.
-   **Eräpäivä:** 14. huhtikuuta 2012. Tämä päivämäärä määritetään maksuehdot, jotka on määritetty projektin perusteella. Tässä esimerkissä olet valinnut maksuehdoiksi 14 vuorokautta. Joten 14 päivää lisätään laskutuspäivämäärään, jotka lisätään eräpäivänä 14. huhtikuuta 2012.
-   **Odotettu Myynnin maksupäivä:** huhtikuu 27, 2012. Tämä päivämäärä lasketaan lisäämällä päivien määrä **Yleiset puskuripäivät** -kenttään **projektin hallinnan ja kirjanpidon parametrit** päivien määrä sivulla **yksittäisten puskuripäivien** -kenttään **projektin sopimuksia** sivulle ja lisätä sitten päivien määrä yhteensä **määräpäivä** kentän. Tässä esimerkissä syötit numeron **3** **yleiset puskuripäivät** -kenttään ja **10** **yksittäiset puskuripäivät** -kenttään. Joten 13 päivää lisätään eräpäivään, jotka lisätään odotettuna myynnin maksupäivänä 27. huhtikuuta 2012.
...
-   **Eräpäivä:** 16. maaliskuuta 2012. Maksuehdot määritetään 14 päivää.
-   **Odotettu Myynnin maksupäivä:** 29. maaliskuuta 2012. Laskenta sisältää kolme Yleiset puskuripäivät ja yksittäisten puskuripäivien 10.
...
> [!NOTE] 
> Ostotilauksen eräpäivä perustuu toimittajatapahtumaan projektin ostotilaus luodaan. Eräpäivää ei määrää mikään oletusasetus. 
...
> [!NOTE] 
> Kun käytät **kustannusseuranta** sivu tarkastella projektikustannuksia nykytila, käytä alkuperäisen ja jäljellä olevan budjetin, joka valittiin ennustemalleja. Jos valitset muita ennustemalleja, kun lasket kustannuksia, laskennan tulokset eivät ole tarkkoja.
