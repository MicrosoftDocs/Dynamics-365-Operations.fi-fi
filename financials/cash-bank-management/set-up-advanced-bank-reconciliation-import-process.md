...
Tiliotteen tuontiasetukset vaihtelevat sähköisen tiliotteen muodon mukaan. Microsoft Dynamics-365 työvaiheiden tukee kolme pankin tiliotteen laatikosta: ISO20022 MT940: n osalta ja BAI2.

## <a name="sample-files"></a>Mallitiedostot
Kaikki kolme muoto-sinulla on tiedostoja, jotka käännetään muotoon, jota voi käyttää Dynamics 365 työvaiheiden alkuperäisessä muodossa sähköisen pankin tiliotteessa. Tarvittavat resurssitiedostot sijaitsevat Microsoft Visual Studion Application Explorerin **Resurssit**-solmussa. Kun olet löytänyt tiedot, kopioi ne yhteen tunnettuun sijaintiin, sillä silloin ne on helpompi ladata palvelimeen määritysprosessin aikana.

| Resurssin nimi                                           | Tiedostonimi                            |
|---------------------------------------------------------|--------------------------------------|
| BankStmtImport\_BAI2CSV\_,\_BAI2XML\_xslt              | BAI2CSV-to-BAI2XML.xslt              |
| BankStmtImport\_BAI2XML\_,\_täsmäytys\_xslt       | BAI2XML-to-Reconciliation.xslt       |
| BankStmtImport\_BankReconciliation\_,\_kooste\_xslt | BankReconciliation-to-Composite.xslt |
...
| BankStmtImport\_MT940XML\_,\_täsmäytys\_xslt      | MT940XML-to-Reconciliation.xslt      |
...
Alla on esimerkkejä advanced pankki-täsmäytys tuo tiedoston asettelu tekniset määritelmät ja kolme liittyvät tiliotetiedostot Esimerkki: https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/how-to-articles/exofbankstfotechlayouts  
...
1.  Siirry **työtilojen**&gt;**tietojen hallinta**.
2.  Click **Import**.
...
10. Valitse järjestysnumerolle 1 ensin **Lataa tiedosto palvelimeen** ja sitten aiemmin tallentamasi** ISO20022XML-to-Reconciliation.xslt**-tiedosto. **Huomautus:** Dynamics 365 muunnos tiedostojen toiminnot on rakennettu vakio muodossa. Koska pankit usein eroavat keskellä olevasta lähteestä tässä muodossa, saatat joutua päivittämään muunnostiedosto yhdistämään pankin tiliotteen-muotoon. <!-- For details about the expected format for ISO20022, see [Dynamics AX ISO20022 Layout](./media/dynamicsaxiso20022layout1.xlsx).-->
11. Click **New**.
...
1.  Siirry **maksuliikenteen hallinta**&gt;**asennus**&gt;**täsmäytys pankin asetusten Advanced**&gt;**tiliotemuotoilua**.
2.  Click **New**.
...
1.  Siirry **maksuliikenteen hallinta**&gt;**pankki**.
...
11. Valitse **Uusi**.
12. Valitse järjestysnumerolle 2 ensin **Lataa tiedosto palvelimeen** ja sitten aiemmin tallentamasi **MT940XML-to-Reconciliation.xslt**-tiedosto. **Huomautus:** Dynamics 365 muunnos tiedostojen toiminnot on rakennettu vakio muodossa. Koska pankit usein eroavat keskellä olevasta lähteestä tässä muodossa, saatat joutua päivittämään muunnostiedosto yhdistämään pankin tiliotteen-muotoon. <!--- For details about the expected format for MT940, see [Dynamics AX MT940 Layout](./media/dynamicsaxmt940layout1.xlsx)-->
13. Click **New**.
...
11. Valitse **Uusi**.
12. Valitse järjestysnumerolle 2 ensin **Lataa tiedosto palvelimeen** ja sitten aiemmin tallentamasi **BAI2XML-to-Reconciliation.xslt**-tiedosto. **Huomautus:** Dynamics 365 muunnos tiedostojen toiminnot on rakennettu vakio muodossa. Koska pankit usein eroavat keskellä olevasta lähteestä tässä muodossa, ja saatat joutua päivittämään muunnostiedosto yhdistämään pankin tiliotteen-muotoon. <!--- For details about the expected format for BAI2, see [Dynamics AX BAI2 Layout](./media/dynamicsaxbai2layout1.xlsx).-->
13. Click **New**.
14. Valitse järjestysnumerolle 3 ensin **Lataa tiedosto palvelimeen** ja sitten aiemmin tallentamasi **BankReconciliation-to-Composite.xslt**-tiedosto.
15. Valitse **Käytä muunnoksia**.
