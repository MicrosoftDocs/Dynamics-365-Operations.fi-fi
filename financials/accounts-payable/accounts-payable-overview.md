...
description: "Tässä artikkelissa kuvataan sivut, joiden avulla määritetään perus- ja valinnaiset toiminnot Microsoft Dynamics AX:n ostoreskontrassa. Artikkelissa kerrotaan myös ennen ostoreskontran määrittämisen aloittamista suoritettavat asetusvaiheet."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
