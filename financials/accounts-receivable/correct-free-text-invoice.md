...
Avaa kirjatun vapaatekstilaskun korjaamaan tekstimuotoinen lasku on jo kirjattu. - **Laskun** -sivulla **peruuttaa**, ja valitse sitten **oikea**. Valitse syykoodi, lisää kommentit ja valitse päivämäärä uudelle korjatulle laskulle. Voit muokata korjattua laskua ja kirjata sen. 
...
-   Vapaatekstilaskun otsikon tila näkyy **Cancelling laskun '\[laskun numero\]'** tai **korjattu lasku '\[laskun numero\]'**.

> [!NOTE]
> Tämä ominaisuus on käytettävissä vain, jos **vapaa teksti lasku korjaus** konfigurointiavain on valittuna.
