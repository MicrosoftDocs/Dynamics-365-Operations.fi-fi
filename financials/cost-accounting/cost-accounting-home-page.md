...
-   Kustannusseurantayksiköiden luominen
-   Kirjanpidon merkintöjen käsittely
-   Budjettivientien käsittely
-   Voit luoda ja käyttää kustannustoimintakäytäntöjä.
-   Kustannusten seuranta
-   Dimensiohierarkioiden määrittäminen
...
Kustannuslaskennan käytännönläheiset kurssit antavat perustietoja Microsoft Dynamics 365 for Finance and Operations, Enterprise Editionin kustannuslaskennan määrittämisestä toteutuneiden kustannusten analyysia varten. Se tarjoaa myös joukon menettelyjä, jotka voit suorittaa siinä järjestyksessä, jossa ne näkyvät.
...
-   [Kustannuslaskennan Power BI -sisällön suojauksen määrittäminen](/dynamics365/unified-operations/dev-itpro/analytics/setup-security-cost-accounting-content-pack)
