...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Laskennan ja summien yhteenvedon laskutoimitusten käyttäminen sähköistä raportointia (ER) varten
