...
description: "Tässä aiheessa kuvataan Dynamics 365 for Operationsin työntekijän osaamisen ja kehittymisen Power BI -sisältöä. Siinä kuvataan, miten avaat sisältöpakettiin kuuluvat raportit. Lisäksi siinä kerrotaan sisältöpaketin rakentamisessa käytetystä tietomallista ja entiteeteistä."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Tässä aiheessa kuvataan Dynamics 365 for Operationsin työntekijän osaamisen ja kehittymisen Power BI -sisältöä. Siinä kuvataan, miten avaat sisältöpakettiin kuuluvat raportit. Lisäksi siinä kerrotaan sisältöpaketin rakentamisessa käytetystä tietomallista ja entiteeteistä.
...
Dynamics 365 for Operations -sovelluksen tietoja käytetään työntekijän osaamisen ja kehittymisen sisältöpaketin raporttien täyttämiseen. Seuraavassa taulukossa on esitetty yksiköt, joihin sisältöpaketti on perustunut.
