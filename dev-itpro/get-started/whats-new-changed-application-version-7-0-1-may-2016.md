...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Mitä voit tehdä?**                                                | **Miksi tämä on tärkeää?**                                                                                                                                                                                                                                                                                         |
| Luo talousraportoinnin tietovarasto.                          | Dynamics AX-tietokantoihin siirtyminen ympäristöissä tai muiden muutosten tekemisestä levittäytyä ympäristölle, kun joudutaan ehkä taloudellinen raportointi tietokannan. Windows PowerShell-komentosarjan toimitetaan nyt muodostaa tietokannan automaattisesti.                                                                |
| Et voi enää valita raportin suunnittelutoiminnon asetuksia, jotka eivät kelpaa. | Useita Management Reporterin markkinointiversioissa käytettyjä raportin suunnittelutoiminnon asetuksia ei voi käyttää tässä Dynamics AX -versiossa. Nämä vaihtoehdot olivat etuyhteydessä talousanalyysi suunnittelu, tulostus ja linkittämistä. Nämä asetukset on saatettu poistaa taloushallinnon report designer käyttäjän virheiden estämiseksi. |
...
[Uusien tai päivitettyjen tehtävien apuviivat (toukokuussa 2016)](new-updated-task-guides-available-may-2016.md)
