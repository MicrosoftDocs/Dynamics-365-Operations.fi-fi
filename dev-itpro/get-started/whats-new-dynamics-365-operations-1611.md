...
# Dynamics 365 for Operations-version 1611 uudet ja muuttuneet ominaisuudet (marraskuu 2016)
...
<td>Saudi-Arabian pankin pankin maahantuontikustannusten sekalaisten kulujen kohdistusmuoto</td>
</tr>
<tr class="odd">
...
### Varastonhallinnan lisätoiminnot vähittäismyymälässä
...
### Yhtenäisen monikanavaisen kaupan mahdollistaminen
...
### Myymäläjärjestelmä: mahdollistaa yhtenäisen paikallisen myymäläkokemuksen
...
### Universaalin Windows -ympäristön sovellukset Retail Modern POS -sovellukselle
...
| Lisätietoja Dynamics 365 for Operations -järjestelmän tavaralähetyksen tuesta                                                                                                         | Lisätietoja tavaralähetysprosessien tuesta on kohdassa [Tavaralähetys](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Tavaralähetyksen määrittäminen](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Luo tavaralähetyksen täydennystilaus (tehtäväopas)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) ja [Tavaralähetysvaraston omistajuuden muuttaminen tuotannon kysynnän perusteella (tehtäväopas)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

### Toimittajayhteistyö (aiemmin Toimittajaportaali)
...
### Varaston parannukset suurille jakelukeskuksille
...
### Varaston työvaiheiden parannukset
...
### Pienemmät toimintojen parannukset toimitusketjun hallinnassa
