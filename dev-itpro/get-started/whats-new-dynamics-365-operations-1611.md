...
| Henkilöstöhallinnon käyttää viisi uutta virtaa BI sisällön paketit                                     | Uusi sisältö Pack käyttöön ihmisten organisaatioiden ja henkilöstöhallinnon henkilöstöpäälliköt voivat analysoida seuraavasti: työvoiman mittarit • demografiset erittelyä ikä, sukupuoli ja siviilisääty • vertailla hintoja jauhautuminen vuositasolla ja luettelo syistä työntekijöille on annettu jättää organisaation • Näytä luettelo avoimia toimia niin kuin vertailu Avaa suljetun toimia korvausta ja edut • verrata tunneittain ja tuntipalkkaisille työntekijöille • Näytä käytettävissä olevat etuudet • Näytä työntekijät Ilmoittautuneita työntekijöiden määrä työsuhteen tyypin työhönoton • analysoi hakijoiden määrän hakijat, mistä ne ovat peräisin, ja kurssit työntekijän osaamista ja kehitystä • osaamisalueiden luettelo rekisteröity paikkoihin ne ole hakevan organisaation koulutus • kurssille ilmoittautuminen mukaan tila • työntekijöiden mukaan • sijainti Couse läsnäollessa hallussa • työntekijöiden jakautuminen ryhmän jäsenen osaamisaluetyypit |
...
<td>Pankin muut LC Veloituksen kohdistuksen muoto Saudi-Arabia</td>
</tr>
<tr class="odd">
...
| Mitä voit tehdä                                                                                                                                                                                                      | Miksi tämä on tärkeää                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Määritä tilauksen oletusasetukset myynneille ja ostoille, jotka perustuvat tuotteen päätietueessa käytössä oleviin aktiivisiin tuotedimensioihin. Näin voit määrittää tilauksen oletusasetukset varastointiyksikölle (SKU) tai osittaiselle varastointiyksikölle. | Voit määrittää tilauksen oletusasetukset, joita käytetään tuotedimensioon tai tuotedimensioyhdistelmään. **Esimerkki**, jonka nimi on Polo t-paidan tuote myydään. Tuotteesta on saatavana kaksi väriä: vihreä ja sininen. Siitä on saatavana myös kaksi kokovaihtoehtoa: S ja M. Polo-t-paidan aktiiviset tuotedimensiot ovat väri ja koko. Voit estää kaikkien vihreiden Polo-t-paitojen ostot riippumatta koosta. |
...
### <a name="personalized-product-recommendations"></a>Mukautetun tuotteen suosituksia

| Mitä voit tehdä                                                                                                                                                                                                                                                                        | Miksi tämä on tärkeää                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Tarkastella useita touchpoints-myyntipisteen (POS) määrittääkseen, mitä asiakas voi olla kiinnostuneita perustuu niiden ostohistorian, haluavansa niiden luettelon kohteet ja kohteet, joita muut asiakkaat ostaa online- ja Tiili ja laastin kaupat henkilökohtaisen tuotteen suosituksia | Kuvastojen suuret vähittäiskauppiaat Omat suositukset auttavat asiakkaan tuotteen etsiminen ja valtuuttaa myymälän Osakkuusyritysten kanssa älykäs clienteling. Kohdistettu asiakkaan kiinnostuksen kohteita ja ostava käyttöä linkitykset tuotteet tuotteen suosituksia auttavat vähittäiskauppiaita upsell ja voit parantaa asiakkaan pidätys. Dynamics - toimintoja varten 365-tuotepaketti, tuotteen suosituksia ovat powered kognitiivisia ja Microsoftin Azure machine learning. |
...
| Lisätietoja Dynamics 365 for Operations -järjestelmän tavaralähetyksen tuesta                                                                                                         | Saat lisätietoja lähetyksen prosesseista tuki [lähetyksen](/dynamics365/operations/scm/inventory/consignment), [määrittäminen lähetyksen](/dynamics365/operations/scm/inventory/set-up-consignment), [Luo lähetys täydennystilauksen (tehtävän guide)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), ja [omistusoikeuden lähetyksen varaston tuotantokysyntä (tehtävän guide) perustuu](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Lisätietoja Dynamics 365 for Operations -järjestelmän toimittajayhteistyön tuesta | Lisätietoja toimittajayhteistyöstä on kohdassa [Toimittajayhteistyö ulkoisten toimittajien kanssa](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Toimittajayhteistyö asiakkaiden kanssa](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Toimittajayhteistyön käyttäjien hallinta](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Määritä ja ylläpidä toimittajayhteistyötä](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration) ja [ Toimittajayhteistyön laskutustyötila](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tbody>
<tr class="odd">
<td>Määritä suoraan myyntitilausriveillä, mistä ja miten kysyntä hankitaan. <strong>Esimerkki</strong> myyntitilausrivi Luo ja määrittää toimitustyyppi suoratoimitus. Ensisijainen toimittaja lisätään myyntitilauksen riville hankintapisteenä.</td>
...
<tr class="even">
<td>Tilauksen toimituslupauksen luominen myyntitilauksen riveiltä <strong>Esimerkki</strong> luo myyntitilauksen riville, jossa on Orpotermit konsernin sisäiseltä toimittajalta. Poistu riviltä. Toimituspäivät lasketaan hankintayrityksen saatavuuden mukaisesti.</td>
