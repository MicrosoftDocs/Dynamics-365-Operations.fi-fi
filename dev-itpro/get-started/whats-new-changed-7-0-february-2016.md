---
title: "Mikä on uutta tai muutettua Dynamics AX 7.0 (helmikuu 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Mikä on uutta tai muutettua Dynamics AX 7.0 (helmikuu 2016)
...
| Automatisoi muodostus, testaus ja käyttöönotto.                                                                            | Osittain käytettävissä                                                                                                                                                                                | Ota kehittäjätopologia käyttöön kehittäjän ja muodostuksen virtuaalikoneen avulla. Määritä muodostuksen virtuaalikone havaitsemaan ja muodostamaan moduuleja Visual Studio Onlinesta (VSO) ja suorittamaan testit. C\# ja X ++-moduulin kääntäminen ja viittauksia tueta. | Tämä tehostaa kehittäjän toimintaa, sillä testaus ja tarkistukset maksavat vähemmän ja vievät vähemmän aikaa.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Käytä Business Connectoria liiketoimintalogiikan tuottamiseen ja integraatioskenaarioiden tukemiseen.         | Business connector on käytettävissä kutsuvat X ++-koodissa hallitun koodin. Suosittelemme, että business connector vain tekijä liiketoimintalogiikan c\#, eivät integraatiota. | Business Connectoria ei enää tueta. Sisällöntuotantovaatimus perustuu siihen, että X++ käännetään hallittuun koodiin. Tämän vuoksi yhteiskäyttö on helpompaa. Integraatioskenaarioissa käytetään ODataa.       | Business Connectoria ei voi käyttää jatkossa.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Asetukset on lisätty siten, että eri suodattimia voidaan käyttää, kun tarkastellaan raporttia. Uusi raportti luodaan sitten niiden perusteella.</td>
...
<td>Analysoi kirjanpitotietojen "Taloudellisen suorituskyvyn seuranta" Power BI-sisällön avulla.</td>
<td>Ei käytettävissä</td>
<td>Valitse PowerBI.comissa ensin **tietojen hakeminen** ja sitten **Dynamics AX:n taloudellisen suorituskyvyn** sisältöpaketti. Kun kirjoitat Dynamics AX -päätepisteesi URL-osoitteen, tietosi tulevat näkyviin koontinäyttöön.</td>
...
<td>Nykyisen Dynamics AX:n version ohjejärjestelmä näyttää tehtäväoppaat, joka on tallennettu Microsoft Dynamics Lifecycle Servicesin (LCS) BPM:ään. Ohjejärjestelmä näyttää myös Microsoftin wikisivuston aiheet. Lisätietoja on ohjeaiheessa [Dynamics AX-ohje – aloittaminen](help-overview.md) ja [uusi tehtävä käytettävissä apuviivat (helmikuu 2016)](new-task-guides-available-february-2016.md).</td>
...
<td>Sähköisen raportoinnin määritysten toteutettu ominaisuus. Toiminto on käytössä Saksassa ja Itävallassa.</td>
...
<td>SSRS-raportti on toteutettu saldoluettelo ryhmän summatileille-raportti (LedgerAccountSum\_FR).</td>
...
<td>Erillinen luettelo Intrastat-kauppatavarakoodeja yhdistetään tuotehierarkian tyyppiä tullikoodi.</td>
...
<td>Intrastat-kauppatavarakoodi on tekstikenttä lisäyksiköt, tunnistamiseen ja ** tuote ** kortti on kentän tunnistamiseen määrä kilogrammoina.</td>
...
<tr class="odd">
<td>Analysoida kanavan vähittäiskaupan myynnin tiedot käyttämällä "Performance Monitor vähittäismyyntikanavan" Power BI-sisältöä.</td>
<td>Ei käytettävissä</td>
...
<td>Tämä toiminto edellyttää <a href="http://www.microsoft.com/en-us/download/details.aspx?id=42636">System Center 2012 Management Pack for Microsoft Dynamics AX 2012 R3 CU8 Retailia</a>.</td>
...
<li>Se tarjoaa vaihtoehtoisia toimitus "valmiita" pakettien, kuten yhdistelmä-sivuston/varastointi/Variantti/kuljetus tilassa, perustuvat nopein toimitus (Varhaisin mahdollinen päivämäärä), jotka käyttäjä voi valita.</li>
