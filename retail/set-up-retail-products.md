...
description: "Tässä artikkelissa kuvataan Microsoft Dynamics-365 työvaiheiden - Retail-tuotteiden määrittämisestä."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Tässä artikkelissa kuvataan Microsoft Dynamics-365 työvaiheiden - Retail-tuotteiden määrittämisestä.

Ennen kuin voit tarjota tuotteita jälleenmyyntiin-retail-kanavat, Luo ja määrittää tuotteiden Dynamics 365 toimintojen AX - tuotepaketti. Vähittäiskaupan käyttää Dynamics 365 työvaiheiden tuotteen ominaisuuksien päätuotteen koko organisaation tuotteiden luomiseen. Voit luoda tuotteet, määritellä tuotteen ominaisuudet ja määritteet ja liittää tuotteet vähittäismyynnin luokkahierarkioihin. Jos haluat tuoda tuotteet saataville vähittäismyyntikanavissa ja lisätä ne aktiiviseen valikoimaan, sinun täytyy vapauttaa tuotteet yrityksiin, joissa ne ovat käytettävissä. Voit määrittää tuotteet, joita myydään vähittäismyyntikanavissa, toimimalla seuraavasti.

1.  Määritä vähittäismyynnin tuotehierarkia. Luokan hierarkian toimintoja käyttämällä Dynamics 365 toimintoja varten, voit määrittää retail Luokkahierarkiat voidaan ryhmitellä ja luokitella tuotteet, jotka jaetaan retail-kanavat. Käyttäjän määrittämät ja järjestelmän määritteet voidaan määritellä luokkatasolla. Tämän jälkeen kaikki kyseiseen luokkaan määritetyt tuotteet perivät nämä määritteet. Luokkahierarkioita voidaan määritellä useita, ja kukin tuote voidaan määrittää useaan hierarkiaan. Yhden hierarkian sisällä kukin tuote voidaan kuitenkin määrittää vain yhteen luokkaan.
...
5.  Lisää tuotteet siirtymishierarkiat. Ennen kuin tuotteet voi selata verkon kautta tai in point of myynti (POS), ne on luokiteltu siirtyminen Vähittäismyyntihierarkia.
6.  Tuotteiden lisääminen luetteloihin. Vaikka tämä vaihe on valinnainen POS-Verkkokaupat vaativat tuotteet sisällytetään vähintään yksi luettelo.
