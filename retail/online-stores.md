...
description: "Tässä artikkelissa on tietoja vähittäismyynnin verkkokaupoista ja niiden määrittämisestä Microsoft Dynamics 365 for Operations -järjestelmässä."
author: kfend
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
