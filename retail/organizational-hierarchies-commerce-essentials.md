---
title: Organisaatioista ja organisaation hierarkiaa (Commerce essentials)
description: "Commerce essentials on kolmenlaisia sisäiset organisaatiot, joita voit määrittää auttaa organisaation tehtävä liiketoimintaprosessia tai tavoitteen saavuttamisessa."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="organizations-and-organizational-hierarchies-commerce-essentials"></a>Organisaatioista ja organisaation hierarkiaa (Commerce essentials)

Commerce essentials on kolmenlaisia sisäiset organisaatiot, joita voit määrittää auttaa organisaation tehtävä liiketoimintaprosessia tai tavoitteen saavuttamisessa. 
